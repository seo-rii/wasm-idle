...
- The browser-facing compile export also completes `fixtures/ps-primitive-2d-arrays/Main.kt`, which
  covers `Array(n) { LongArray(m) }`, `Array(n) { DoubleArray(m) }`,
...
- The browser-facing compile export also completes `fixtures/ps-pair-priority-queue/Main.kt`, which
  covers `PriorityQueue<Pair<Int, Int>>` construction, `add`, `offer`, `peek`, `poll`, `contains`,
...
- The browser-facing compile export also completes `fixtures/ps-pair-array-deque/Main.kt`, which
  covers BFS-style `ArrayDeque<Pair<Int, Int>>` construction, `add`, `addFirst`, `addLast`,
  `offer`, `offerFirst`, `offerLast`, `peek`, `poll`, `pollLast`, `removeFirst`, `first`, `last`,
...
- The browser-facing compile export also completes `fixtures/ps-mixed-pair-array-deque/Main.kt`,
  which covers `ArrayDeque<Pair<Int, Long>>` and `ArrayDeque<Pair<Long, Int>>` construction,
  `add`, `addFirst`, `addLast`, `offer`, `offerFirst`, `offerLast`, `peek`, `peekFirst`, `poll`,
...
- The browser-facing compile export also completes `fixtures/ps-long-long-pair-array-deque/Main.kt`,
  which covers `ArrayDeque<Pair<Long, Long>>` construction, `add`, `addFirst`, `addLast`, `offer`,
...
- The browser-facing compile export also completes `fixtures/ps-long-long-map/Main.kt`, which covers
...
- The browser-facing compile export also completes `fixtures/ps-long-int-pair-list/Main.kt`, which
  covers `ArrayList<Pair<Long, Int>>` and `mutableListOf<Pair<Long, Int>>()` construction,
  function parameters, `Array<ArrayList<Pair<Long, Int>>>`, indexed get/set, `.first`, `.second`,
...
- The browser-facing compile export also completes `fixtures/ps-long-long-pair-list/Main.kt`, which
  covers `ArrayList<Pair<Long, Long>>` and `mutableListOf<Pair<Long, Long>>()` construction,
