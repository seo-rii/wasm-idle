...
import { DEFAULT_GO_BROWSER_EXPECTED_OUTPUT, runGoBrowserProbe } from './go-browser-probe-lib.mjs';
...
const expectedOutput =
	process.env.WASM_IDLE_GO_EXPECTED_OUTPUT || DEFAULT_GO_BROWSER_EXPECTED_OUTPUT;
