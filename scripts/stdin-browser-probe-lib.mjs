...
/**
 * @param {{ browserUrl: string; chromiumExecutable?: string; expectedOutput: string; language: 'ASSEMBLYSCRIPT' | 'WAT' | 'RUBY' | 'R' | 'SQLITE' | 'PHP' | 'VBNET' | 'D'; runTimeoutMs?: number; sendEof?: boolean; source: string; stdinText: string }} options
 */
