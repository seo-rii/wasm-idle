...
async function loadLuaCompiler(moduleUrl) {
    const module = await import(/* @vite-ignore */ moduleUrl);
    const factory = typeof module.createLuaCompiler === 'function'
...
export function createLuaWorkerService(loadCompiler = loadLuaCompiler) {
    let compiler = null;
    let lastKey = '';
    let lastDiagnostics = [];
    return {
