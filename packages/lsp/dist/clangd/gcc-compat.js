...
#endif
`;
export const GCC_COMPATIBILITY_HEADERS = [
    {
...
export function installGccCompatibilityHeaders(memfs) {
...
export function writeGccCompatibilityHeaders(fs, root = '') {
...
//# sourceMappingURL=gcc-compat.js.map