...
const EXPECTED_PRODUCER = Object.freeze({
	...
	script: Object.freeze({
		...
		bytes: 46491,
		sha256: '85c0470fd9d903350761fb6996580f38b6178f8119d4aae25eb2b7cb9c216b3b'
	}),
	tool: Object.freeze({
		name: 'vite',
		version: '8.0.8',
		...
		files: 47,
		bytes: 2190838,
		treeSha256: 'b3462dd488501c9744a64040f6169ab8afe0d4ec257c5fa822f7ccf5fd779536'
	}),
...
function validateManifestIdentityGraph(
	...
	if (
		...
		producer.packageTreeReceiptFormat !== 'sha256-json-sorted-path-bytes-sha256-v1'
	) {
