...
the closed-state check used during cleanup, rejects stale-generation metadata. The session verifies
the module, source, loader, Wasm, and pthread-sidecar hashes before creating either worker.
