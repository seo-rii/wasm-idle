...
export interface RuntimeBuildProducerRecord {
	id: string;
	manifest: string;
	manifestSha256: string;
}

export interface RuntimeBuildToolchainInfo {
	producer: RuntimeBuildProducerRecord;
	version: string;
	llvmVersion: string;
	llvmCommit: string;
...
export interface RuntimeBuildInfo {
	toolchain: RuntimeBuildToolchainInfo;
