from .position import load_position_from_save, normalize_position
...
class Wall(object):
    def __init__(self, position_1, position_2):
        self.position_1 = normalize_position(position_1)
        self.position_2 = normalize_position(position_2)
