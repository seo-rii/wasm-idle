...
import type {
	SupportedSystemCommand,
	SystemDispatchResult,
	SystemDispatcher
} from './system-dispatch.js';

export interface CreateNodeSystemDispatcherOptions {
	commands?: Partial<Record<SupportedSystemCommand, string>>;
	env?: Record<string, string>;
	toolchainRootOnHost?: string;
...
export function createNodeSystemDispatcher(
	options: CreateNodeSystemDispatcherOptions = {}
): SystemDispatcher {
