...
export interface NodeHostDispatcherOptions {
	switchPrefix: string;
...
export function createNodeHostSystemDispatcher(options: NodeHostDispatcherOptions) {
...
export interface CompileOnHostOptions extends Omit<CompileOptions, 'system' | 'worker'> {
	switchPrefix: string;
	extraEnv?: Record<string, string>;
	binaryenBin?: string;
}

export async function compileOnHost(
	request: CompileRequest,
	options: CompileOnHostOptions
