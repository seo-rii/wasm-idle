...
const expectedImportPathHash = (
	...
	for (const sourceFile of sourceFiles) {
		...
		for (const blockMatch of sourceText.matchAll(/^\s*import\s*\(([\s\S]*?)^\s*\)/gm)) {
			for (const importMatch of blockMatch[1].matchAll(
				/^\s*(?:(_|\.|[A-Za-z_]\w*)\s+)?"([^"]+)"/gm
			)) {
...
const expectedPlaceholderBlockHash = (loweredUnit: {
...
const expectedPlaceholderBlockSignatureHash = (loweredUnit: {
	placeholderBlocks?: Array<{
		signature?: string;
	}>;
	imports?: Array<{
	...
	let position = 1;
	if (
		Array.isArray(loweredUnit.placeholderBlocks) &&
		loweredUnit.placeholderBlocks.every(
...
const expectedLoweringBlockHash = (loweredUnit: {
	id?: string;
	kind?: string;
	packageName?: string;
	sourceFiles?: string[];
	...
	for (const sourceFile of sourceFiles) {
		...
		for (const match of sourceText.matchAll(/type\s+[A-Za-z_]\w*\s+struct\s*\{([^}]*)\}/g)) {
			for (const field of match[1]
				...
				for (const fieldName of namedFieldMatch[1]
					.split(',')
					.map((entry) => entry.trim())
					.filter((entry) => entry !== '')) {
	...
	const verification = verifyTinyGoLoweredArtifactExports(
		{
			exports: {
				...
				tinygo_lowered_program_000_source_hash: () =>
					expectedSourceHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_import_count: () => 1,
				tinygo_lowered_program_000_import_path_hash: () =>
					expectedImportPathHash(programSourceFiles, sourceFileContents),
				...
				tinygo_lowered_program_000_function_name_hash: () =>
					expectedFunctionNameHash(programSourceFiles, sourceFileContents),
				...
				tinygo_lowered_program_000_selector_name_hash: () =>
					expectedSelectorNameHash(programSourceFiles, sourceFileContents),
				...
				tinygo_lowered_program_000_break_label_name_hash: () =>
					expectedBreakLabelNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_continue_statement_count: () => 1,
				tinygo_lowered_program_000_continue_label_name_hash: () =>
					expectedContinueLabelNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_labeled_statement_count: () => 1,
				tinygo_lowered_program_000_label_name_hash: () =>
					expectedLabelNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_goto_statement_count: () => 1,
				tinygo_lowered_program_000_goto_label_name_hash: () =>
					expectedGotoLabelNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_fallthrough_statement_count: () => 1,
				tinygo_lowered_program_000_method_count: () => 1,
				tinygo_lowered_program_000_method_name_hash: () =>
					expectedMethodNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_method_signature_hash: () =>
					expectedMethodSignatureHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_exported_method_name_hash: () =>
					expectedExportedMethodNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_exported_method_signature_hash: () =>
					expectedExportedMethodSignatureHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_exported_function_count: () => 4,
				tinygo_lowered_program_000_exported_function_name_hash: () =>
					expectedExportedFunctionNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_type_count: () => 2,
				tinygo_lowered_program_000_type_name_hash: () =>
					expectedTypeNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_exported_type_count: () => 2,
				tinygo_lowered_program_000_exported_type_name_hash: () =>
					expectedExportedTypeNameHash(programSourceFiles, sourceFileContents),
				...
				tinygo_lowered_program_000_struct_field_name_hash: () =>
					expectedStructFieldNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_struct_field_type_hash: () =>
					expectedStructFieldTypeHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_embedded_struct_field_type_hash: () =>
					expectedEmbeddedStructFieldTypeHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_interface_method_count: () => 1,
				tinygo_lowered_program_000_interface_method_name_hash: () =>
					expectedInterfaceMethodNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_interface_method_signature_hash: () =>
					expectedInterfaceMethodSignatureHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_const_count: () => 1,
				tinygo_lowered_program_000_const_name_hash: () =>
					expectedConstNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_var_count: () => 1,
				tinygo_lowered_program_000_var_name_hash: () =>
					expectedVarNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_exported_const_count: () => 1,
				tinygo_lowered_program_000_exported_const_name_hash: () =>
					expectedExportedConstNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_exported_var_count: () => 1,
				tinygo_lowered_program_000_exported_var_name_hash: () =>
					expectedExportedVarNameHash(programSourceFiles, sourceFileContents),
				tinygo_lowered_program_000_declaration_count: () =>
					loweredIRManifest.units[0].declarations.length,
				tinygo_lowered_program_000_declaration_name_hash: () =>
					expectedDeclarationNameHash(loweredIRManifest.units[0].declarations),
				tinygo_lowered_program_000_declaration_signature_hash: () =>
					expectedDeclarationSignatureHash(loweredIRManifest.units[0].declarations),
				tinygo_lowered_program_000_declaration_kind_hash: () =>
					expectedDeclarationKindHash(loweredIRManifest.units[0].declarations),
				tinygo_lowered_program_000_declaration_exported_count: () =>
					expectedDeclarationExportedCount(loweredIRManifest.units[0].declarations),
				tinygo_lowered_program_000_declaration_exported_name_hash: () =>
					expectedDeclarationExportedNameHash(loweredIRManifest.units[0].declarations),
				tinygo_lowered_program_000_declaration_exported_signature_hash: () =>
					expectedDeclarationExportedSignatureHash(
						loweredIRManifest.units[0].declarations
					),
				tinygo_lowered_program_000_declaration_exported_kind_hash: () =>
					expectedDeclarationExportedKindHash(loweredIRManifest.units[0].declarations),
				tinygo_lowered_program_000_declaration_method_count: () =>
					expectedDeclarationMethodCount(loweredIRManifest.units[0].declarations),
				tinygo_lowered_program_000_declaration_method_name_hash: () =>
					expectedDeclarationMethodNameHash(loweredIRManifest.units[0].declarations),
				tinygo_lowered_program_000_declaration_method_signature_hash: () =>
					expectedDeclarationMethodSignatureHash(loweredIRManifest.units[0].declarations),
				tinygo_lowered_program_000_declaration_method_kind_hash: () =>
					expectedDeclarationMethodKindHash(loweredIRManifest.units[0].declarations),
				tinygo_lowered_program_000_placeholder_block_count: () => 41,
				tinygo_lowered_program_000_placeholder_block_hash: () =>
					expectedPlaceholderBlockHash(loweredIRManifest.units[0]),
				tinygo_lowered_program_000_placeholder_block_signature_hash: () =>
					expectedPlaceholderBlockSignatureHash(loweredIRManifest.units[0]),
				tinygo_lowered_program_000_placeholder_block_runtime_hash: () =>
					expectedPlaceholderBlockHash(loweredIRManifest.units[0]),
				tinygo_lowered_program_000_lowering_block_count: () => 41,
				tinygo_lowered_program_000_lowering_block_hash: () =>
					expectedLoweringBlockHash(loweredIRManifest.units[0]),
				tinygo_lowered_program_000_lowering_block_runtime_hash: () =>
					expectedLoweringBlockHash(loweredIRManifest.units[0]),
				...
				tinygo_lowered_stdlib_000_source_hash: () =>
					expectedSourceHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_import_count: () => 0,
				tinygo_lowered_stdlib_000_import_path_hash: () =>
					expectedImportPathHash(stdlibSourceFiles, sourceFileContents),
				...
				tinygo_lowered_stdlib_000_selector_name_hash: () =>
					expectedSelectorNameHash(stdlibSourceFiles, sourceFileContents),
				...
				tinygo_lowered_stdlib_000_break_label_name_hash: () =>
					expectedBreakLabelNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_continue_statement_count: () => 0,
				tinygo_lowered_stdlib_000_continue_label_name_hash: () =>
					expectedContinueLabelNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_labeled_statement_count: () => 0,
				tinygo_lowered_stdlib_000_label_name_hash: () =>
					expectedLabelNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_goto_statement_count: () => 0,
				tinygo_lowered_stdlib_000_goto_label_name_hash: () =>
					expectedGotoLabelNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_fallthrough_statement_count: () => 0,
				tinygo_lowered_stdlib_000_method_count: () => 0,
				tinygo_lowered_stdlib_000_method_name_hash: () =>
					expectedMethodNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_method_signature_hash: () =>
					expectedMethodSignatureHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_exported_method_name_hash: () =>
					expectedExportedMethodNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_exported_method_signature_hash: () =>
					expectedExportedMethodSignatureHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_exported_function_count: () => 0,
				tinygo_lowered_stdlib_000_exported_function_name_hash: () =>
					expectedExportedFunctionNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_type_count: () => 0,
				tinygo_lowered_stdlib_000_type_name_hash: () =>
					expectedTypeNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_exported_type_count: () => 0,
				tinygo_lowered_stdlib_000_exported_type_name_hash: () =>
					expectedExportedTypeNameHash(stdlibSourceFiles, sourceFileContents),
				...
				tinygo_lowered_stdlib_000_struct_field_name_hash: () =>
					expectedStructFieldNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_struct_field_type_hash: () =>
					expectedStructFieldTypeHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_embedded_struct_field_type_hash: () =>
					expectedEmbeddedStructFieldTypeHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_interface_method_count: () => 0,
				tinygo_lowered_stdlib_000_interface_method_name_hash: () =>
					expectedInterfaceMethodNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_interface_method_signature_hash: () =>
					expectedInterfaceMethodSignatureHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_const_count: () => 0,
				tinygo_lowered_stdlib_000_const_name_hash: () =>
					expectedConstNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_var_count: () => 0,
				tinygo_lowered_stdlib_000_var_name_hash: () =>
					expectedVarNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_exported_const_count: () => 0,
				tinygo_lowered_stdlib_000_exported_const_name_hash: () =>
					expectedExportedConstNameHash(stdlibSourceFiles, sourceFileContents),
				tinygo_lowered_stdlib_000_exported_var_count: () => 0,
				tinygo_lowered_stdlib_000_exported_var_name_hash: () =>
					expectedExportedVarNameHash(stdlibSourceFiles, sourceFileContents),
				...
				tinygo_lowered_stdlib_000_placeholder_block_hash: () =>
					expectedPlaceholderBlockHash(loweredIRManifest.units[1]),
				tinygo_lowered_stdlib_000_placeholder_block_signature_hash: () =>
					expectedPlaceholderBlockSignatureHash(loweredIRManifest.units[1]),
				tinygo_lowered_stdlib_000_placeholder_block_runtime_hash: () =>
					expectedPlaceholderBlockHash(loweredIRManifest.units[1]),
				tinygo_lowered_stdlib_000_lowering_block_count: () => 0,
				tinygo_lowered_stdlib_000_lowering_block_hash: () =>
					expectedLoweringBlockHash(loweredIRManifest.units[1]),
				tinygo_lowered_stdlib_000_lowering_block_runtime_hash: () =>
					expectedLoweringBlockHash(loweredIRManifest.units[1]),
	...
	assert.deepEqual(verification.units, [
		{
			...
			continueLabelNameHash: expectedContinueLabelNameHash(
				programSourceFiles,
				sourceFileContents
			),
			...
			structFieldNameHash: expectedStructFieldNameHash(
				programSourceFiles,
				sourceFileContents
			),
			structFieldTypeHash: expectedStructFieldTypeHash(
				programSourceFiles,
				sourceFileContents
			),
			embeddedStructFieldTypeHash: expectedEmbeddedStructFieldTypeHash(
				programSourceFiles,
				sourceFileContents
			),
			taggedStructFieldTagHash: expectedTaggedStructFieldTagHash(
				programSourceFiles,
				sourceFileContents
			),
			interfaceMethodCount: 1,
			interfaceMethodNameHash: expectedInterfaceMethodNameHash(
				programSourceFiles,
				sourceFileContents
			),
			interfaceMethodSignatureHash: expectedInterfaceMethodSignatureHash(
				programSourceFiles,
				sourceFileContents
			),
			embeddedInterfaceMethodNameHash: expectedEmbeddedInterfaceMethodNameHash(
				programSourceFiles,
				sourceFileContents
			),
			...
			declarationNameHash: expectedDeclarationNameHash(
				loweredIRManifest.units[0].declarations
			),
			declarationSignatureHash: expectedDeclarationSignatureHash(
				loweredIRManifest.units[0].declarations
			),
			declarationKindHash: expectedDeclarationKindHash(
				loweredIRManifest.units[0].declarations
			),
			declarationExportedCount: expectedDeclarationExportedCount(
				loweredIRManifest.units[0].declarations
			),
			declarationExportedNameHash: expectedDeclarationExportedNameHash(
				loweredIRManifest.units[0].declarations
			),
			declarationExportedSignatureHash: expectedDeclarationExportedSignatureHash(
				loweredIRManifest.units[0].declarations
			),
			declarationExportedKindHash: expectedDeclarationExportedKindHash(
				loweredIRManifest.units[0].declarations
			),
			declarationMethodCount: expectedDeclarationMethodCount(
				loweredIRManifest.units[0].declarations
			),
			declarationMethodNameHash: expectedDeclarationMethodNameHash(
				loweredIRManifest.units[0].declarations
			),
			declarationMethodSignatureHash: expectedDeclarationMethodSignatureHash(
				loweredIRManifest.units[0].declarations
			),
			declarationMethodKindHash: expectedDeclarationMethodKindHash(
				loweredIRManifest.units[0].declarations
			),
			...
			verifyTinyGoLoweredArtifactExports(
				{
					exports: {
						...
						tinygo_lowered_program_000_kind_tag: () => 1,
						tinygo_lowered_program_000_source_hash: () =>
							expectedSourceHash(['/workspace/main.go']),
			...
			verifyTinyGoLoweredArtifactExports(
				{
					exports: {
						...
						tinygo_lowered_imported_000_source_hash: () =>
							expectedSourceHash(['/workspace/lib/helper.go']),
			...
			verifyTinyGoLoweredArtifactExports(
				{
					exports: {
						...
						tinygo_lowered_program_000_import_path_hash: () =>
							expectedImportPathHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\nimport (\n\t_ "unsafe"\n\t. "fmt"\n)\nfunc main() { Println("hi") }\n'
							}),
						tinygo_lowered_program_000_blank_import_count: () => 0,
			...
			verifyTinyGoLoweredArtifactExports(
				{
					exports: {
						...
						tinygo_lowered_program_000_function_count: () => 1,
						tinygo_lowered_program_000_function_name_hash: () =>
							expectedFunctionNameHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\nfunc main() { _ = func(value int) int { return value + 1 } }\n'
							}),
						tinygo_lowered_program_000_func_literal_count: () => 0,
			...
			verifyTinyGoLoweredArtifactExports(
				{
					exports: {
						...
						tinygo_lowered_program_000_labeled_statement_count: () => 1,
						tinygo_lowered_program_000_label_name_hash: () =>
							expectedLabelNameHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\nfunc route(value int) {\nstart:\n\tswitch value {\n\tcase 0:\n\t\tgoto start\n\tcase 1:\n\t\tfallthrough\n\tdefault:\n\t}\n}\n'
							}),
						tinygo_lowered_program_000_goto_statement_count: () => 0,
						tinygo_lowered_program_000_goto_label_name_hash: () =>
							expectedGotoLabelNameHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\nfunc route(value int) {\nstart:\n\tswitch value {\n\tcase 0:\n\t\tgoto start\n\tcase 1:\n\t\tfallthrough\n\tdefault:\n\t}\n}\n'
							}),
						tinygo_lowered_program_000_fallthrough_statement_count: () => 1,
			...
			verifyTinyGoLoweredArtifactExports(
				{
					exports: {
						...
						tinygo_lowered_program_000_method_name_hash: () =>
							expectedMethodNameHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\ntype App struct{}\nfunc (App) serve() {}\nfunc (App) Reset() {}\nfunc (App) Start() {}\nfunc main() {}\n'
							}),
			...
			verifyTinyGoLoweredArtifactExports(
				{
					exports: {
						...
						tinygo_lowered_program_000_method_signature_hash: () =>
							expectedMethodSignatureHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\ntype App struct{}\nfunc (App) serve() {}\nfunc (App) Reset() error { return nil }\nfunc main() {}\n'
							}),
						tinygo_lowered_program_000_exported_method_name_hash: () =>
							expectedExportedMethodNameHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\ntype App struct{}\nfunc (App) serve() {}\nfunc (App) Reset() error { return nil }\nfunc main() {}\n'
							}),
						...
						tinygo_lowered_program_000_type_count: () => 1,
						tinygo_lowered_program_000_type_name_hash: () =>
							expectedTypeNameHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\ntype App struct{}\nfunc (App) serve() {}\nfunc (App) Reset() error { return nil }\nfunc main() {}\n'
							}),
						tinygo_lowered_program_000_exported_type_count: () => 1,
						tinygo_lowered_program_000_exported_type_name_hash: () =>
							expectedExportedTypeNameHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\ntype App struct{}\nfunc (App) serve() {}\nfunc (App) Reset() error { return nil }\nfunc main() {}\n'
							}),
						tinygo_lowered_program_000_struct_type_count: () => 1,
			...
			verifyTinyGoLoweredArtifactExports(
				{
					exports: {
						...
						tinygo_lowered_program_000_tagged_struct_field_count: () => 0,
						tinygo_lowered_program_000_struct_field_name_hash: () =>
							expectedStructFieldNameHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\ntype Base struct{}\ntype Named struct{}\ntype App struct{ Base; Named; Name string }\nfunc main() {}\n'
							}),
						tinygo_lowered_program_000_struct_field_type_hash: () =>
							expectedStructFieldTypeHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\ntype Base struct{}\ntype Named struct{}\ntype App struct{ Base; Named; Name string }\nfunc main() {}\n'
							}),
						tinygo_lowered_program_000_embedded_struct_field_type_hash: () => 0,
			...
			verifyTinyGoLoweredArtifactExports(
				{
					exports: {
						...
						tinygo_lowered_program_000_interface_method_name_hash: () =>
							expectedInterfaceMethodNameHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\ntype Runner interface{ Run() }\ntype Service interface{ Runner; Close() }\nfunc main() {}\n'
							}),
						tinygo_lowered_program_000_interface_method_signature_hash: () =>
							expectedInterfaceMethodSignatureHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\ntype Runner interface{ Run() }\ntype Service interface{ Runner; Close() }\nfunc main() {}\n'
							}),
						tinygo_lowered_program_000_embedded_interface_method_count: () => 0,
			...
			verifyTinyGoLoweredArtifactExports(
				{
					exports: {
						...
						tinygo_lowered_program_000_const_name_hash: () =>
							expectedConstNameHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\nconst (\n\tversion = 1\n\tAppName = "wasm"\n\tBuild, Ready = 1, 2\n)\nfunc main() {}\n'
							}),
						tinygo_lowered_program_000_var_count: () => 0,
			...
			verifyTinyGoLoweredArtifactExports(
				{
					exports: {
						...
						tinygo_lowered_program_000_var_name_hash: () =>
							expectedVarNameHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\nvar (\n\tready = true\n\tAppState = "boot"\n\tCount, Size = 1, 2\n)\nfunc main() {}\n'
							}),
						tinygo_lowered_program_000_exported_const_count: () => 0,
			...
			verifyTinyGoLoweredArtifactExports(
				{
					exports: {
						...
						tinygo_lowered_program_000_embedded_struct_field_type_hash: () =>
							expectedEmbeddedStructFieldTypeHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\ntype Base struct{}\ntype App struct{ Base; Name string; Count, Size int; Ready bool `json:"ready"` }\nfunc main() {}\n'
							}),
						tinygo_lowered_program_000_tagged_struct_field_tag_hash: () =>
							expectedTaggedStructFieldTagHash(['/workspace/main.go'], {
								'/workspace/main.go':
									'package main\ntype Base struct{}\ntype App struct{ Base; Name string; Count, Size int; Ready bool `json:"ready"` }\nfunc main() {}\n'
							}),
						tinygo_lowered_program_000_struct_field_type_hash: () => 0,
...
test('verifyTinyGoLoweredBitcodeFiles accepts llvm bitcode files in deterministic order', () => {
	const verification = verifyTinyGoLoweredBitcodeFiles(
		['/working/tinygo-work/program-000.bc', '/working/tinygo-work/stdlib-000.bc'],
		[
			{
