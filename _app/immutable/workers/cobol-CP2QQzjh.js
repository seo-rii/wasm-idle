...
#endif
`,Ge=String.raw`#ifndef WASM_CLANG_EXT_PB_DS_ASSOC_CONTAINER_HPP
...
#endif
`,Ke=String.raw`#ifndef WASM_CLANG_EXT_PB_DS_HASH_POLICY_HPP
...
#endif
`,qe=String.raw`#ifndef WASM_CLANG_EXT_PB_DS_PRIORITY_QUEUE_HPP
...
#endif
`,Je=String.raw`#ifndef WASM_CLANG_EXT_ROPE
...
#endif
`,Ye=String.raw`#ifndef WASM_CLANG_SETJMP_H
...
#endif
`,Xe=String.raw`#ifndef WASM_CLANG_BITS_STDCPP_H
...
#endif
`,Ze=String.raw`#ifndef WASM_CLANG_BITS_EXTCXX_H
...
#endif
`,Qe=[{path:`include/setjmp.h`,contents:Ye},{path:`include/bits/stdc++.h`,contents:Xe},{path:`include/bits/extc++.h`,contents:Ze},{path:`include/c++/v1/ext/rope`,contents:Je},{path:`include/c++/v1/ext/pb_ds/tree_policy.hpp`,contents:We},{path:`include/c++/v1/ext/pb_ds/assoc_container.hpp`,contents:Ge},{path:`include/c++/v1/ext/pb_ds/hash_policy.hpp`,contents:Ke},{path:`include/c++/v1/ext/pb_ds/priority_queue.hpp`,contents:qe}];function $e(e){e.addDirectory(`include/c++/v1/ext/pb_ds`),e.addDirectory(`include/bits`);for(let t of Qe)e.addFile(t.path,t.contents)}const et=e=>JSON.stringify(e.length>96?e.slice(0,93)+`...`:e);var tt=class{ready;mem=null;hostMem_=null;stdinStr;stdin;stdout;trace;instance=null;exports;out=!0;filePaths=new Set;fileOverlays=new Map;constructor(e){this.stdin=e.stdin,this.stdout=e.stdout,this.stdinStr=e.stdinStr||``,this.trace=e.trace||(()=>{});let t=ee(this,`abort`,`host_write`,`host_read`,`memfs_log`,`copy_in`,`copy_out`);this.ready=(e.maxAssetBytes===void 0?e.signal?L(e.moduleUrl,e.progress,e.signal):L(e.moduleUrl,e.progress):L(e.moduleUrl,e.progress,e.signal,e.maxAssetBytes)).then(e=>WebAssembly.instantiate(e,{env:t})).then(e=>{this.instance=e,this.exports=e.exports,this.mem=new ie(this.exports.memory),this.exports.init()})}set hostMem(e){this.hostMem_=e}setStdinStr(e){this.stdinStr=e}addDirectory(e){this.mem.check(),this.mem.write(this.exports.GetPathBuf(),e),this.exports.AddDirectoryNode(e.length)}addFile(e,t){let n=t instanceof ArrayBuffer?t.byteLength:t.length;this.mem.check(),this.mem.write(this.exports.GetPathBuf(),e);let r=this.exports.AddFileNode(e.length,n),i=this.exports.GetFileNodeAddress(r);this.mem.check(),this.mem.write(i,t),this.filePaths.add(this.normalizePath(e))}setFile(e,t){let n=this.normalizePath(e);this.filePaths.add(n),this.fileOverlays.set(n,Uint8Array.from(t))}hasFile(e){return this.filePaths.has(this.normalizePath(e))}normalizePath(e){return e.replaceAll(`\\`,`/`).replace(/^\.\//,``).replace(/^\/+/,``)}getFileContents(e){let t=this.fileOverlays.get(this.normalizePath(e));if(t)return t;this.mem.check(),this.mem.write(this.exports.GetPathBuf(),e);let n=this.exports.FindNode(e.length),r=this.exports.GetFileNodeAddress(n),i=this.exports.GetFileNodeSize(n);return new Uint8Array(this.mem.buffer,r,i)}abort(){throw this.trace(`abort()`),new Ce}host_write(e,t,n,r){this.hostMem_.check(),Te(e<=2);let i=0,a=``;for(let e=0;e<n;++e){let e=this.hostMem_.read32(t);t+=4;let n=this.hostMem_.read32(t);t+=4,a+=this.hostMem_.readStrR(e,n),i+=n}return this.hostMem_.write32(r,i),this.trace(`host_write(fd=${e}, bytes=${i}, data=${et(a)})`),this.out&&this.stdout(a),0}host_read(e,t,n,r){this.hostMem_.check(),Te(e===0);let i=0;for(let r=0;r<n;++r){let n=this.hostMem_.read32(t);t+=4;let r=this.hostMem_.read32(t);t+=4,this.stdinStr.length||(this.stdinStr=this.stdin());let a=Math.min(r,this.stdinStr.length);if(a===0)break;let o=this.stdinStr.substring(0,a);if(this.hostMem_.write(n,this.stdinStr.substring(0,a)),this.stdinStr=this.stdinStr.substring(a),i+=a,this.trace(`host_read(fd=${e}, bytes=${a}, data=${et(o)})`),a!==r)break}return this.hostMem_.write32(r,i),i===0&&this.trace(`host_read(fd=${e}, bytes=0)`),0}memfs_log(e,t){this.mem.check();let n=this.mem.readStr(e,t);this.trace(`memfs_log(${et(n)})`)}copy_out(e,t,n){this.hostMem_.check();let r=new Uint8Array(this.hostMem_.buffer,e,n);this.mem.check();let i=new Uint8Array(this.mem.buffer,t,n);r.set(i)}copy_in(e,t,n){this.mem.check();let r=new Uint8Array(this.mem.buffer,e,n);this.hostMem_.check();let i=new Uint8Array(this.hostMem_.buffer,t,n);r.set(i)}};function*nt(e){let t=e instanceof Uint8Array?e:new Uint8Array(e),n=0,r=``,i=e=>(n+=e,te(t,n-e,e)),a=e=>(n+=e,re(t,n-e,e)),o=()=>n=n+511&-512;for(;n+512<=t.length;){let e={filename:i(100),mode:a(8),owner:a(8),group:a(8),size:a(12),mtime:a(12),checksum:a(8),type:i(1),linkname:i(100),ustar:i(8)};if(!e.ustar)return;let s={...e,ownerName:i(32),groupName:i(32),devMajor:i(8),devMinor:i(8),filenamePrefix:i(155)};if(o(),(s.size>0||s.type===`0`||s.type===``||s.type===`L`)&&(s.contents=t.subarray(n,n+s.size),n+=s.size,o()),s.type===`L`){s.contents&&(r=te(s.contents,0,s.size));continue}s.filename=r||(s.filenamePrefix?`${s.filenamePrefix}/${s.filename}`:s.filename),r=``,yield s}}function rt(e,t){for(let n of nt(e))switch(n.type){case``:case`0`:t.addFile(n.filename,n.contents);break;case`5`:t.addDirectory(n.filename);break;default:throw Error(`unsupported tar entry type: ${n.type}`)}}const it=`\x1B[92m`,at=`\x1B[0m`,ot=e=>Math.max(0,Math.min(1,Number.isFinite(e)?e:0));function st(e){let t={clang:0,lld:0,memfs:0},n=()=>{e((t.clang+t.lld+t.memfs)/3)},r=e=>({set(r){t[e]=ot(r),n()}});return{clang:r(`clang`),lld:r(`lld`),memfs:r(`memfs`)}}const ct=(e,t)=>{let n=e?.toString().trim();if(!n)throw Error(`${t} is required`);let r;try{r=new URL(n,typeof location<`u`?location.href:void 0)}catch{throw Error(`${t} must be an absolute HTTP(S) URL`)}if(r.protocol!==`http:`&&r.protocol!==`https:`)throw Error(`${t} must use HTTP(S)`);return r},lt=e=>{let t=ct(e,`wasm-clang runtime base URL`);return t.pathname.endsWith(`/`)||(t.pathname+=`/`),t.hash=``,t},B=(e,t)=>new URL(t,lt(e)).toString(),ut=(e,t)=>B(e,t),dt=e=>lt(e).toString(),ft=e=>lt(new URL(`./`,ct(e,`wasm-clang runtime manifest URL`))).toString(),pt=e=>ut(e,`runtime-manifest.v1.json`);function mt(e,t){let n=dt(e);return{manifest:pt(n).toString(),memfs:B(n,t?.compiler.memfs.asset||`bin/memfs.wasm.gz`).toString(),clang:B(n,t?.compiler.clang.asset||`bin/clang.wasm.gz`).toString(),lld:B(n,t?.compiler.lld.asset||`bin/lld.wasm.gz`).toString(),sysroot:B(n,t?.compiler.sysroot.asset||`bin/sysroot.tar.gz`).toString(),clangdJs:B(n,t?.clangd.js||`clangd/clangd.js`).toString(),clangdWasm:B(n,t?.clangd.wasm||`clangd/clangd.wasm.gz`).toString()}}const V=e=>e.replaceAll(`\\`,`/`).split(`/`).filter(e=>e&&e!==`.`&&e!==`..`).join(`/`),ht=e=>{let t=V(e);return t.startsWith(`workspace/`)?t.slice(10):t};function gt(e,t){let n=V(t||``),r=`main`,i=n&&/\.[A-Za-z0-9_-]+$/.test(n)?n:`${n||r}.${e===`C`?`c`:e===`OBJC`?`m`:`cc`}`,a=(i.split(`/`).pop()||i).replace(/\.[^.]+$/,``)||r;return{input:i,obj:`${a}.o`,wasm:`${a}.wasm`}}async function _t(e){let t=typeof e==`string`?new TextEncoder().encode(e):(e instanceof Uint8Array,new Uint8Array(e)),n=await globalThis.crypto.subtle.digest(`SHA-256`,t);return Array.from(new Uint8Array(n),e=>e.toString(16).padStart(2,`0`)).join(``)}async function vt(e,t,n){if(!n)throw Error(`LLDB debug compilation requires compiler provenance in the wasm-clang runtime manifest`);let{input:r}=gt(e.language||`CPP`,ht(e.activePath||``)||ht(e.fileName||``)||void 0),i=new Map;for(let t of e.workspaceFiles||[]){let e=ht(t.path);e&&i.set(e,t.content)}i.set(r,e.code);let a=[...i.entries()].sort(([e],[t])=>e<t?-1:+(e>t));return{kind:`dwarf`,sourceRoot:`/workspace`,moduleSha256:await _t(t),files:await Promise.all(a.map(async([e,t])=>({path:`/workspace/${e}`,contentSha256:await _t(t)}))),compiler:n}}globalThis.document===void 0&&(globalThis.document={querySelectorAll:(()=>[])});const H=`__wasm_idle_build`,yt=/\.(?:c|cc|cpp|cxx)$/,bt=new Set([`-target`,`--target`,`-triple`,`-target-feature`,`-target-cpu`,`-target-abi`,`-mcpu`,`-march`,`-mattr`,`-mthread-model`,`-mllvm`,`-pthread`,`-fopenmp`,`-msimd128`,`-mno-simd128`,`-matomics`,`-mno-atomics`,`-mmemory64`,`-mno-memory64`,`-mshared-memory`,`-mno-shared-memory`,`-mmulti-memory`,`-mno-multi-memory`]),xt=[`-target=`,`--target=`,`-triple=`,`-target-feature=`,`-target-cpu=`,`-target-abi=`,`-mcpu=`,`-march=`,`-mattr=`,`-mthread-model=`,`-mllvm=`];function St(e){return(e||``).trim().toUpperCase().replaceAll(/\s+/g,``)}function Ct(e){switch(St(e)){case`03`:case`CPP03`:case`C++03`:case`GNU++03`:case`GNUC++03`:return`-std=gnu++03`;case`11`:case`CPP11`:case`C++11`:case`GNU++11`:case`GNUC++11`:return`-std=gnu++11`;case`14`:case`CPP14`:case`C++14`:case`GNU++14`:case`GNUC++14`:return`-std=gnu++14`;case`17`:case`CPP17`:case`C++17`:case`GNU++17`:case`GNUC++17`:return`-std=gnu++17`;case`20`:case`CPP20`:case`C++20`:case`GNU++20`:case`GNUC++20`:return`-std=gnu++20`;case`23`:case`CPP23`:case`C++23`:case`GNU++23`:case`GNUC++23`:return`-std=gnu++23`;case`26`:case`CPP26`:case`C++26`:case`GNU++26`:case`GNUC++26`:return`-std=gnu++26`;default:return`-std=gnu++20`}}function wt(e){switch(St(e)){case`99`:case`C99`:case`GNU99`:case`GNUC99`:return`-std=gnu99`;case`11`:case`C11`:case`GNU11`:case`GNUC11`:return`-std=gnu11`;case`17`:case`18`:case`C17`:case`C18`:case`GNU17`:case`GNU18`:case`GNUC17`:case`GNUC18`:return`-std=gnu17`;default:return`-std=gnu11`}}function Tt(e,t){return e===`C`?{languageArg:`c`,standardArg:wt(t.cVersion)}:e===`OBJC`?{languageArg:`objective-c`,standardArg:wt(t.cVersion)}:{languageArg:`c++`,standardArg:Ct(t.cppVersion)}}const Et=e=>{let t=encodeURIComponent(e),n=``;for(let e=0;e<t.length;){let r=t[e];if(e+=1,r==`%`){let r=t.substring(e,e+=2);r&&(n+=String.fromCharCode(parseInt(r,16)))}else n+=r}return n};function Dt(e,t){let n=[...e],r=t,i,a=!1;for(let t=0;t<e.length;t+=1){let o=e[t],s=e[t+1];if(r){n[t]=` `,o===`*`&&s===`/`&&(n[t+1]=` `,t+=1,r=!1);continue}if(i){n[t]=` `,a?a=!1:o===`\\`?a=!0:o===i&&(i=void 0);continue}if(o===`/`&&s===`*`){n[t]=` `,n[t+1]=` `,t+=1,r=!0;continue}if(o===`/`&&s===`/`){for(let r=t;r<e.length;r+=1)n[r]=` `;break}(o===`"`||o===`'`)&&(n[t]=` `,i=o)}return{line:n.join(``),inBlockComment:r}}var Ot=class{ready;memfs;stdout;moduleCache;showTiming;log;debug=!1;debugBreakpoints=new Set;debugPauseOnEntry=!1;debugBuffer;debugInterruptBuffer;debugWatchBuffer;debugWatchResultBuffer;onDebugEvent;debugVariableMetadata={};debugGlobalMetadata=[];debugFunctionMetadata={};lastBuildKey=``;path;assetUrls;compilerConfig;wasm;lastArtifactPath=`main.wasm`;traceStartedAt=0;progress;maxAssetBytes;constructor(e){let t=e.maxAssetBytes??134217728;if(!Number.isSafeInteger(t)||t<=0)throw TypeError(`Clang maxAssetBytes must be a positive safe integer`);this.maxAssetBytes=t,this.moduleCache={},this.stdout=e.stdout||(()=>{}),this.showTiming=e.showTiming||!1,this.log=e.log||!1,this.path=e.runtimeBaseUrl.toString(),this.assetUrls=mt(this.path,e.manifest),this.compilerConfig=e.manifest?.compiler,this.onDebugEvent=e.onDebugEvent,this.progress=st(t=>e.progress?.(t)),this.memfs=new tt({stdout:this.stdout,stdin:e.stdin||(()=>``),moduleUrl:this.assetUrls.memfs,progress:this.progress.memfs,signal:e.signal,maxAssetBytes:t,trace:e=>this.trace(e)});let n=this.getModule(this.assetUrls.clang,this.progress.clang,e.signal),r=this.getModule(this.assetUrls.lld,this.progress.lld,e.signal),i=this.memfs.ready.then(async()=>{let n=e.signal?ye(this.assetUrls.sysroot,void 0,t,e.signal):ye(this.assetUrls.sysroot,void 0,t);await this.hostLogAsync(`Untarring ${this.assetUrls.sysroot}`,n.then(e=>rt(e,this.memfs))),$e(this.memfs)});this.ready=Promise.all([n,r,i]).then(()=>void 0)}hostLog(e){if(!this.log)return;let t=`[1;93m>${at} `;this.stdout(`${t}${e}`)}beginTrace(e){this.debug=e,this.traceStartedAt=Date.now()}trace(e){if(!this.debug||!this.log)return;let t=Date.now()-this.traceStartedAt;this.stdout(`\x1b[2m[debug +${t}ms] ${e}\x1b[0m\n`)}async hostLogAsync(e,t){let n=+new Date;this.hostLog(`${e}...`);let r=await t,i=+new Date;return this.log&&this.stdout(` done.`),this.showTiming&&this.stdout(` ${it}(${i-n}ms)${at}\n`),this.log&&this.stdout(`
`),r}async getModule(e,t,n){if(this.moduleCache[e])return this.moduleCache[e];let r=await this.hostLogAsync(`Fetching and compiling ${e}`,L(e,t,n,this.maxAssetBytes));return this.moduleCache[e]=r,r}addWorkspaceDirectories(e,t=new Set){let n=V(e).split(`/`).slice(0,-1),r=``;for(let e of n)r=r?`${r}/${e}`:e,t.has(r)||(this.memfs.addDirectory(r),t.add(r))}addWorkspaceFiles(e=[],t=``){let n=new Set,r=V(t);for(let t of e){let e=V(t.path);!e||e===r||(this.addWorkspaceDirectories(e,n),this.memfs.addFile(e,Et(t.content)))}}async compile(e){let t=V(e.input||`main.cc`)||`main.cc`,n=e.code,r=e.obj,i=e.language===`C`?`C`:e.language===`OBJC`?`OBJC`:`CPP`,a=e.compileArgs??e.args??[],{languageArg:o,standardArg:s}=Tt(i,e),c=M(e),l=c===`trace`,u=c===`lldb`;if(u)for(let e of a){if(typeof e!=`string`)throw TypeError(`LLDB compile arguments must be strings`);if(bt.has(e)||xt.some(t=>e.startsWith(t)))throw Error(`LLDB compile argument ${JSON.stringify(e)} cannot change the WAMR debug target profile`)}let d=c===`none`?e.opt||`2`:`0`;if(l){let e=n.split(`
`),t=!1,r=e.map(e=>{let n=Dt(e,t);return t=n.inBlockComment,n.line}),a=e=>{if(/^(?:do|else)$/.test(e))return!0;if(!/^(?:else\s+)?(?:if|for|while)\s*\(/.test(e))return!1;let t=e.indexOf(`(`),n=0;for(let r=t;r<e.length;r+=1)if(e[r]===`(`&&(n+=1),e[r]===`)`&&(--n,n===0))return e.slice(r+1).trim()===``;return!1},o=new Set,s=!1,c=!1;for(let e=0;e<r.length;e+=1){let t=r[e].trim();if(!t)continue;let n=c,i=n;n&&t.includes(`;`)&&(c=!1),s&&(s=!1,t!==`{`&&(i=!0,!t.includes(`;`)&&!t.includes(`{`)&&!a(t)&&(c=!0))),/^while\s*\(.*\)\s*;$/.test(t)&&(i=!0),i&&o.add(e),a(t)&&(s=!0)}let l=0,u=0,d=0,f=1,p=1,m=new Map,h=new Map,g=new Map,_,v=new Map,y=``,b=[],x=!1;for(let t of e){let e=t;if(x){let t=e.indexOf(`*/`);if(t===-1)continue;e=e.slice(t+2),x=!1}let n=e.indexOf(`/*`);if(n!==-1){let t=e.indexOf(`*/`,n+2);t===-1?(x=!0,e=e.slice(0,n)):e=e.slice(0,n)+e.slice(t+2)}let r=e.indexOf(`//`);r!==-1&&(e=e.slice(0,r));let i=e.trim();if(!y){let e=i.match(/^struct\s+([A-Za-z_]\w*)\s*\{$/);e?.[1]&&(y=e[1],b=[]);continue}if(i===`};`){let e=0,t=1,n=[];for(let r of b){let i=r.kind===`double`?8:r.kind===`bool`||r.kind===`char`?1:4;e%i!==0&&(e+=i-e%i),n.push({name:r.name,kind:r.kind,offset:e}),e+=i,t=Math.max(t,i)}e%t!==0&&(e+=t-e%t),v.set(y,{fields:n,size:Math.max(e,1)}),y=``,b=[];continue}let a=i.match(/^(?:const\s+)?(?:(?:unsigned|signed)\s+)?(?:(?:short|long long|long)\s+)?(int|float|double|bool|char)\s+(.+);$/);if(a)for(let e of a[2].split(`,`)){let t=e.split(`=`)[0]?.trim()||``;if(!t||/[*&\[]/.test(t))continue;let n=t.match(/([A-Za-z_]\w*)\s*$/)?.[1];n&&b.push({name:n,kind:a[1]})}}this.debugVariableMetadata={},this.debugGlobalMetadata=[],this.debugFunctionMetadata={};let S=[],C=i===`CPP`?`extern "C" `:``,w=[`${C}__attribute__((import_module("env"), import_name("__wasm_idle_debug_enter"))) void __wasm_idle_debug_enter(int functionId, int line);`,`${C}__attribute__((import_module("env"), import_name("__wasm_idle_debug_leave"))) void __wasm_idle_debug_leave(int functionId);`,`${C}__attribute__((import_module("env"), import_name("__wasm_idle_debug_value_num"))) void __wasm_idle_debug_value_num(int functionId, int slot, double value);`,`${C}__attribute__((import_module("env"), import_name("__wasm_idle_debug_value_bool"))) void __wasm_idle_debug_value_bool(int functionId, int slot, int value);`,`${C}__attribute__((import_module("env"), import_name("__wasm_idle_debug_value_addr"))) void __wasm_idle_debug_value_addr(int functionId, int slot, int value);`,`${C}__attribute__((import_module("env"), import_name("__wasm_idle_debug_value_text"))) void __wasm_idle_debug_value_text(int functionId, int slot, const char* ptr, int len);`,`${C}__attribute__((import_module("env"), import_name("__wasm_idle_debug_line"))) void __wasm_idle_debug_line(int functionId, int line);`],T=i===`CPP`?[`#include <cstdio>`,`#include <iostream>`,`#include <map>`,`#include <set>`,`#include <string>`,`#include <type_traits>`,`#include <vector>`,...w,`template <typename T>`,`static inline std::string __wasm_idle_debug_format_value(const T& value) {`,`    if constexpr (std::is_same_v<T, bool>) return value ? "true" : "false";`,`    else if constexpr (std::is_same_v<T, char>) return std::string("'") + value + "'";`,`    else if constexpr (std::is_same_v<T, signed char> || std::is_same_v<T, unsigned char>) return std::to_string((int)value);`,`    else if constexpr (std::is_integral_v<T> || std::is_floating_point_v<T>) return std::to_string(value);`,`    else return "?";`,`}`,`template <typename T>`,`static inline void __wasm_idle_debug_emit_vector(int functionId, int slot, const std::vector<T>& values) {`,`    std::string text = "[";`,`    int count = 0;`,`    for (const auto& value : values) {`,`        if (count > 0) text += ", ";`,`        if (count >= 8) { text += "..."; break; }`,`        text += __wasm_idle_debug_format_value(value);`,`        count += 1;`,`    }`,`    text += "]";`,`    __wasm_idle_debug_value_text(functionId, slot, text.c_str(), (int)text.size());`,`}`,`template <typename T>`,`static inline void __wasm_idle_debug_emit_set(int functionId, int slot, const std::set<T>& values) {`,`    std::string text = "{";`,`    int count = 0;`,`    for (const auto& value : values) {`,`        if (count > 0) text += ", ";`,`        if (count >= 8) { text += "..."; break; }`,`        text += __wasm_idle_debug_format_value(value);`,`        count += 1;`,`    }`,`    text += "}";`,`    __wasm_idle_debug_value_text(functionId, slot, text.c_str(), (int)text.size());`,`}`,`template <typename K, typename V>`,`static inline void __wasm_idle_debug_emit_map(int functionId, int slot, const std::map<K, V>& values) {`,`    std::string text = "{";`,`    int count = 0;`,`    for (const auto& entry : values) {`,`        if (count > 0) text += ", ";`,`        if (count >= 8) { text += "..."; break; }`,`        text += __wasm_idle_debug_format_value(entry.first);`,`        text += ": ";`,`        text += __wasm_idle_debug_format_value(entry.second);`,`        count += 1;`,`    }`,`    text += "}";`,`    __wasm_idle_debug_value_text(functionId, slot, text.c_str(), (int)text.size());`,`}`]:[`#include <stdio.h>`,...w];for(let t=0;t<e.length;t+=1){let n=e[t],a=n.match(/^\s*/)?.[0]||``,s=n,c=r[t],y=c.trim(),b=o.has(t),x=u>0&&l>=u,C=u===0&&l===0&&!y.includes(`(`)&&!y.startsWith(`#`),w=/^(while|if|for)\s*\(/.test(y)&&!y.includes(`{`),E=[],D=[],O=new Set,k=C&&y.match(/^(?:const\s+)?(?:(?:unsigned|signed)\s+)?(?:(?:short|long long|long)\s+)?(int|float|double|bool|char)\s+(.+);$/);if(k){let e=k[1]===`bool`?`bool`:`number`,n=[],r=``,i=0;for(let e of k[2]){if(e===`,`&&i===0){r.trim()&&n.push(r.trim()),r=``;continue}e===`{`&&(i+=1),e===`}`&&(i=Math.max(0,i-1)),r+=e}r.trim()&&n.push(r.trim());for(let r of n){let[n]=r.split(`=`),i=n?.trim()||``;if(/[*&\[]/.test(i))continue;let a=i.match(/([A-Za-z_]\w*)\s*$/)?.[1];if(!a)continue;let o=p++;h.set(a,{slot:o,kind:e,fromLine:t+1,toLine:2**53-1}),this.debugGlobalMetadata=[...this.debugGlobalMetadata,{slot:o,name:a,kind:e,fromLine:t+1,toLine:2**53-1}],S.push(`${e===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(0, ${o}, ${a});`)}}let A=C&&y.match(/^(?:const\s+)?([A-Za-z_]\w*)\s+([A-Za-z_]\w*)\s*\[(\d+)\]\s*(?:=.*)?;$/);if(A){let e=v.get(A[1]);if(e){let n=p++;this.debugGlobalMetadata=[...this.debugGlobalMetadata,{slot:n,name:A[2],kind:`array`,length:Number(A[3]),dimensions:[Number(A[3])],structFields:e.fields,structSize:e.size,fromLine:t+1,toLine:2**53-1}],S.push(`__wasm_idle_debug_value_addr(0, ${n}, (int)((unsigned long long)(${A[2]})));`)}}if(x&&!b&&y&&!y.startsWith(`#`)&&y!==`{`&&y!==`}`&&!y.startsWith(`else`)&&!y.startsWith(`case `)&&y!==`case`&&!y.startsWith(`default`)&&!y.startsWith(`catch`)&&!/^(public|private|protected)\s*:/.test(y)&&!y.endsWith(`:`)&&!y.includes(` else `)){E.push(`${a}__wasm_idle_debug_line(${d}, ${t+1});`);let e=y.match(/^(?:const\s+)?(?:(?:unsigned|signed)\s+)?(?:(?:short|long long|long)\s+)?(int|float|double|bool|char)\s+(.+);$/),n=y.match(/^(?:const\s+)?(?:(?:std::)?(vector|set|map))\s*<(.+)>\s+([A-Za-z_]\w*)\s*(?:=.*)?;$/);if(n&&d){let e=p++,r=n[1],i=n[3];O.add(i),g.set(i,{slot:e,container:r,fromLine:t+1,toLine:2**53-1}),this.debugVariableMetadata[d]=[...this.debugVariableMetadata[d]||[],{slot:e,name:i,kind:`text`,fromLine:t+1,toLine:2**53-1}],D.push(`${a}__wasm_idle_debug_emit_${r}(${d}, ${e}, ${i});`)}if(e&&d){let n=e[1]===`bool`?`bool`:`number`,r=[],i=``,o=0,s=0;for(let t of e[2]){if(t===`,`&&o===0&&s===0){i.trim()&&r.push(i.trim()),i=``;continue}t===`(`&&(o+=1),t===`)`&&(o=Math.max(0,o-1)),t===`{`&&(s+=1),t===`}`&&(s=Math.max(0,s-1)),i+=t}i.trim()&&r.push(i.trim());for(let i of r){let[r]=i.split(`=`),o=r?.trim()||``,s=[];for(let e of o.matchAll(/\[(\d+)\]/g))s.push(Number(e[1]));let c=o.match(/([A-Za-z_]\w*)\s*(?=\[\d+\])/);if(s.length&&c){let n=p++;this.debugVariableMetadata[d]=[...this.debugVariableMetadata[d]||[],{slot:n,name:c[1],kind:`array`,elementKind:e[1],length:s[0],dimensions:s,fromLine:t+1,toLine:2**53-1}],D.push(`${a}__wasm_idle_debug_value_addr(${d}, ${n}, (int)((unsigned long long)(${c[1]})));`);continue}if(/[*&]/.test(o))continue;let l=o.match(/([A-Za-z_]\w*)\s*(?:\[[^\]]*\])?$/)?.[1];if(l){if(!m.has(l)){let e=p++;m.set(l,{slot:e,kind:n,fromLine:t+1,toLine:2**53-1}),this.debugVariableMetadata[d]=[...this.debugVariableMetadata[d]||[],{slot:e,name:l,kind:n,fromLine:t+1,toLine:2**53-1}]}if(i.includes(`=`)){let e=m.get(l);e&&D.push(`${a}${e.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${d}, ${e.slot}, ${l});`)}}}}let r=y.match(/^for\s*\(\s*(?:const\s+)?(?:(?:unsigned|signed)\s+)?(?:(?:short|long long|long)\s+)?(int|float|double|bool|char)\s+([A-Za-z_]\w*)\s*=/);if(r&&d){let e=r[1]===`bool`?`bool`:`number`,n=r[2];if(!m.has(n)){let r=p++;m.set(n,{slot:r,kind:e,fromLine:t+1,toLine:2**53-1}),this.debugVariableMetadata[d]=[...this.debugVariableMetadata[d]||[],{slot:r,name:n,kind:e,fromLine:t+1,toLine:2**53-1}]}}if(!w){for(let[e,t]of g){if(O.has(e))continue;let n=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);RegExp(`\\b${n}\\b`).test(y)&&D.push(`${a}__wasm_idle_debug_emit_${t.container}(${d}, ${t.slot}, ${e});`)}for(let[e,n]of m){let r=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);y.startsWith(`for`)&&n.toLine===t+1||(RegExp(`(?:^|[^\\w])(?:\\+\\+|--)\\s*${r}\\b`).test(y)||RegExp(`\\b${r}\\s*(?:(?:<<|>>|[+\\-*/%&|^])?=|\\+\\+|--)`).test(y)||RegExp(`&\\s*${r}\\b`).test(y)||RegExp(`\\b(?:cin|std::cin)\\b[^;]*>>\\s*${r}\\b`).test(y))&&D.push(`${a}${n.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${d}, ${n.slot}, ${e});`)}for(let[e,t]of h){if(m.has(e)||g.has(e))continue;let n=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);(RegExp(`(?:^|[^\\w])(?:\\+\\+|--)\\s*${n}\\b`).test(y)||RegExp(`\\b${n}\\s*(?:(?:<<|>>|[+\\-*/%&|^])?=|\\+\\+|--)`).test(y)||RegExp(`&\\s*${n}\\b`).test(y)||RegExp(`\\b(?:cin|std::cin)\\b[^;]*>>\\s*${n}\\b`).test(y))&&D.push(`${a}${t.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(0, ${t.slot}, ${e});`)}}/^return\b/.test(y)&&E.push(`${a}__wasm_idle_debug_leave(${d});`)}if(u>0&&l===u&&y===`}`&&E.push(`${a}__wasm_idle_debug_leave(${d});`),x&&d&&(/^(while|if)\s*\(/.test(y)||/^for\s*\(/.test(y))){let e=y.match(/^(while|if|for)\b/)?.[1],r=n.indexOf(e||``),i=r>=0?n.indexOf(`(`,r):-1;if(i>=0){let r=-1,o=0;for(let e=i;e<n.length;e+=1){let t=n[e];if(t===`(`&&(o+=1),t===`)`&&(--o,o===0)){r=e;break}for(let[e,t]of h){if(m.has(e)||g.has(e))continue;let n=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);!w&&(RegExp(`(?:^|[^\\w])(?:\\+\\+|--)\\s*${n}\\b`).test(y)||RegExp(`\\b${n}\\s*(?:(?:<<|>>|[+\\-*/%&|^])?=|\\+\\+|--)`).test(y)||RegExp(`&\\s*${n}\\b`).test(y))&&D.push(`${a}${t.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(0, ${t.slot}, ${e});`)}}if(r>i){let a=n.slice(i+1,r);if(e===`for`){let e=[],o=``,c=0;for(let t of a){if(t===`;`&&c===0){e.push(o),o=``;continue}t===`(`&&(c+=1),t===`)`&&(c=Math.max(0,c-1)),o+=t}if(e.push(o),e.length===3&&e[1]?.trim()){let a=e[0].trim(),o=e[2].trim(),c=[],l=[],u=[],f=/^(?:const\s+)?(?:(?:unsigned|signed)\s+)?(?:(?:short|long long|long)\s+)?(?:int|float|double|bool|char)\b/.test(a);for(let[e,t]of m){let n=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),r=RegExp(`(?:^|[^\\w])(?:\\+\\+|--)\\s*${n}\\b|\\b${n}\\s*(?:(?:<<|>>|[+\\-*/%&|^])?=|\\+\\+|--)`);!f&&r.test(a)&&c.push(`${t.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${d}, ${t.slot}, ${e})`),f&&r.test(a)&&l.push(`${t.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${d}, ${t.slot}, ${e})`),r.test(o)&&u.push(`${t.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${d}, ${t.slot}, ${e})`)}let p=c.length&&a?`(${a}, ${c.join(`, `)})`:e[0],h=u.length&&o?`(${o}, ${u.join(`, `)})`:e[2];s=n.slice(0,i+1)+`${p}; (${l.length?`${l.join(`, `)}, `:``}__wasm_idle_debug_line(${d}, ${t+1}), (${e[1].trim()})); ${h}`+n.slice(r)}}else{let e=[];if(w){for(let[t,n]of m){let r=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);RegExp(`(?:^|[^\\w])(?:\\+\\+|--)\\s*${r}\\b|\\b${r}\\s*(?:(?:<<|>>|[+\\-*/%&|^])?=|\\+\\+|--)`).test(a)&&e.push(`${n.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${d}, ${n.slot}, ${t})`)}for(let[t,n]of h){if(m.has(t)||g.has(t))continue;let r=t.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);RegExp(`(?:^|[^\\w])(?:\\+\\+|--)\\s*${r}\\b|\\b${r}\\s*(?:(?:<<|>>|[+\\-*/%&|^])?=|\\+\\+|--)`).test(a)&&e.push(`${n.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(0, ${n.slot}, ${t})`)}}let o=e.length?`((${a.trim()}) ? (${e.join(`, `)}, 1) : (${e.join(`, `)}, 0))`:`(${a.trim()})`;s=n.slice(0,i+1)+`(__wasm_idle_debug_line(${d}, ${t+1}), ${o})`+n.slice(r)}}}}T.push(...E),T.push(s),T.push(...D);let j=u===0&&y.includes(`(`)&&y.includes(`)`)&&y.includes(`{`)&&(c.match(/{/g)||[]).length>(c.match(/}/g)||[]).length&&!/^(if|for|while|switch|catch)\b/.test(y)&&!/^(class|struct|namespace|enum|union)\b/.test(y),M=u===0&&!!_&&y===`{`;if(l+=(c.match(/{/g)||[]).length,l-=(c.match(/}/g)||[]).length,j||M){u=l,d=f++;let e=`anonymous`,n=i===`OBJC`&&j?y.match(/^([-+])\s*\([^)]*\)\s*([A-Za-z_]\w*)/):null;if(j?(e=y.slice(0,y.indexOf(`(`)).trim().split(/\s+/).pop()||e,n&&(e=`${n[1]}${n[2]}`)):_&&(e=_.functionName||e),this.debugFunctionMetadata[d]=e,p=1,m=new Map,g=new Map,T.push(`${a}    __wasm_idle_debug_enter(${d}, ${t+1});`),e===`main`){i===`CPP`&&(T.push(`${a}    std::cout.setf(std::ios::unitbuf);`),T.push(`${a}    std::cerr.setf(std::ios::unitbuf);`));let e=i===`CPP`?`nullptr`:`NULL`;T.push(`${a}    setvbuf(stdout, ${e}, _IONBF, 0);`),T.push(`${a}    setvbuf(stderr, ${e}, _IONBF, 0);`)}let r=j?n?``:y.slice(y.indexOf(`(`)+1,y.lastIndexOf(`)`)):_?.parameters||``;for(let e of r.split(`,`).map(e=>e.trim()).filter(Boolean)){let n=e.split(`=`)[0]?.trim()||``,r=n.match(/^(?:const\s+)?(?:(?:std::)?(vector|set|map)\s*<.+>)\s*&?\s*([A-Za-z_]\w*)\s*$/);if(r){let e=p++,n=r[1],i=r[2];g.set(i,{slot:e,container:n,fromLine:t+1,toLine:2**53-1}),this.debugVariableMetadata[d]=[...this.debugVariableMetadata[d]||[],{slot:e,name:i,kind:`text`,fromLine:t+1,toLine:2**53-1}],T.push(`${a}    __wasm_idle_debug_emit_${n}(${d}, ${e}, ${i});`);continue}let i=[];for(let e of n.matchAll(/\[(\d+)\]/g))i.push(Number(e[1]));let o=n.match(/([A-Za-z_]\w*)\s*(?=\[\d+\])/);if(i.length&&o&&/\b(int|float|double|bool|char)\b/.test(n)){let e=p++;this.debugVariableMetadata[d]=[...this.debugVariableMetadata[d]||[],{slot:e,name:o[1],kind:`array`,elementKind:n.match(/\b(int|float|double|bool|char)\b/)?.[1]||`int`,length:i[0],dimensions:i,fromLine:t+1,toLine:2**53-1}],T.push(`${a}    __wasm_idle_debug_value_addr(${d}, ${e}, (int)((unsigned long long)(${o[1]})));`);continue}if(/[*&\[]/.test(n))continue;let s=n.match(/([A-Za-z_]\w*)\s*(?:\[[^\]]*\])?\s*$/);if(!s)continue;let c=s[1],l=/\bbool\b/.test(n)?`bool`:/\b(?:int|float|double|char|short|long)\b/.test(n)?`number`:``;if(!l)continue;let u=p++;m.set(c,{slot:u,kind:l,fromLine:t+1,toLine:2**53-1}),this.debugVariableMetadata[d]=[...this.debugVariableMetadata[d]||[],{slot:u,name:c,kind:l,fromLine:t+1,toLine:2**53-1}],T.push(`${a}    ${l===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${d}, ${u}, ${c});`)}_=void 0}else u===0&&y.includes(`(`)&&y.includes(`)`)&&!y.includes(`{`)&&!y.endsWith(`;`)&&!/^(if|for|while|switch|catch)\b/.test(y)&&!/^(class|struct|namespace|enum|union)\b/.test(y)?_={functionName:y.slice(0,y.indexOf(`(`)).trim().split(/\s+/).pop()||`anonymous`,parameters:y.slice(y.indexOf(`(`)+1,y.lastIndexOf(`)`))}:y&&y!==`{`&&(_=void 0);u>0&&l<u&&(u=0,d=0,m=new Map,g=new Map)}S.length&&(i===`CPP`?(T.push(`struct __wasm_idle_debug_globals_init {`),T.push(`    __wasm_idle_debug_globals_init() {`),T.push(...S.map(e=>`        ${e}`)),T.push(`    }`),T.push(`} __wasm_idle_debug_globals_init_instance;`)):(T.push(`__attribute__((constructor)) static void __wasm_idle_debug_globals_init(void) {`),T.push(...S.map(e=>`    ${e}`)),T.push(`}`))),n=T.join(`
`)}else this.debugVariableMetadata={},this.debugGlobalMetadata=[],this.debugFunctionMetadata={};typeof e.transformSource==`function`&&(n=e.transformSource(n));let f=Et(n);await this.ready,e.sourceAlreadyMounted||(this.addWorkspaceFiles(e.workspaceFiles,t),this.addWorkspaceDirectories(t),this.memfs.addFile(t,f)),this.memfs.addFile(r,new Uint8Array);let p=await this.getModule(this.assetUrls.clang),m=this.compilerConfig?.resourceDir||`/lib/clang/8.0.1`,h=`${m.replace(/\/+$/,``)}/include`,g=[`-cc1`,`-triple`,`wasm32-wasi`,`-emit-obj`,`-disable-free`,`-isysroot`,`/`,`-resource-dir`,m,...i===`CPP`?[`-internal-isystem`,`/include/c++/v1`,`-internal-isystem`,h,`-internal-isystem`,`/include/wasm32-wasi`,`-internal-isystem`,`/include`]:[`-internal-isystem`,h,`-internal-isystem`,`/include/wasm32-wasi`,`-internal-isystem`,`/include`],...i===`OBJC`?[`-I.`]:[],`-ferror-limit`,`19`,`-fcolor-diagnostics`,...u?[]:[`-O`+d],`-o`,r,s,`-x`,o,...i===`OBJC`?[`-fobjc-runtime=gnustep-2.0`,`-fblocks`]:[],t,...a,...u?[`-O0`,`-debug-info-kind=standalone`,`-dwarf-version=4`,`-debugger-tuning=gdb`,`-fdebug-compilation-dir=/workspace`]:[]];this.trace(`compile ${t} -> ${r}`);try{return await this.run(p,!0,`clang`,...g)}catch(e){if(Uint8Array.from(this.memfs.getFileContents(r)).length>0)return this.trace(`recover ${r} after clang output stream exit`),null;throw e}}async link(e,t,n=`none`){let r=typeof e==`string`?[e]:[...e];if(r.length===0||r.some(e=>typeof e!=`string`||e.length===0))throw TypeError(`At least one nonempty object file is required for linking`);let i=M(typeof n==`boolean`?{debug:n}:{debugMode:n}),a=`lib/wasm32-wasi`,o=this.compilerConfig?.compilerRuntimeLibDir||`lib/clang/8.0.1/lib/wasi`,s=`${a}/crt1.o`;await this.ready;let c=await this.getModule(this.assetUrls.lld);return this.trace(`link ${r.join(`, `)} -> ${t}`),await this.run(c,this.log,`wasm-ld`,`--export-dynamic`,...i===`trace`?[`--allow-undefined`]:[],`-z`,`stack-size=1048576`,`-L${a}/noeh`,`-L${a}`,s,...r,`-lc`,`-lc++`,`-lc++abi`,`-lm`,`-L${o}`,`-lclang_rt.builtins-wasm32`,`-o`,t)}async run(e,t,...n){return this.runWithOptions(e,t,n)}async runWithOptions(e,t,n,r={},i,a){this.memfs.out=t,this.hostLog(`${n.join(` `)}\n`),this.trace(`run ${n.join(` `)}`);let o=+new Date,s=new Ue(e,this.memfs,n[0],...n.slice(1),{extraImports:i,instanceRef:a});s.environ={...s.environ,...r},s.trace=e=>this.trace(e),s.debugSession={buffer:this.debugBuffer,interruptBuffer:this.debugInterruptBuffer,watchBuffer:this.debugWatchBuffer,watchResultBuffer:this.debugWatchResultBuffer,breakpoints:new Set(this.debugBreakpoints),breakpointVersion:0,pauseOnEntry:this.debugPauseOnEntry,stepArmed:this.debugPauseOnEntry,nextLineArmed:!1,stepOutArmed:!1,callDepth:0,stepOutDepth:0,currentFunctionId:0,currentLine:0,resumeSkipActive:!1,resumeSkipFunctionId:0,resumeSkipLine:0,nextLineFunctionId:0,nextLineLine:0,variableMetadata:this.debugVariableMetadata,globalVariableMetadata:this.debugGlobalMetadata,functionMetadata:this.debugFunctionMetadata,frames:[],globalValues:new Map,onPause:e=>this.onDebugEvent?.(e)};let c=+new Date,l=await s.run(),u=+new Date;return this.log&&this.stdout(`
`),this.showTiming&&this.stdout(`${it}(${o-c}ms/${u-c}ms)${at}\n`),l?s:null}async compileLink(e,t={}){let{language:n=`CPP`,fileName:r,activePath:i,workspaceFiles:a=[],args:o=[],compileArgs:s=o,debugMode:c,debug:l,breakpoints:u=[],pauseOnEntry:d=!1,cppVersion:f,cVersion:p,debugBuffer:m,interruptBuffer:h,watchBuffer:g,watchResultBuffer:_}=t,v=M({debugMode:c,debug:l}),y=v===`lldb`?ht:V,b=a.map(e=>({...e,path:y(e.path)})),{input:x,obj:S,wasm:C}=gt(n,y(i||``)||y(r||``)||void 0),w=new Map;for(let e of b)if(e.path){if(e.path===H||e.path.startsWith(`${H}/`))throw Error(`Workspace path uses reserved build namespace ${JSON.stringify(H)}`);w.set(e.path,e)}if(x===H||x.startsWith(`${H}/`))throw Error(`Active source path uses reserved build namespace ${JSON.stringify(H)}`);w.set(x,{path:x,content:e});let T=[...w.values()].sort((e,t)=>e.path<t.path?-1:+(e.path>t.path)),E=T.filter(e=>e.path===x||yt.test(e.path)),D=v===`trace`;if(D&&E.length>1)throw Error(`Trace debug mode does not support multiple C/C++ translation units`);this.beginTrace(D),this.debugBreakpoints=new Set(D?u:[]),this.debugPauseOnEntry=D&&d,this.debugBuffer=m,this.debugInterruptBuffer=h,this.debugWatchBuffer=g,this.debugWatchResultBuffer=_,this.lastArtifactPath=C;let O=JSON.stringify({code:e,input:x,wasm:C,language:n,compileArgs:s,workspaceFiles:T,cppVersion:f,cVersion:p,debugMode:v});if(this.lastBuildKey===O)return this.trace(`reuse ${C}`),this.wasm;if(E.length===1)await this.compile({input:x,code:e,obj:S,language:n,compileArgs:s,workspaceFiles:b,cppVersion:f,cVersion:p,debugMode:v}),await this.link(S,C,v);else{await this.ready,this.addWorkspaceFiles(T),this.memfs.addDirectory(H),this.memfs.addDirectory(`${H}/objects`);let e=[];for(let[t,r]of E.entries()){let i=`${H}/objects/${t.toString().padStart(4,`0`)}.o`;e.push(i),await this.compile({input:r.path,code:r.content,obj:i,language:r.path===x?n:r.path.endsWith(`.c`)?`C`:`CPP`,compileArgs:s,workspaceFiles:[],cppVersion:f,cVersion:p,debugMode:v,sourceAlreadyMounted:!0})}await this.link(e,C,v)}this.lastBuildKey=O;let k=Uint8Array.from(this.memfs.getFileContents(C));return this.wasm=await this.hostLogAsync(`Compiling ${C}`,WebAssembly.compile(k))}async compileArtifact(e,t={}){let n=M(t),r=await this.compileLink(e,t),i=Uint8Array.from(this.memfs.getFileContents(this.lastArtifactPath)),a=t.language||`CPP`,o={code:e,language:a,fileName:t.fileName,activePath:t.activePath,workspaceFiles:t.workspaceFiles,compileArgs:t.compileArgs,cppVersion:t.cppVersion,cVersion:t.cVersion,debugMode:n};return{bytes:i,wasm:r,target:`wasm32-wasi`,format:`wasi-core-wasm`,fileName:this.lastArtifactPath,language:a,...n===`trace`?{debugMetadata:{variableMetadata:this.debugVariableMetadata,globalVariableMetadata:this.debugGlobalMetadata,functionMetadata:this.debugFunctionMetadata}}:{},...n===`lldb`?{debug:await vt(o,i,this.compilerConfig?.provenance)}:{}}}async compileLinkRun(e,t={}){let{language:n=`CPP`,fileName:r,activePath:i,workspaceFiles:a=[],args:o=[],compileArgs:s=o,programArgs:c=[],debugMode:l,debug:u,breakpoints:d=[],pauseOnEntry:f=!1,cppVersion:p,cVersion:m,debugBuffer:h,interruptBuffer:g,watchBuffer:_,watchResultBuffer:v}=t,y=M({debugMode:l,debug:u});if(y===`lldb`)throw Error(`compileLinkRun() cannot execute LLDB artifacts in the browser WebAssembly engine. Use compileArtifact() and @wasm-idle/llvm-core/debug instead.`);this.debug=y===`trace`;let{wasm:b}=gt(n,V(i||``)||V(r||``)||void 0);return await this.run(await this.compileLink(e,{language:n,fileName:r,activePath:i,workspaceFiles:a,compileArgs:s,debugMode:y,breakpoints:d,pauseOnEntry:f,cppVersion:p,cVersion:m,debugBuffer:h,interruptBuffer:g,watchBuffer:_,watchResultBuffer:v}),!0,b,...c)}};function U(e,t){if(!e||typeof e!=`object`||Array.isArray(e))throw Error(`invalid ${t} in wasm-clang runtime manifest`);return e}function W(e,t){if(typeof e!=`string`||e.length===0)throw Error(`invalid ${t} in wasm-clang runtime manifest`);return e}function kt(e,t){if(e!==`wasm32-wasi`)throw Error(`invalid ${t} in wasm-clang runtime manifest`);return e}function At(e){let t=U(e,`root.compiler.provenance`);if(t.name!==`clang`)throw Error(`invalid root.compiler.provenance.name in wasm-clang runtime manifest`);return{name:`clang`,version:W(t.version,`root.compiler.provenance.version`),revision:W(t.revision,`root.compiler.provenance.revision`)}}function jt(e){let t=U(e,`root.compiler`),n=U(t.sysroot,`root.compiler.sysroot`);return{memfs:{asset:W(U(t.memfs,`root.compiler.memfs`).asset,`root.compiler.memfs.asset`),argv0:W(U(t.memfs,`root.compiler.memfs`).argv0,`root.compiler.memfs.argv0`)},clang:{asset:W(U(t.clang,`root.compiler.clang`).asset,`root.compiler.clang.asset`),argv0:W(U(t.clang,`root.compiler.clang`).argv0,`root.compiler.clang.argv0`)},lld:{asset:W(U(t.lld,`root.compiler.lld`).asset,`root.compiler.lld.asset`),argv0:W(U(t.lld,`root.compiler.lld`).argv0,`root.compiler.lld.argv0`)},sysroot:{asset:W(n.asset,`root.compiler.sysroot.asset`),...typeof n.runtimeRoot==`string`?{runtimeRoot:n.runtimeRoot}:{}},...t.resourceDir===void 0?{}:{resourceDir:W(t.resourceDir,`root.compiler.resourceDir`)},...t.compilerRuntimeLibDir===void 0?{}:{compilerRuntimeLibDir:W(t.compilerRuntimeLibDir,`root.compiler.compilerRuntimeLibDir`)},...typeof t.defaultCppStandard==`string`?{defaultCppStandard:t.defaultCppStandard}:{},...typeof t.defaultCStandard==`string`?{defaultCStandard:t.defaultCStandard}:{},...t.provenance===void 0?{}:{provenance:At(t.provenance)}}}function Mt(e){let t=U(e,`root.clangd`);return{js:W(t.js,`root.clangd.js`),wasm:W(t.wasm,`root.clangd.wasm`)}}function Nt(e,t){let n=U(e,t);if(U(n.execution,`${t}.execution`).kind!==`wasi-preview1`)throw Error(`invalid ${t}.execution.kind in wasm-clang runtime manifest`);if(n.artifactFormat!==`wasi-core-wasm`)throw Error(`invalid ${t}.artifactFormat in wasm-clang runtime manifest`);return{artifactFormat:`wasi-core-wasm`,execution:{kind:`wasi-preview1`}}}function Pt(e){return{"wasm32-wasi":Nt(U(e,`root.targets`)[`wasm32-wasi`],`root.targets.wasm32-wasi`)}}function Ft(e){let t=U(e,`root`);if(t.manifestVersion!==1)throw Error(`invalid root.manifestVersion in wasm-clang runtime manifest`);return{manifestVersion:1,version:W(t.version,`root.version`),defaultTarget:kt(t.defaultTarget,`root.defaultTarget`),compiler:jt(t.compiler),clangd:Mt(t.clangd),targets:Pt(t.targets)}}async function It(e,t=fetch,n,r=le){return Ft(await he(ct(e,`wasm-clang runtime manifest URL`),{fetchImpl:t,label:`wasm-clang runtime manifest`,maxBytes:Math.min(r,le),signal:n}))}function Lt(e){return pt(e)}var Rt=class e{static read_bytes(t,n){let r=new e;return r.buf=t.getUint32(n,!0),r.buf_len=t.getUint32(n+4,!0),r}static read_bytes_array(t,n,r){let i=[];for(let a=0;a<r;a++)i.push(e.read_bytes(t,n+8*a));return i}},zt=class e{static read_bytes(t,n){let r=new e;return r.buf=t.getUint32(n,!0),r.buf_len=t.getUint32(n+4,!0),r}static read_bytes_array(t,n,r){let i=[];for(let a=0;a<r;a++)i.push(e.read_bytes(t,n+8*a));return i}},Bt=class{head_length(){return 24}name_length(){return this.dir_name.byteLength}write_head_bytes(e,t){e.setBigUint64(t,this.d_next,!0),e.setBigUint64(t+8,this.d_ino,!0),e.setUint32(t+16,this.dir_name.length,!0),e.setUint8(t+20,this.d_type)}write_name_bytes(e,t,n){e.set(this.dir_name.slice(0,Math.min(this.dir_name.byteLength,n)),t)}constructor(e,t,n,r){let i=new TextEncoder().encode(n);this.d_next=e,this.d_ino=t,this.d_namlen=i.byteLength,this.d_type=r,this.dir_name=i}},G=class{write_bytes(e,t){e.setUint8(t,this.fs_filetype),e.setUint16(t+2,this.fs_flags,!0),e.setBigUint64(t+8,this.fs_rights_base,!0),e.setBigUint64(t+16,this.fs_rights_inherited,!0)}constructor(e,t){this.fs_rights_base=0n,this.fs_rights_inherited=0n,this.fs_filetype=e,this.fs_flags=t}},Vt=class{write_bytes(e,t){e.setBigUint64(t,this.dev,!0),e.setBigUint64(t+8,this.ino,!0),e.setUint8(t+16,this.filetype),e.setBigUint64(t+24,this.nlink,!0),e.setBigUint64(t+32,this.size,!0),e.setBigUint64(t+38,this.atim,!0),e.setBigUint64(t+46,this.mtim,!0),e.setBigUint64(t+52,this.ctim,!0)}constructor(e,t,n){this.dev=0n,this.nlink=0n,this.atim=0n,this.mtim=0n,this.ctim=0n,this.ino=e,this.filetype=t,this.size=n}},Ht=class e{static read_bytes(t,n){return new e(t.getBigUint64(n,!0),t.getUint8(n+8),t.getUint32(n+16,!0),t.getBigUint64(n+24,!0),t.getUint16(n+36,!0))}constructor(e,t,n,r,i){this.userdata=e,this.eventtype=t,this.clockid=n,this.timeout=r,this.flags=i}},Ut=class{write_bytes(e,t){e.setBigUint64(t,this.userdata,!0),e.setUint16(t+8,this.error,!0),e.setUint8(t+10,this.eventtype)}constructor(e,t,n){this.userdata=e,this.error=t,this.eventtype=n}},Wt=class{write_bytes(e,t){e.setUint32(t,this.pr_name.byteLength,!0)}constructor(e){this.pr_name=new TextEncoder().encode(e)}},Gt=class e{static dir(t){let n=new e;return n.tag=0,n.inner=new Wt(t),n}write_bytes(e,t){e.setUint32(t,this.tag,!0),this.inner.write_bytes(e,t+4)}};let Kt=class{enable(e){this.log=qt(e===void 0?!0:e,this.prefix)}get enabled(){return this.isEnabled}constructor(e){this.isEnabled=e,this.prefix=`wasi:`,this.enable(e)}};function qt(e,t){return e?console.log.bind(console,`%c%s`,`color: #265BA0`,t):()=>{}}const K=new Kt(!1);var Jt=class extends Error{constructor(e){super(`exit with exit code `+e),this.code=e}};let Yt=class{start(e){this.inst=e;try{return e.exports._start(),0}catch(e){if(e instanceof Jt)return e.code;throw e}}initialize(e){this.inst=e,e.exports._initialize&&e.exports._initialize()}constructor(e,t,n,r={}){this.args=[],this.env=[],this.fds=[],K.enable(r.debug),this.args=e,this.env=t,this.fds=n;let i=this;this.wasiImport={args_sizes_get(e,t){let n=new DataView(i.inst.exports.memory.buffer);n.setUint32(e,i.args.length,!0);let r=0;for(let e of i.args)r+=e.length+1;return n.setUint32(t,r,!0),K.log(n.getUint32(e,!0),n.getUint32(t,!0)),0},args_get(e,t){let n=new DataView(i.inst.exports.memory.buffer),r=new Uint8Array(i.inst.exports.memory.buffer),a=t;for(let a=0;a<i.args.length;a++){n.setUint32(e,t,!0),e+=4;let o=new TextEncoder().encode(i.args[a]);r.set(o,t),n.setUint8(t+o.length,0),t+=o.length+1}return K.enabled&&K.log(new TextDecoder(`utf-8`).decode(r.slice(a,t))),0},environ_sizes_get(e,t){let n=new DataView(i.inst.exports.memory.buffer);n.setUint32(e,i.env.length,!0);let r=0;for(let e of i.env)r+=new TextEncoder().encode(e).length+1;return n.setUint32(t,r,!0),K.log(n.getUint32(e,!0),n.getUint32(t,!0)),0},environ_get(e,t){let n=new DataView(i.inst.exports.memory.buffer),r=new Uint8Array(i.inst.exports.memory.buffer),a=t;for(let a=0;a<i.env.length;a++){n.setUint32(e,t,!0),e+=4;let o=new TextEncoder().encode(i.env[a]);r.set(o,t),n.setUint8(t+o.length,0),t+=o.length+1}return K.enabled&&K.log(new TextDecoder(`utf-8`).decode(r.slice(a,t))),0},clock_res_get(e,t){let n;switch(e){case 1:n=5000n;break;case 0:n=1000000n;break;default:return 52}return new DataView(i.inst.exports.memory.buffer).setBigUint64(t,n,!0),0},clock_time_get(e,t,n){let r=new DataView(i.inst.exports.memory.buffer);if(e===0)r.setBigUint64(n,BigInt(new Date().getTime())*1000000n,!0);else if(e==1){let e;try{e=BigInt(Math.round(performance.now()*1e6))}catch{e=0n}r.setBigUint64(n,e,!0)}else r.setBigUint64(n,0n,!0);return 0},fd_advise(e,t,n,r){return i.fds[e]==null?8:0},fd_allocate(e,t,n){return i.fds[e]==null?8:i.fds[e].fd_allocate(t,n)},fd_close(e){if(i.fds[e]!=null){let t=i.fds[e].fd_close();return i.fds[e]=void 0,t}else return 8},fd_datasync(e){return i.fds[e]==null?8:i.fds[e].fd_sync()},fd_fdstat_get(e,t){if(i.fds[e]!=null){let{ret:n,fdstat:r}=i.fds[e].fd_fdstat_get();return r?.write_bytes(new DataView(i.inst.exports.memory.buffer),t),n}else return 8},fd_fdstat_set_flags(e,t){return i.fds[e]==null?8:i.fds[e].fd_fdstat_set_flags(t)},fd_fdstat_set_rights(e,t,n){return i.fds[e]==null?8:i.fds[e].fd_fdstat_set_rights(t,n)},fd_filestat_get(e,t){if(i.fds[e]!=null){let{ret:n,filestat:r}=i.fds[e].fd_filestat_get();return r?.write_bytes(new DataView(i.inst.exports.memory.buffer),t),n}else return 8},fd_filestat_set_size(e,t){return i.fds[e]==null?8:i.fds[e].fd_filestat_set_size(t)},fd_filestat_set_times(e,t,n,r){return i.fds[e]==null?8:i.fds[e].fd_filestat_set_times(t,n,r)},fd_pread(e,t,n,r,a){let o=new DataView(i.inst.exports.memory.buffer),s=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let c=Rt.read_bytes_array(o,t,n),l=0;for(let t of c){let{ret:n,data:c}=i.fds[e].fd_pread(t.buf_len,r);if(n!=0)return o.setUint32(a,l,!0),n;if(s.set(c,t.buf),l+=c.length,r+=BigInt(c.length),c.length!=t.buf_len)break}return o.setUint32(a,l,!0),0}else return 8},fd_prestat_get(e,t){let n=new DataView(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let{ret:r,prestat:a}=i.fds[e].fd_prestat_get();return a?.write_bytes(n,t),r}else return 8},fd_prestat_dir_name(e,t,n){if(i.fds[e]!=null){let{ret:r,prestat:a}=i.fds[e].fd_prestat_get();if(a==null)return r;let o=a.inner.pr_name;return new Uint8Array(i.inst.exports.memory.buffer).set(o.slice(0,n),t),o.byteLength>n?37:0}else return 8},fd_pwrite(e,t,n,r,a){let o=new DataView(i.inst.exports.memory.buffer),s=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let c=zt.read_bytes_array(o,t,n),l=0;for(let t of c){let n=s.slice(t.buf,t.buf+t.buf_len),{ret:c,nwritten:u}=i.fds[e].fd_pwrite(n,r);if(c!=0)return o.setUint32(a,l,!0),c;if(l+=u,r+=BigInt(u),u!=n.byteLength)break}return o.setUint32(a,l,!0),0}else return 8},fd_read(e,t,n,r){let a=new DataView(i.inst.exports.memory.buffer),o=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let s=Rt.read_bytes_array(a,t,n),c=0;for(let t of s){let{ret:n,data:s}=i.fds[e].fd_read(t.buf_len);if(n!=0)return a.setUint32(r,c,!0),n;if(o.set(s,t.buf),c+=s.length,s.length!=t.buf_len)break}return a.setUint32(r,c,!0),0}else return 8},fd_readdir(e,t,n,r,a){let o=new DataView(i.inst.exports.memory.buffer),s=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let c=0;for(;;){let{ret:l,dirent:u}=i.fds[e].fd_readdir_single(r);if(l!=0)return o.setUint32(a,c,!0),l;if(u==null)break;if(n-c<u.head_length()){c=n;break}let d=new ArrayBuffer(u.head_length());if(u.write_head_bytes(new DataView(d),0),s.set(new Uint8Array(d).slice(0,Math.min(d.byteLength,n-c)),t),t+=u.head_length(),c+=u.head_length(),n-c<u.name_length()){c=n;break}u.write_name_bytes(s,t,n-c),t+=u.name_length(),c+=u.name_length(),r=u.d_next}return o.setUint32(a,c,!0),0}else return 8},fd_renumber(e,t){if(i.fds[e]!=null&&i.fds[t]!=null){let n=i.fds[t].fd_close();return n==0?(i.fds[t]=i.fds[e],i.fds[e]=void 0,0):n}else return 8},fd_seek(e,t,n,r){let a=new DataView(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let{ret:o,offset:s}=i.fds[e].fd_seek(t,n);return a.setBigInt64(r,s,!0),o}else return 8},fd_sync(e){return i.fds[e]==null?8:i.fds[e].fd_sync()},fd_tell(e,t){let n=new DataView(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let{ret:r,offset:a}=i.fds[e].fd_tell();return n.setBigUint64(t,a,!0),r}else return 8},fd_write(e,t,n,r){let a=new DataView(i.inst.exports.memory.buffer),o=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let s=zt.read_bytes_array(a,t,n),c=0;for(let t of s){let n=o.slice(t.buf,t.buf+t.buf_len),{ret:s,nwritten:l}=i.fds[e].fd_write(n);if(s!=0)return a.setUint32(r,c,!0),s;if(c+=l,l!=n.byteLength)break}return a.setUint32(r,c,!0),0}else return 8},path_create_directory(e,t,n){let r=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let a=new TextDecoder(`utf-8`).decode(r.slice(t,t+n));return i.fds[e].path_create_directory(a)}else return 8},path_filestat_get(e,t,n,r,a){let o=new DataView(i.inst.exports.memory.buffer),s=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let c=new TextDecoder(`utf-8`).decode(s.slice(n,n+r)),{ret:l,filestat:u}=i.fds[e].path_filestat_get(t,c);return u?.write_bytes(o,a),l}else return 8},path_filestat_set_times(e,t,n,r,a,o,s){let c=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let l=new TextDecoder(`utf-8`).decode(c.slice(n,n+r));return i.fds[e].path_filestat_set_times(t,l,a,o,s)}else return 8},path_link(e,t,n,r,a,o,s){let c=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null&&i.fds[a]!=null){let l=new TextDecoder(`utf-8`).decode(c.slice(n,n+r)),u=new TextDecoder(`utf-8`).decode(c.slice(o,o+s)),{ret:d,inode_obj:f}=i.fds[e].path_lookup(l,t);return f==null?d:i.fds[a].path_link(u,f,!1)}else return 8},path_open(e,t,n,r,a,o,s,c,l){let u=new DataView(i.inst.exports.memory.buffer),d=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let f=new TextDecoder(`utf-8`).decode(d.slice(n,n+r));K.log(f);let{ret:p,fd_obj:m}=i.fds[e].path_open(t,f,a,o,s,c);if(p!=0)return p;i.fds.push(m);let h=i.fds.length-1;return u.setUint32(l,h,!0),0}else return 8},path_readlink(e,t,n,r,a,o){let s=new DataView(i.inst.exports.memory.buffer),c=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let l=new TextDecoder(`utf-8`).decode(c.slice(t,t+n));K.log(l);let{ret:u,data:d}=i.fds[e].path_readlink(l);if(d!=null){let e=new TextEncoder().encode(d);if(e.length>a)return s.setUint32(o,0,!0),8;c.set(e,r),s.setUint32(o,e.length,!0)}return u}else return 8},path_remove_directory(e,t,n){let r=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let a=new TextDecoder(`utf-8`).decode(r.slice(t,t+n));return i.fds[e].path_remove_directory(a)}else return 8},path_rename(e,t,n,r,a,o){let s=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null&&i.fds[r]!=null){let c=new TextDecoder(`utf-8`).decode(s.slice(t,t+n)),l=new TextDecoder(`utf-8`).decode(s.slice(a,a+o)),{ret:u,inode_obj:d}=i.fds[e].path_unlink(c);if(d==null)return u;if(u=i.fds[r].path_link(l,d,!0),u!=0&&i.fds[e].path_link(c,d,!0)!=0)throw`path_link should always return success when relinking an inode back to the original place`;return u}else return 8},path_symlink(e,t,n,r,a){let o=new Uint8Array(i.inst.exports.memory.buffer);return i.fds[n]==null?8:(new TextDecoder(`utf-8`).decode(o.slice(e,e+t)),new TextDecoder(`utf-8`).decode(o.slice(r,r+a)),58)},path_unlink_file(e,t,n){let r=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let a=new TextDecoder(`utf-8`).decode(r.slice(t,t+n));return i.fds[e].path_unlink_file(a)}else return 8},poll_oneoff(e,t,n){if(n===0)return 28;if(n>1)return K.log(`poll_oneoff: only a single subscription is supported`),58;let r=new DataView(i.inst.exports.memory.buffer),a=Ht.read_bytes(r,e),o=a.eventtype,s=a.clockid,c=a.timeout;if(o!==0)return K.log(`poll_oneoff: only clock subscriptions are supported`),58;let l;if(s===1)l=()=>BigInt(Math.round(performance.now()*1e6));else if(s===0)l=()=>BigInt(new Date().getTime())*1000000n;else return 28;let u=a.flags&1?c:l()+c;for(;u>l(););return new Ut(a.userdata,0,o).write_bytes(r,t),0},proc_exit(e){throw new Jt(e)},proc_raise(e){throw`raised signal `+e},sched_yield(){},random_get(e,t){let n=new Uint8Array(i.inst.exports.memory.buffer).subarray(e,e+t);if(`crypto`in globalThis&&(typeof SharedArrayBuffer>`u`||!(i.inst.exports.memory.buffer instanceof SharedArrayBuffer)))for(let e=0;e<t;e+=65536)crypto.getRandomValues(n.subarray(e,e+65536));else for(let e=0;e<t;e++)n[e]=Math.random()*256|0},sock_recv(e,t,n){throw`sockets not supported`},sock_send(e,t,n){throw`sockets not supported`},sock_shutdown(e,t){throw`sockets not supported`},sock_accept(e,t){throw`sockets not supported`}}}};var Xt=class{fd_allocate(e,t){return 58}fd_close(){return 0}fd_fdstat_get(){return{ret:58,fdstat:null}}fd_fdstat_set_flags(e){return 58}fd_fdstat_set_rights(e,t){return 58}fd_filestat_get(){return{ret:58,filestat:null}}fd_filestat_set_size(e){return 58}fd_filestat_set_times(e,t,n){return 58}fd_pread(e,t){return{ret:58,data:new Uint8Array}}fd_prestat_get(){return{ret:58,prestat:null}}fd_pwrite(e,t){return{ret:58,nwritten:0}}fd_read(e){return{ret:58,data:new Uint8Array}}fd_readdir_single(e){return{ret:58,dirent:null}}fd_seek(e,t){return{ret:58,offset:0n}}fd_sync(){return 0}fd_tell(){return{ret:58,offset:0n}}fd_write(e){return{ret:58,nwritten:0}}path_create_directory(e){return 58}path_filestat_get(e,t){return{ret:58,filestat:null}}path_filestat_set_times(e,t,n,r,i){return 58}path_link(e,t,n){return 58}path_unlink(e){return{ret:58,inode_obj:null}}path_lookup(e,t){return{ret:58,inode_obj:null}}path_open(e,t,n,r,i,a){return{ret:54,fd_obj:null}}path_readlink(e){return{ret:58,data:null}}path_remove_directory(e){return 58}path_rename(e,t,n){return 58}path_unlink_file(e){return 58}},q=class e{static issue_ino(){return e.next_ino++}static root_ino(){return 0n}constructor(){this.ino=e.issue_ino()}};q.next_ino=1n;var Zt=class extends Xt{fd_allocate(e,t){if(!(this.file.size>e+t)){let n=new Uint8Array(Number(e+t));n.set(this.file.data,0),this.file.data=n}return 0}fd_fdstat_get(){return{ret:0,fdstat:new G(4,0)}}fd_filestat_set_size(e){if(this.file.size>e)this.file.data=new Uint8Array(this.file.data.buffer.slice(0,Number(e)));else{let t=new Uint8Array(Number(e));t.set(this.file.data,0),this.file.data=t}return 0}fd_read(e){let t=this.file.data.slice(Number(this.file_pos),Number(this.file_pos+BigInt(e)));return this.file_pos+=BigInt(t.length),{ret:0,data:t}}fd_pread(e,t){return{ret:0,data:this.file.data.slice(Number(t),Number(t+BigInt(e)))}}fd_seek(e,t){let n;switch(t){case 0:n=e;break;case 1:n=this.file_pos+e;break;case 2:n=BigInt(this.file.data.byteLength)+e;break;default:return{ret:28,offset:0n}}return n<0?{ret:28,offset:0n}:(this.file_pos=n,{ret:0,offset:this.file_pos})}fd_tell(){return{ret:0,offset:this.file_pos}}fd_write(e){if(this.file.readonly)return{ret:8,nwritten:0};if(this.file_pos+BigInt(e.byteLength)>this.file.size){let t=this.file.data;this.file.data=new Uint8Array(Number(this.file_pos+BigInt(e.byteLength))),this.file.data.set(t)}return this.file.data.set(e,Number(this.file_pos)),this.file_pos+=BigInt(e.byteLength),{ret:0,nwritten:e.byteLength}}fd_pwrite(e,t){if(this.file.readonly)return{ret:8,nwritten:0};if(t+BigInt(e.byteLength)>this.file.size){let n=this.file.data;this.file.data=new Uint8Array(Number(t+BigInt(e.byteLength))),this.file.data.set(n)}return this.file.data.set(e,Number(t)),{ret:0,nwritten:e.byteLength}}fd_filestat_get(){return{ret:0,filestat:this.file.stat()}}constructor(e){super(),this.file_pos=0n,this.file=e}},Qt=class extends Xt{fd_seek(e,t){return{ret:8,offset:0n}}fd_tell(){return{ret:8,offset:0n}}fd_allocate(e,t){return 8}fd_fdstat_get(){return{ret:0,fdstat:new G(3,0)}}fd_readdir_single(e){if(K.enabled&&(K.log(`readdir_single`,e),K.log(e,this.dir.contents.keys())),e==0n)return{ret:0,dirent:new Bt(1n,this.dir.ino,`.`,3)};if(e==1n)return{ret:0,dirent:new Bt(2n,this.dir.parent_ino(),`..`,3)};if(e>=BigInt(this.dir.contents.size)+2n)return{ret:0,dirent:null};let[t,n]=Array.from(this.dir.contents.entries())[Number(e-2n)];return{ret:0,dirent:new Bt(e+1n,n.ino,t,n.stat().filetype)}}path_filestat_get(e,t){let{ret:n,path:r}=J.from(t);if(r==null)return{ret:n,filestat:null};let{ret:i,entry:a}=this.dir.get_entry_for_path(r);return a==null?{ret:i,filestat:null}:{ret:0,filestat:a.stat()}}path_lookup(e,t){let{ret:n,path:r}=J.from(e);if(r==null)return{ret:n,inode_obj:null};let{ret:i,entry:a}=this.dir.get_entry_for_path(r);return a==null?{ret:i,inode_obj:null}:{ret:0,inode_obj:a}}path_open(e,t,n,r,i,a){let{ret:o,path:s}=J.from(t);if(s==null)return{ret:o,fd_obj:null};let{ret:c,entry:l}=this.dir.get_entry_for_path(s);if(l==null){if(c!=44)return{ret:c,fd_obj:null};if((n&1)==1){let{ret:e,entry:r}=this.dir.create_entry_for_path(t,(n&2)==2);if(r==null)return{ret:e,fd_obj:null};l=r}else return{ret:44,fd_obj:null}}else if((n&4)==4)return{ret:20,fd_obj:null};return(n&2)==2&&l.stat().filetype!==3?{ret:54,fd_obj:null}:l.path_open(n,r,a)}path_create_directory(e){return this.path_open(0,e,3,0n,0n,0).ret}path_link(e,t,n){let{ret:r,path:i}=J.from(e);if(i==null)return r;if(i.is_dir)return 44;let{ret:a,parent_entry:o,filename:s,entry:c}=this.dir.get_parent_dir_and_entry_for_path(i,!0);if(o==null||s==null)return a;if(c!=null){let e=t.stat().filetype==3,r=c.stat().filetype==3;if(e&&r)if(n&&c instanceof Y){if(c.contents.size!=0)return 55}else return 20;else if(e&&!r)return 54;else if(!e&&r)return 31;else if(!(t.stat().filetype==4&&c.stat().filetype==4))return 20}return!n&&t.stat().filetype==3?63:(o.contents.set(s,t),0)}path_unlink(e){let{ret:t,path:n}=J.from(e);if(n==null)return{ret:t,inode_obj:null};let{ret:r,parent_entry:i,filename:a,entry:o}=this.dir.get_parent_dir_and_entry_for_path(n,!0);return i==null||a==null?{ret:r,inode_obj:null}:o==null?{ret:44,inode_obj:null}:(i.contents.delete(a),{ret:0,inode_obj:o})}path_unlink_file(e){let{ret:t,path:n}=J.from(e);if(n==null)return t;let{ret:r,parent_entry:i,filename:a,entry:o}=this.dir.get_parent_dir_and_entry_for_path(n,!1);return i==null||a==null||o==null?r:o.stat().filetype===3?31:(i.contents.delete(a),0)}path_remove_directory(e){let{ret:t,path:n}=J.from(e);if(n==null)return t;let{ret:r,parent_entry:i,filename:a,entry:o}=this.dir.get_parent_dir_and_entry_for_path(n,!1);return i==null||a==null||o==null?r:!(o instanceof Y)||o.stat().filetype!==3?54:o.contents.size===0?i.contents.delete(a)?0:44:55}fd_filestat_get(){return{ret:0,filestat:this.dir.stat()}}fd_filestat_set_size(e){return 8}fd_read(e){return{ret:8,data:new Uint8Array}}fd_pread(e,t){return{ret:8,data:new Uint8Array}}fd_write(e){return{ret:8,nwritten:0}}fd_pwrite(e,t){return{ret:8,nwritten:0}}constructor(e){super(),this.dir=e}},$t=class extends Qt{fd_prestat_get(){return{ret:0,prestat:Gt.dir(this.prestat_name)}}constructor(e,t){super(new Y(t)),this.prestat_name=e}},en=class extends q{path_open(e,t,n){if(this.readonly&&(t&BigInt(64))==BigInt(64))return{ret:63,fd_obj:null};if((e&8)==8){if(this.readonly)return{ret:63,fd_obj:null};this.data=new Uint8Array([])}let r=new Zt(this);return n&1&&r.fd_seek(0n,2),{ret:0,fd_obj:r}}get size(){return BigInt(this.data.byteLength)}stat(){return new Vt(this.ino,4,this.size)}constructor(e,t){super(),this.data=new Uint8Array(e),this.readonly=!!t?.readonly}};let J=class e{static from(t){let n=new e;if(n.is_dir=t.endsWith(`/`),t.startsWith(`/`))return{ret:76,path:null};if(t.includes(`\0`))return{ret:28,path:null};for(let e of t.split(`/`))if(!(e===``||e===`.`)){if(e===`..`){if(n.parts.pop()==null)return{ret:76,path:null};continue}n.parts.push(e)}return{ret:0,path:n}}to_path_string(){let e=this.parts.join(`/`);return this.is_dir&&(e+=`/`),e}constructor(){this.parts=[],this.is_dir=!1}};var Y=class e extends q{parent_ino(){return this.parent==null?q.root_ino():this.parent.ino}path_open(e,t,n){return{ret:0,fd_obj:new Qt(this)}}stat(){return new Vt(this.ino,3,0n)}get_entry_for_path(t){let n=this;for(let r of t.parts){if(!(n instanceof e))return{ret:54,entry:null};let t=n.contents.get(r);if(t!==void 0)n=t;else return K.log(r),{ret:44,entry:null}}return t.is_dir&&n.stat().filetype!=3?{ret:54,entry:null}:{ret:0,entry:n}}get_parent_dir_and_entry_for_path(t,n){let r=t.parts.pop();if(r===void 0)return{ret:28,parent_entry:null,filename:null,entry:null};let{ret:i,entry:a}=this.get_entry_for_path(t);if(a==null)return{ret:i,parent_entry:null,filename:null,entry:null};if(!(a instanceof e))return{ret:54,parent_entry:null,filename:null,entry:null};let o=a.contents.get(r);return o===void 0?n?{ret:0,parent_entry:a,filename:r,entry:null}:{ret:44,parent_entry:null,filename:null,entry:null}:t.is_dir&&o.stat().filetype!=3?{ret:54,parent_entry:null,filename:null,entry:null}:{ret:0,parent_entry:a,filename:r,entry:o}}create_entry_for_path(t,n){let{ret:r,path:i}=J.from(t);if(i==null)return{ret:r,entry:null};let{ret:a,parent_entry:o,filename:s,entry:c}=this.get_parent_dir_and_entry_for_path(i,!0);if(o==null||s==null)return{ret:a,entry:null};if(c!=null)return{ret:20,entry:null};K.log(`create`,i);let l;return l=n?new e(new Map):new en(new ArrayBuffer(0)),o.contents.set(s,l),c=l,{ret:0,entry:c}}constructor(t){super(),this.parent=null,t instanceof Array?this.contents=new Map(t):this.contents=t;for(let t of this.contents.values())t instanceof e&&(t.parent=this)}};function tn(e){let t=e.replace(/\\/g,`/`),n=t.startsWith(`/`)?t:`/${t}`,r=[];for(let t of n.split(`/`))if(!(!t||t===`.`)){if(t===`..`)throw Error(`wasm-clang does not allow guest path traversal: ${e}`);r.push(t)}return`/${r.join(`/`)}`}function nn(e){return typeof e==`string`?new TextEncoder().encode(e):(e instanceof Uint8Array,new Uint8Array(e))}var rn=class extends Xt{ino=q.issue_ino();decoder=new TextDecoder;chunks=[];output;constructor(e){super(),this.output=e}fd_filestat_get(){return{ret:0,filestat:new Vt(this.ino,2,0n)}}fd_fdstat_get(){let e=new G(2,0);return e.fs_rights_base=BigInt(64),{ret:0,fdstat:e}}fd_write(e){let t=this.decoder.decode(e,{stream:!0});return this.chunks.push(t),this.output?.(t),{ret:0,nwritten:e.byteLength}}getText(){let e=this.decoder.decode();return e&&(this.chunks.push(e),this.output?.(e)),this.chunks.join(``)}},an=class{currentChunk=new Uint8Array;currentOffset=0;readInput;constructor(e){this.readInput=e}read(e){for(;this.currentOffset>=this.currentChunk.length;){let e=this.readInput?.();if(e==null)return new Uint8Array;this.currentChunk=nn(e),this.currentOffset=0,this.currentChunk.byteLength}let t=this.currentChunk.slice(this.currentOffset,this.currentOffset+e);return this.currentOffset+=t.byteLength,t}},on=class extends Xt{ino=q.issue_ino();source;constructor(e){super(),this.source=e}fd_filestat_get(){return{ret:0,filestat:new Vt(this.ino,2,0n)}}fd_fdstat_get(){let e=new G(2,0);return e.fs_rights_base=BigInt(2),{ret:0,fdstat:e}}fd_read(e){return{ret:0,data:this.source.read(e)}}};function sn(e={}){let t=new Y(new Map);for(let n of e.files||[]){let e=tn(n.path).slice(1).split(`/`),r=t;for(let t of e.slice(0,-1)){let e=r.contents.get(t);if(e instanceof Y){r=e;continue}let n=new Y(new Map);r.contents.set(t,n),r=n}r.contents.set(e.at(-1),new en(nn(n.contents)))}let n=new an(e.stdin),r=new rn(e.stdout),i=new rn(e.stderr),a=new Map([[`PWD`,`/`]]);for(let[t,n]of Object.entries(e.env||{}))a.set(t,n);return{args:[e.programName||`main.wasm`,...e.args||[]],envEntries:Array.from(a.entries()).map(([e,t])=>`${e}=${t}`),rootDirectory:t,stdout:r,stderr:i,fds:[new on(n),r,i,new $t(`/tmp`,new Map),new $t(`/`,t.contents)]}}async function cn(e,t={}){if(e.target!==`wasm32-wasi`||e.format!==`wasi-core-wasm`)throw Error(`wasm-clang currently executes only wasm32-wasi preview1 core wasm artifacts.`);let n=sn({...t,programName:t.programName||e.fileName}),r=new Yt(n.args,n.envEntries,n.fds,{debug:!1}),i=(e.bytes instanceof Uint8Array,new Uint8Array(e.bytes)),a=e.wasm||await WebAssembly.compile(i),o={current:null},s=typeof t.extraImports==`function`?await t.extraImports({host:n,module:a,instance:o}):t.extraImports||{},c=await WebAssembly.instantiate(a,{...s,wasi_unstable:r.wasiImport,wasi_snapshot_preview1:r.wasiImport});return o.current=c,{exitCode:r.start(c),stdout:n.stdout.getText(),stderr:n.stderr.getText()}}const ln=`runtime-manifest.v1.json`,un=new TextDecoder,dn=new WeakMap;let fn=0;const pn={name:`gnucobol-wasi-clang`,version:1,gnucobolVersion:`3.2`,gmpVersion:`6.3.0`,frontendTarget:`wasm32-wasi`,backend:`wasm-llvm-clang`,unsupported:[`dynamic CALL`,`CALL SYSTEM`,`fork`,`SCREEN SECTION`,`indexed I/O`]};function mn(e,t){let n=e?.toString().trim();if(!n)throw Error(`${t} is required`);let r;try{r=new URL(n,typeof location<`u`?location.href:void 0)}catch{throw Error(`${t} must be an absolute HTTP(S) URL`)}if(r.protocol!==`http:`&&r.protocol!==`https:`)throw Error(`${t} must use HTTP(S)`);return r}function hn(e){let t=mn(e,`wasm-cobol runtime base URL`);return t.pathname.endsWith(`/`)||(t.pathname+=`/`),t.hash=``,t}function gn(e){return hn(new URL(`./`,mn(e,`wasm-cobol runtime manifest URL`))).toString()}function X(e){return e.replaceAll(`\\`,`/`).split(`/`).filter(e=>e&&e!==`.`&&e!==`..`).join(`/`)}function Z(e,t){if(!e||typeof e!=`object`||Array.isArray(e))throw Error(`invalid ${t} in wasm-cobol runtime manifest`);return e}function Q(e,t){if(typeof e!=`string`||!e)throw Error(`invalid ${t} in wasm-cobol runtime manifest`);return e}function _n(e){let t=Z(e,`root`);if(t.manifestVersion!==1)throw Error(`invalid root.manifestVersion in wasm-cobol runtime manifest`);let n=Z(t.frontend,`root.frontend`),r=Z(t.rootfs,`root.rootfs`),i=Z(t.cSysroot,`root.cSysroot`),a=Z(t.profile,`root.profile`);if(a.name!==pn.name||a.version!==pn.version)throw Error(`unsupported root.profile in wasm-cobol runtime manifest`);return{manifestVersion:1,version:Q(t.version,`root.version`),frontend:{asset:Q(n.asset,`root.frontend.asset`),argv0:Q(n.argv0,`root.frontend.argv0`)},rootfs:{asset:Q(r.asset,`root.rootfs.asset`)},cSysroot:{asset:Q(i.asset,`root.cSysroot.asset`)},profile:pn}}function vn(e){return new URL(ln,hn(e))}function yn(e,t){let n=hn(e);return{manifest:new URL(ln,n).toString(),frontend:new URL(t?.frontend.asset||`cobc.wasm.gz`,n).toString(),rootfs:new URL(t?.rootfs.asset||`rootfs.tar.gz`,n).toString(),cSysroot:new URL(t?.cSysroot.asset||`c-sysroot.tar.gz`,n).toString()}}async function bn(e,t=fetch,n,r=le){return _n(await he(mn(e,`wasm-cobol runtime manifest URL`),{fetchImpl:t,label:`wasm-cobol runtime manifest`,maxBytes:r,signal:n}))}function $(e,t,n,r){e.onProgress?.({stage:t,percent:n,message:r})}function xn(e,t){if(!t)return;let n=dn.get(e);n||(n=new Set,dn.set(e,n));let r=X(t).split(`/`),i=``;for(let t of r)if(i=i?`${i}/${t}`:t,!n.has(i)){try{e.memfs.addDirectory(i)}catch{}n.add(i)}}function Sn(e,t,n){let r=X(t);xn(e,r.split(`/`).slice(0,-1).join(`/`)),e.memfs.addFile(r,n)}function Cn(e,t){return un.decode(Uint8Array.from(e.memfs.getFileContents(t)))}function wn(e){return e.includes(`/`)?e.slice(0,e.lastIndexOf(`/`)):``}function Tn(e,t){return X(e?`${e}/${t}`:t)}function En(e,t,n){let r=[],i=new Set,a=(t,n)=>{let o=wn(t);for(let t of n.matchAll(/^\s*#\s*include\s+"([^"]+)"/gm)){let n=Tn(o,t[1]);if(i.has(n))continue;i.add(n);let s=Cn(e,n);r.push({path:n,content:s}),a(n,s)}};return a(t,n),r}function Dn(e){let t=X(e||`main.cob`);return t?/\.[A-Za-z0-9_-]+$/.test(t)?t:`${t}.cob`:`main.cob`}function On(e){let t=/(\bPROGRAM-ID\s*\.\s*)(?:(["'])MAIN\2|MAIN)(?=[\s.]|$)/i;return t.test(e)?e.replace(t,`$1WASM-IDLE-MAIN`).replace(/(\bEND\s+PROGRAM\s+)(?:(["'])MAIN\2|MAIN)(?=[\s.]|$)/gi,`$1WASM-IDLE-MAIN`):e}var kn=class e{runtime;frontend;constructor(e,t){this.runtime=e,this.frontend=t}static async create(t){if(t.signal?.aborted)throw t.signal.reason;let n=t.maxAssetBytes??134217728;if(!Number.isSafeInteger(n)||n<=0)throw TypeError(`COBOL maxAssetBytes must be a positive safe integer`);let r=t.fetchImpl||fetch,i=t.runtimeBaseUrl===void 0?gn(t.manifestUrl):hn(t.runtimeBaseUrl).toString(),a=yn(i,t.manifest||await bn(t.manifestUrl||vn(i),r,t.signal,Math.min(n,4194304))),o=t.clangRuntimeBaseUrl===void 0?ft(t.clangManifestUrl):dt(t.clangRuntimeBaseUrl),s=t.clangManifest||await It(t.clangManifestUrl||Lt(o),r,t.signal,Math.min(n,4194304)),c=new Ot({runtimeBaseUrl:o,manifest:{...s,compiler:{...s.compiler,sysroot:{...s.compiler.sysroot,asset:a.cSysroot}}},log:t.log,maxAssetBytes:n,signal:t.signal,stdout:()=>{}}),l=L(a.frontend,void 0,t.signal,n),u=ye(a.rootfs,void 0,n,t.signal),[d,f]=await Promise.all([l,u]);if(await c.ready,t.signal?.aborted)throw t.signal.reason;return rt(f,c.memfs),xn(c,`tmp`),new e(c,d)}async compile(e){if(!e.code?.trim())return{success:!1,stderr:`wasm-cobol requires a non-empty source string`};let t=[],n=this.runtime,r=n.stdout,i=n.memfs.stdout;n.stdout=e=>t.push(e),n.memfs.stdout=e=>t.push(e),n.log=e.log??n.log,n.beginTrace(!!e.log);try{$(e,`bootstrap`,5,`preparing GnuCOBOL workspace`);let r=`__wasm_cobol_${++fn}`,i=Dn(e.fileName),a=`${r}/${i}`,o=(i.split(`/`).pop()||`main.cob`).replace(/\.[^.]+$/,``),s=`${r}/${o}.c`,c=`${r}_${o}`,l=`${c}.c`,u=`${c}.o`,d=`${r}/link`,f=`${d}/${o}.o`,p=`${d}/${o}.wasm`;xn(n,`${r}/tmp`),xn(n,d),Sn(n,a,On(e.code));for(let t of e.workspaceFiles||[]){let e=X(t.path);!e||e===i||Sn(n,`${r}/${e}`,t.content)}$(e,`translate`,20,`translating COBOL to C with GnuCOBOL`);let m=e.sourceFormat===`fixed`?`-fixed`:`-free`;await n.runWithOptions(this.frontend,!0,[`cobc`,`-x`,`-C`,m,`-I`,r,`-o`,s,...e.compileArgs||[],a],{COB_CONFIG_DIR:`share/gnucobol/config`,COB_COPY_DIR:`${r}:share/gnucobol/copy`,TMPDIR:`${r}/tmp`,LC_ALL:`C`,SOURCE_DATE_EPOCH:`0`});let h=Cn(n,s),g=En(n,s,h),_=new Map(g.map(e=>{let t=e.path.split(`/`).pop()||e.path;return[t,`${r}_${t}`]})),v=e=>e.replace(/(#\s*include\s+")([^"]+)(")/g,(e,t,n,r)=>{let i=_.get(n.split(`/`).pop()||n);return i?`${t}${i}${r}`:e}),y=v(h),b=g.map(e=>({path:_.get(e.path.split(`/`).pop()||e.path)??e.path,content:v(e.content)}));$(e,`compile`,55,`compiling generated C with llvm-core Clang`);let x=t.length,S;try{await n.compile({input:l,code:y,obj:u,language:`C`,cVersion:`17`,opt:`0`,workspaceFiles:b,compileArgs:[`-I`,`.`,`-I`,`include`,`-D_WASI_EMULATED_SIGNAL`,`-D_WASI_EMULATED_GETPID`,...e.cCompileArgs||[]]})}catch(e){S=e}let C=Uint8Array.from(n.memfs.getFileContents(u)),w=t.slice(x).join(``),T=C[0]===0&&C[1]===97&&C[2]===115&&C[3]===109&&w.includes(`IO failure on output stream: Invalid argument`);if(S&&!T)throw S;if(T&&t.splice(x),C.length===0)throw Error(`wasm-clang did not produce the COBOL object file`);n.memfs.addFile(f,C),$(e,`link`,80,`linking libcob and GMP`);let E=await n.getModule(n.assetUrls.lld),D=n.compilerConfig?.compilerRuntimeLibDir||`lib/clang/8.0.1/lib/wasi`;await n.run(E,e.log??!1,`wasm-ld`,`--export-dynamic`,`-z`,`stack-size=1048576`,`-Llib/wasm32-wasi/noeh`,`-Llib/wasm32-wasi`,`lib/wasm32-wasi/crt1.o`,f,`lib/libcobwasi.a`,`lib/libcob.a`,`lib/libgmp.a`,`lib/libdl.a`,`lib/libsetjmp.a`,`lib/libwasi-emulated-signal.a`,`lib/libwasi-emulated-getpid.a`,`-lc`,`-lm`,`-L${D}`,`-lclang_rt.builtins-wasm32`,`-o`,p);let O=Uint8Array.from(n.memfs.getFileContents(p)),k={bytes:O,wasm:await WebAssembly.compile(O),target:`wasm32-wasi`,format:`wasi-core-wasm`,fileName:p,language:`C`,sourceLanguage:`COBOL`};return $(e,`done`,100,`done`),{success:!0,artifact:k,stdout:t.join(``)}}catch(e){let n=t.join(``);return{success:!1,stdout:n,stderr:n||(e instanceof Error?e.message:String(e))}}finally{n.stdout=r,n.memfs.stdout=i}}};async function An(e){return kn.create(e)}function jn(e,t={}){return cn(e,t)}self.document={querySelectorAll(){return[]}};let Mn=null,Nn=null,Pn=!1,Fn=null,In=!1;const Ln=e=>e.replaceAll(`\\`,`/`).split(`/`).filter(e=>e&&e!==`.`&&e!==`..`).join(`/`),Rn=e=>e.endsWith(`
`)?e:`${e}\n`;function zn(e){let t=Ln(e||``);return t?/\.[A-Za-z0-9_-]+$/.test(t)?t:`${t}.cob`:`main.cob`}function Bn(){return Pn?In?null:(In=!0,Fn??``):s(Nn,()=>postMessage({buffer:!0}))}async function Vn(e,t,n,r){A(e||null),Mn=await An({runtimeBaseUrl:t,clangRuntimeBaseUrl:e?.baseUrl||``,maxAssetBytes:n,log:r})}self.onmessage=async e=>{if(j(e.data))return;let{code:t,buffer:n,load:r,log:i,prepare:a,compileArgs:o,programArgs:s,activePath:c,workspaceFiles:l,stdin:u,clangAssets:d,cobolBaseUrl:f,maxAssetBytes:p}=e.data;if(r)try{await Vn(d,f,p,i),postMessage({load:!0})}catch(e){postMessage({error:e.message})}else if(typeof i==`boolean`&&!t)typeof t==`string`&&postMessage({results:!0});else if(t){if(!Mn){postMessage({error:`COBOL runtime is not loaded.`});return}Nn=new Int32Array(n),Pn=typeof u==`string`,Fn=Pn?u:null,In=!1;try{let e=l||[],n=await Mn.compile({code:Rn(t),fileName:zn(c),sourceFormat:`free`,compileArgs:o||[],workspaceFiles:e,log:i,onProgress:({percent:e,message:t})=>{postMessage({progress:e/100}),i&&postMessage({log:t})}});if(!n.success||!n.artifact)throw Error(n.stderr||`GnuCOBOL did not produce a WebAssembly program.`);if(!a){let t=await jn(n.artifact,{args:s||[],stdin:Bn,stdout:e=>postMessage({output:e}),stderr:e=>postMessage({output:e}),files:e.map(({path:e,content:t})=>({path:e,contents:t}))});if(t.exitCode)throw Error(`COBOL program exited with ${t.exitCode}`)}postMessage({results:!0})}catch(e){postMessage({error:e.message})}}};