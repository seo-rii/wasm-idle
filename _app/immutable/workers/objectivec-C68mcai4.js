...
#endif
`,Pe=String.raw`#ifndef WASM_CLANG_EXT_PB_DS_ASSOC_CONTAINER_HPP
...
#endif
`,Fe=String.raw`#ifndef WASM_CLANG_EXT_PB_DS_HASH_POLICY_HPP
...
#endif
`,Ie=String.raw`#ifndef WASM_CLANG_EXT_PB_DS_PRIORITY_QUEUE_HPP
...
#endif
`,Le=String.raw`#ifndef WASM_CLANG_EXT_ROPE
...
#endif
`,Re=String.raw`#ifndef WASM_CLANG_SETJMP_H
...
#endif
`,ze=String.raw`#ifndef WASM_CLANG_BITS_STDCPP_H
...
#endif
`,Be=String.raw`#ifndef WASM_CLANG_BITS_EXTCXX_H
...
#endif
`,Ve=[{path:`include/setjmp.h`,contents:Re},{path:`include/bits/stdc++.h`,contents:ze},{path:`include/bits/extc++.h`,contents:Be},{path:`include/c++/v1/ext/rope`,contents:Le},{path:`include/c++/v1/ext/pb_ds/tree_policy.hpp`,contents:Ne},{path:`include/c++/v1/ext/pb_ds/assoc_container.hpp`,contents:Pe},{path:`include/c++/v1/ext/pb_ds/hash_policy.hpp`,contents:Fe},{path:`include/c++/v1/ext/pb_ds/priority_queue.hpp`,contents:Ie}];function He(e){e.addDirectory(`include/c++/v1/ext/pb_ds`),e.addDirectory(`include/bits`);for(let t of Ve)e.addFile(t.path,t.contents)}const Ue=e=>JSON.stringify(e.length>96?e.slice(0,93)+`...`:e);var We=class{ready;mem=null;hostMem_=null;stdinStr;stdin;stdout;trace;instance=null;exports;out=!0;filePaths=new Set;fileOverlays=new Map;constructor(e){this.stdin=e.stdin,this.stdout=e.stdout,this.stdinStr=e.stdinStr||``,this.trace=e.trace||(()=>{});let t=D(this,`abort`,`host_write`,`host_read`,`memfs_log`,`copy_in`,`copy_out`);this.ready=ce(e.moduleUrl,e.progress).then(e=>WebAssembly.instantiate(e,{env:t})).then(e=>{this.instance=e,this.exports=e.exports,this.mem=new j(this.exports.memory),this.exports.init()})}set hostMem(e){this.hostMem_=e}setStdinStr(e){this.stdinStr=e}addDirectory(e){this.mem.check(),this.mem.write(this.exports.GetPathBuf(),e),this.exports.AddDirectoryNode(e.length)}addFile(e,t){let n=t instanceof ArrayBuffer?t.byteLength:t.length;this.mem.check(),this.mem.write(this.exports.GetPathBuf(),e);let r=this.exports.AddFileNode(e.length,n),i=this.exports.GetFileNodeAddress(r);this.mem.check(),this.mem.write(i,t),this.filePaths.add(this.normalizePath(e))}setFile(e,t){let n=this.normalizePath(e);this.filePaths.add(n),this.fileOverlays.set(n,Uint8Array.from(t))}hasFile(e){return this.filePaths.has(this.normalizePath(e))}normalizePath(e){return e.replaceAll(`\\`,`/`).replace(/^\.\//,``).replace(/^\/+/,``)}getFileContents(e){let t=this.fileOverlays.get(this.normalizePath(e));if(t)return t;this.mem.check(),this.mem.write(this.exports.GetPathBuf(),e);let n=this.exports.FindNode(e.length),r=this.exports.GetFileNodeAddress(n),i=this.exports.GetFileNodeSize(n);return new Uint8Array(this.mem.buffer,r,i)}abort(){throw this.trace(`abort()`),new fe}host_write(e,t,n,r){this.hostMem_.check(),me(e<=2);let i=0,a=``;for(let e=0;e<n;++e){let e=this.hostMem_.read32(t);t+=4;let n=this.hostMem_.read32(t);t+=4,a+=this.hostMem_.readStrR(e,n),i+=n}return this.hostMem_.write32(r,i),this.trace(`host_write(fd=${e}, bytes=${i}, data=${Ue(a)})`),this.out&&this.stdout(a),0}host_read(e,t,n,r){this.hostMem_.check(),me(e===0);let i=0;for(let r=0;r<n;++r){let n=this.hostMem_.read32(t);t+=4;let r=this.hostMem_.read32(t);t+=4,this.stdinStr.length||(this.stdinStr=this.stdin());let a=Math.min(r,this.stdinStr.length);if(a===0)break;let o=this.stdinStr.substring(0,a);if(this.hostMem_.write(n,this.stdinStr.substring(0,a)),this.stdinStr=this.stdinStr.substring(a),i+=a,this.trace(`host_read(fd=${e}, bytes=${a}, data=${Ue(o)})`),a!==r)break}return this.hostMem_.write32(r,i),i===0&&this.trace(`host_read(fd=${e}, bytes=0)`),0}memfs_log(e,t){this.mem.check();let n=this.mem.readStr(e,t);this.trace(`memfs_log(${Ue(n)})`)}copy_out(e,t,n){this.hostMem_.check();let r=new Uint8Array(this.hostMem_.buffer,e,n);this.mem.check();let i=new Uint8Array(this.mem.buffer,t,n);r.set(i)}copy_in(e,t,n){this.mem.check();let r=new Uint8Array(this.mem.buffer,e,n);this.hostMem_.check();let i=new Uint8Array(this.hostMem_.buffer,t,n);r.set(i)}};function*Ge(e){let t=e instanceof Uint8Array?e:new Uint8Array(e),n=0,r=``,i=e=>(n+=e,O(t,n-e,e)),a=e=>(n+=e,A(t,n-e,e)),o=()=>n=n+511&-512;for(;n+512<=t.length;){let e={filename:i(100),mode:a(8),owner:a(8),group:a(8),size:a(12),mtime:a(12),checksum:a(8),type:i(1),linkname:i(100),ustar:i(8)};if(!e.ustar)return;let s={...e,ownerName:i(32),groupName:i(32),devMajor:i(8),devMinor:i(8),filenamePrefix:i(155)};if(o(),(s.size>0||s.type===`0`||s.type===``||s.type===`L`)&&(s.contents=t.subarray(n,n+s.size),n+=s.size,o()),s.type===`L`){s.contents&&(r=O(s.contents,0,s.size));continue}s.filename=r||(s.filenamePrefix?`${s.filenamePrefix}/${s.filename}`:s.filename),r=``,yield s}}function Ke(e,t){for(let n of Ge(e))switch(n.type){case``:case`0`:t.addFile(n.filename,n.contents);break;case`5`:t.addDirectory(n.filename);break;default:throw Error(`unsupported tar entry type: ${n.type}`)}}const qe=`\x1B[92m`,Je=`\x1B[0m`,Ye=e=>Math.max(0,Math.min(1,Number.isFinite(e)?e:0));function Xe(e){let t={clang:0,lld:0,memfs:0},n=()=>{e((t.clang+t.lld+t.memfs)/3)},r=e=>({set(r){t[e]=Ye(r),n()}});return{clang:r(`clang`),lld:r(`lld`),memfs:r(`memfs`)}}const Ze=(e,t)=>{let n=e?.toString().trim();if(!n)throw Error(`${t} is required`);let r;try{r=new URL(n,typeof location<`u`?location.href:void 0)}catch{throw Error(`${t} must be an absolute HTTP(S) URL`)}if(r.protocol!==`http:`&&r.protocol!==`https:`)throw Error(`${t} must use HTTP(S)`);return r},Qe=e=>{let t=Ze(e,`wasm-clang runtime base URL`);return t.pathname.endsWith(`/`)||(t.pathname+=`/`),t.hash=``,t},F=(e,t)=>new URL(t,Qe(e)).toString(),$e=(e,t)=>F(e,t),et=e=>Qe(e).toString(),tt=e=>$e(e,`runtime-manifest.v1.json`);function nt(e,t){let n=et(e);return{manifest:tt(n).toString(),memfs:F(n,t?.compiler.memfs.asset||`bin/memfs.wasm.gz`).toString(),clang:F(n,t?.compiler.clang.asset||`bin/clang.wasm.gz`).toString(),lld:F(n,t?.compiler.lld.asset||`bin/lld.wasm.gz`).toString(),sysroot:F(n,t?.compiler.sysroot.asset||`bin/sysroot.tar.gz`).toString(),clangdJs:F(n,t?.clangd.js||`clangd/clangd.js`).toString(),clangdWasm:F(n,t?.clangd.wasm||`clangd/clangd.wasm.gz`).toString()}}globalThis.document===void 0&&(globalThis.document={querySelectorAll:(()=>[])});const rt=`-std=gnu++2a`;function it(e){return(e||``).trim().toUpperCase().replaceAll(/\s+/g,``)}function at(e){switch(it(e)){case`03`:case`CPP03`:case`C++03`:case`GNU++03`:case`GNUC++03`:return`-std=gnu++03`;case`11`:case`CPP11`:case`C++11`:case`GNU++11`:case`GNUC++11`:return`-std=gnu++11`;case`14`:case`CPP14`:case`C++14`:case`GNU++14`:case`GNUC++14`:return`-std=gnu++14`;case`17`:case`CPP17`:case`C++17`:case`GNU++17`:case`GNUC++17`:return`-std=gnu++17`;case`20`:case`23`:case`26`:case`CPP20`:case`CPP23`:case`CPP26`:case`C++20`:case`C++23`:case`C++26`:case`GNU++20`:case`GNU++23`:case`GNU++26`:case`GNUC++20`:case`GNUC++23`:case`GNUC++26`:return rt;default:return rt}}function ot(e){switch(it(e)){case`99`:case`C99`:case`GNU99`:case`GNUC99`:return`-std=gnu99`;case`11`:case`C11`:case`GNU11`:case`GNUC11`:return`-std=gnu11`;case`17`:case`18`:case`C17`:case`C18`:case`GNU17`:case`GNU18`:case`GNUC17`:case`GNUC18`:return`-std=gnu17`;default:return`-std=gnu11`}}function st(e,t){return e===`C`?{languageArg:`c`,standardArg:ot(t.cVersion)}:e===`OBJC`?{languageArg:`objective-c`,standardArg:ot(t.cVersion)}:{languageArg:`c++`,standardArg:at(t.cppVersion)}}const I=e=>e.replaceAll(`\\`,`/`).split(`/`).filter(e=>e&&e!==`.`&&e!==`..`).join(`/`);function ct(e,t){let n=I(t||``),r=`main`,i=n&&/\.[A-Za-z0-9_-]+$/.test(n)?n:`${n||r}.${e===`C`?`c`:e===`OBJC`?`m`:`cc`}`,a=(i.split(`/`).pop()||i).replace(/\.[^.]+$/,``)||r;return{input:i,obj:`${a}.o`,wasm:`${a}.wasm`}}const lt=e=>{let t=encodeURIComponent(e),n=``;for(let e=0;e<t.length;){let r=t[e];if(e+=1,r==`%`){let r=t.substring(e,e+=2);r&&(n+=String.fromCharCode(parseInt(r,16)))}else n+=r}return n};var ut=class{ready;memfs;stdout;moduleCache;showTiming;log;debug=!1;debugBreakpoints=new Set;debugPauseOnEntry=!1;debugBuffer;debugInterruptBuffer;debugWatchBuffer;debugWatchResultBuffer;onDebugEvent;debugVariableMetadata={};debugGlobalMetadata=[];debugFunctionMetadata={};lastBuildKey=``;path;assetUrls;compilerConfig;wasm;lastArtifactPath=`main.wasm`;traceStartedAt=0;progress;constructor(e){this.moduleCache={},this.stdout=e.stdout||(()=>{}),this.showTiming=e.showTiming||!1,this.log=e.log||!1,this.path=e.runtimeBaseUrl.toString(),this.assetUrls=nt(this.path,e.manifest),this.compilerConfig=e.manifest?.compiler,this.onDebugEvent=e.onDebugEvent,this.progress=Xe(t=>e.progress?.(t)),this.memfs=new We({stdout:this.stdout,stdin:e.stdin||(()=>``),moduleUrl:this.assetUrls.memfs,progress:this.progress.memfs,trace:e=>this.trace(e)});let t=this.getModule(this.assetUrls.clang,this.progress.clang),n=this.getModule(this.assetUrls.lld,this.progress.lld),r=this.memfs.ready.then(async()=>{await this.hostLogAsync(`Untarring ${this.assetUrls.sysroot}`,se(this.assetUrls.sysroot).then(e=>Ke(e,this.memfs))),He(this.memfs)});this.ready=Promise.all([t,n,r]).then(()=>void 0)}hostLog(e){if(!this.log)return;let t=`[1;93m>${Je} `;this.stdout(`${t}${e}`)}beginTrace(e){this.debug=e,this.traceStartedAt=Date.now()}trace(e){if(!this.debug||!this.log)return;let t=Date.now()-this.traceStartedAt;this.stdout(`\x1b[2m[debug +${t}ms] ${e}\x1b[0m\n`)}async hostLogAsync(e,t){let n=+new Date;this.hostLog(`${e}...`);let r=await t,i=+new Date;return this.log&&this.stdout(` done.`),this.showTiming&&this.stdout(` ${qe}(${i-n}ms)${Je}\n`),this.log&&this.stdout(`
`),r}async getModule(e,t){if(this.moduleCache[e])return this.moduleCache[e];let n=await this.hostLogAsync(`Fetching and compiling ${e}`,ce(e,t));return this.moduleCache[e]=n,n}addWorkspaceDirectories(e,t=new Set){let n=I(e).split(`/`).slice(0,-1),r=``;for(let e of n)r=r?`${r}/${e}`:e,t.has(r)||(this.memfs.addDirectory(r),t.add(r))}addWorkspaceFiles(e=[],t=``){let n=new Set,r=I(t);for(let t of e){let e=I(t.path);!e||e===r||(this.addWorkspaceDirectories(e,n),this.memfs.addFile(e,lt(t.content)))}}async compile(e){let t=I(e.input||`main.cc`)||`main.cc`,n=e.code,r=e.obj,i=e.language===`C`?`C`:e.language===`OBJC`?`OBJC`:`CPP`,a=e.compileArgs??e.args??[],{languageArg:o,standardArg:s}=st(i,e),c=!!e.debug,l=c?`0`:e.opt||`2`;if(c){let e=n.split(`
`),t=0,r=0,a=0,o=1,s=1,c=new Map,l=new Map,u=new Map,d=!1,f,p=new Map,m=``,h=[],g=!1;for(let t of e){let e=t;if(g){let t=e.indexOf(`*/`);if(t===-1)continue;e=e.slice(t+2),g=!1}let n=e.indexOf(`/*`);if(n!==-1){let t=e.indexOf(`*/`,n+2);t===-1?(g=!0,e=e.slice(0,n)):e=e.slice(0,n)+e.slice(t+2)}let r=e.indexOf(`//`);r!==-1&&(e=e.slice(0,r));let i=e.trim();if(!m){let e=i.match(/^struct\s+([A-Za-z_]\w*)\s*\{$/);e?.[1]&&(m=e[1],h=[]);continue}if(i===`};`){let e=0,t=1,n=[];for(let r of h){let i=r.kind===`double`?8:r.kind===`bool`||r.kind===`char`?1:4;e%i!==0&&(e+=i-e%i),n.push({name:r.name,kind:r.kind,offset:e}),e+=i,t=Math.max(t,i)}e%t!==0&&(e+=t-e%t),p.set(m,{fields:n,size:Math.max(e,1)}),m=``,h=[];continue}let a=i.match(/^(?:const\s+)?(?:(?:unsigned|signed)\s+)?(?:(?:short|long long|long)\s+)?(int|float|double|bool|char)\s+(.+);$/);if(a)for(let e of a[2].split(`,`)){let t=e.split(`=`)[0]?.trim()||``;if(!t||/[*&\[]/.test(t))continue;let n=t.match(/([A-Za-z_]\w*)\s*$/)?.[1];n&&h.push({name:n,kind:a[1]})}}this.debugVariableMetadata={},this.debugGlobalMetadata=[],this.debugFunctionMetadata={};let _=[],v=i===`CPP`?`extern "C" `:``,y=[`${v}__attribute__((import_module("env"), import_name("__wasm_idle_debug_enter"))) void __wasm_idle_debug_enter(int functionId, int line);`,`${v}__attribute__((import_module("env"), import_name("__wasm_idle_debug_leave"))) void __wasm_idle_debug_leave(int functionId);`,`${v}__attribute__((import_module("env"), import_name("__wasm_idle_debug_value_num"))) void __wasm_idle_debug_value_num(int functionId, int slot, double value);`,`${v}__attribute__((import_module("env"), import_name("__wasm_idle_debug_value_bool"))) void __wasm_idle_debug_value_bool(int functionId, int slot, int value);`,`${v}__attribute__((import_module("env"), import_name("__wasm_idle_debug_value_addr"))) void __wasm_idle_debug_value_addr(int functionId, int slot, int value);`,`${v}__attribute__((import_module("env"), import_name("__wasm_idle_debug_value_text"))) void __wasm_idle_debug_value_text(int functionId, int slot, const char* ptr, int len);`,`${v}__attribute__((import_module("env"), import_name("__wasm_idle_debug_line"))) void __wasm_idle_debug_line(int functionId, int line);`],b=i===`CPP`?[`#include <cstdio>`,`#include <iostream>`,`#include <map>`,`#include <set>`,`#include <string>`,`#include <type_traits>`,`#include <vector>`,...y,`template <typename T>`,`static inline std::string __wasm_idle_debug_format_value(const T& value) {`,`    if constexpr (std::is_same_v<T, bool>) return value ? "true" : "false";`,`    else if constexpr (std::is_same_v<T, char>) return std::string("'") + value + "'";`,`    else if constexpr (std::is_same_v<T, signed char> || std::is_same_v<T, unsigned char>) return std::to_string((int)value);`,`    else if constexpr (std::is_integral_v<T> || std::is_floating_point_v<T>) return std::to_string(value);`,`    else return "?";`,`}`,`template <typename T>`,`static inline void __wasm_idle_debug_emit_vector(int functionId, int slot, const std::vector<T>& values) {`,`    std::string text = "[";`,`    int count = 0;`,`    for (const auto& value : values) {`,`        if (count > 0) text += ", ";`,`        if (count >= 8) { text += "..."; break; }`,`        text += __wasm_idle_debug_format_value(value);`,`        count += 1;`,`    }`,`    text += "]";`,`    __wasm_idle_debug_value_text(functionId, slot, text.c_str(), (int)text.size());`,`}`,`template <typename T>`,`static inline void __wasm_idle_debug_emit_set(int functionId, int slot, const std::set<T>& values) {`,`    std::string text = "{";`,`    int count = 0;`,`    for (const auto& value : values) {`,`        if (count > 0) text += ", ";`,`        if (count >= 8) { text += "..."; break; }`,`        text += __wasm_idle_debug_format_value(value);`,`        count += 1;`,`    }`,`    text += "}";`,`    __wasm_idle_debug_value_text(functionId, slot, text.c_str(), (int)text.size());`,`}`,`template <typename K, typename V>`,`static inline void __wasm_idle_debug_emit_map(int functionId, int slot, const std::map<K, V>& values) {`,`    std::string text = "{";`,`    int count = 0;`,`    for (const auto& entry : values) {`,`        if (count > 0) text += ", ";`,`        if (count >= 8) { text += "..."; break; }`,`        text += __wasm_idle_debug_format_value(entry.first);`,`        text += ": ";`,`        text += __wasm_idle_debug_format_value(entry.second);`,`        count += 1;`,`    }`,`    text += "}";`,`    __wasm_idle_debug_value_text(functionId, slot, text.c_str(), (int)text.size());`,`}`]:[`#include <stdio.h>`,...y];for(let n=0;n<e.length;n+=1){let m=e[n],h=m.match(/^\s*/)?.[0]||``,g=m,v=m;if(d){let e=v.indexOf(`*/`);if(e===-1){b.push(m);continue}v=v.slice(e+2),d=!1}let y=v.indexOf(`/*`);if(y!==-1){let e=v.indexOf(`*/`,y+2);e===-1?(d=!0,v=v.slice(0,y)):v=v.slice(0,y)+v.slice(e+2)}let x=v.indexOf(`//`);x!==-1&&(v=v.slice(0,x));let S=v.trim(),C=r>0&&t>=r,w=r===0&&t===0&&!S.includes(`(`)&&!S.startsWith(`#`),T=/^(while|if|for)\s*\(/.test(S)&&!S.includes(`{`),E=[],D=[],O=new Set,k=w&&S.match(/^(?:const\s+)?(?:(?:unsigned|signed)\s+)?(?:(?:short|long long|long)\s+)?(int|float|double|bool|char)\s+(.+);$/);if(k){let e=k[1]===`bool`?`bool`:`number`,t=[],r=``,i=0;for(let e of k[2]){if(e===`,`&&i===0){r.trim()&&t.push(r.trim()),r=``;continue}e===`{`&&(i+=1),e===`}`&&(i=Math.max(0,i-1)),r+=e}r.trim()&&t.push(r.trim());for(let r of t){let[t]=r.split(`=`),i=t?.trim()||``;if(/[*&\[]/.test(i))continue;let a=i.match(/([A-Za-z_]\w*)\s*$/)?.[1];if(!a)continue;let o=s++;l.set(a,{slot:o,kind:e,fromLine:n+1,toLine:2**53-1}),this.debugGlobalMetadata=[...this.debugGlobalMetadata,{slot:o,name:a,kind:e,fromLine:n+1,toLine:2**53-1}],_.push(`${e===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(0, ${o}, ${a});`)}}let A=w&&S.match(/^(?:const\s+)?([A-Za-z_]\w*)\s+([A-Za-z_]\w*)\s*\[(\d+)\]\s*(?:=.*)?;$/);if(A){let e=p.get(A[1]);if(e){let t=s++;this.debugGlobalMetadata=[...this.debugGlobalMetadata,{slot:t,name:A[2],kind:`array`,length:Number(A[3]),dimensions:[Number(A[3])],structFields:e.fields,structSize:e.size,fromLine:n+1,toLine:2**53-1}],_.push(`__wasm_idle_debug_value_addr(0, ${t}, (int)((unsigned long long)(${A[2]})));`)}}if(C&&S&&!S.startsWith(`#`)&&S!==`{`&&S!==`}`&&!S.startsWith(`else`)&&!S.startsWith(`case `)&&S!==`case`&&!S.startsWith(`default`)&&!S.startsWith(`catch`)&&!/^(public|private|protected)\s*:/.test(S)&&!S.endsWith(`:`)&&!S.includes(` else `)){E.push(`${h}__wasm_idle_debug_line(${a}, ${n+1});`);let e=S.match(/^(?:const\s+)?(?:(?:unsigned|signed)\s+)?(?:(?:short|long long|long)\s+)?(int|float|double|bool|char)\s+(.+);$/),t=S.match(/^(?:const\s+)?(?:(?:std::)?(vector|set|map))\s*<(.+)>\s+([A-Za-z_]\w*)\s*(?:=.*)?;$/);if(t&&a){let e=s++,r=t[1],i=t[3];O.add(i),u.set(i,{slot:e,container:r,fromLine:n+1,toLine:2**53-1}),this.debugVariableMetadata[a]=[...this.debugVariableMetadata[a]||[],{slot:e,name:i,kind:`text`,fromLine:n+1,toLine:2**53-1}],D.push(`${h}__wasm_idle_debug_emit_${r}(${a}, ${e}, ${i});`)}if(e&&a){let t=e[1]===`bool`?`bool`:`number`,r=[],i=``,o=0,l=0;for(let t of e[2]){if(t===`,`&&o===0&&l===0){i.trim()&&r.push(i.trim()),i=``;continue}t===`(`&&(o+=1),t===`)`&&(o=Math.max(0,o-1)),t===`{`&&(l+=1),t===`}`&&(l=Math.max(0,l-1)),i+=t}i.trim()&&r.push(i.trim());for(let i of r){let[r]=i.split(`=`),o=r?.trim()||``,l=[];for(let e of o.matchAll(/\[(\d+)\]/g))l.push(Number(e[1]));let u=o.match(/([A-Za-z_]\w*)\s*(?=\[\d+\])/);if(l.length&&u){let t=s++;this.debugVariableMetadata[a]=[...this.debugVariableMetadata[a]||[],{slot:t,name:u[1],kind:`array`,elementKind:e[1],length:l[0],dimensions:l,fromLine:n+1,toLine:2**53-1}],D.push(`${h}__wasm_idle_debug_value_addr(${a}, ${t}, (int)((unsigned long long)(${u[1]})));`);continue}if(/[*&]/.test(o))continue;let d=o.match(/([A-Za-z_]\w*)\s*(?:\[[^\]]*\])?$/)?.[1];if(d){if(!c.has(d)){let e=s++;c.set(d,{slot:e,kind:t,fromLine:n+1,toLine:2**53-1}),this.debugVariableMetadata[a]=[...this.debugVariableMetadata[a]||[],{slot:e,name:d,kind:t,fromLine:n+1,toLine:2**53-1}]}if(i.includes(`=`)){let e=c.get(d);e&&D.push(`${h}${e.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${a}, ${e.slot}, ${d});`)}}}}let r=S.match(/^for\s*\(\s*(?:const\s+)?(?:(?:unsigned|signed)\s+)?(?:(?:short|long long|long)\s+)?(int|float|double|bool|char)\s+([A-Za-z_]\w*)\s*=/);if(r&&a){let e=r[1]===`bool`?`bool`:`number`,t=r[2];if(!c.has(t)){let r=s++;c.set(t,{slot:r,kind:e,fromLine:n+1,toLine:2**53-1}),this.debugVariableMetadata[a]=[...this.debugVariableMetadata[a]||[],{slot:r,name:t,kind:e,fromLine:n+1,toLine:2**53-1}]}}if(!T){for(let[e,t]of u){if(O.has(e))continue;let n=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);RegExp(`\\b${n}\\b`).test(S)&&D.push(`${h}__wasm_idle_debug_emit_${t.container}(${a}, ${t.slot}, ${e});`)}for(let[e,t]of c){let r=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);S.startsWith(`for`)&&t.toLine===n+1||(RegExp(`(?:^|[^\\w])(?:\\+\\+|--)\\s*${r}\\b`).test(S)||RegExp(`\\b${r}\\s*(?:[+\\-*/%]?=|\\+\\+|--)`).test(S)||RegExp(`&\\s*${r}\\b`).test(S)||RegExp(`\\b(?:cin|std::cin)\\b[^;]*>>\\s*${r}\\b`).test(S))&&D.push(`${h}${t.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${a}, ${t.slot}, ${e});`)}for(let[e,t]of l){if(c.has(e)||u.has(e))continue;let n=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);(RegExp(`(?:^|[^\\w])(?:\\+\\+|--)\\s*${n}\\b`).test(S)||RegExp(`\\b${n}\\s*(?:[+\\-*/%]?=|\\+\\+|--)`).test(S)||RegExp(`&\\s*${n}\\b`).test(S)||RegExp(`\\b(?:cin|std::cin)\\b[^;]*>>\\s*${n}\\b`).test(S))&&D.push(`${h}${t.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(0, ${t.slot}, ${e});`)}}/^return\b/.test(S)&&E.push(`${h}__wasm_idle_debug_leave(${a});`)}if(r>0&&t===r&&S===`}`&&E.push(`${h}__wasm_idle_debug_leave(${a});`),C&&a&&(/^(while|if)\s*\(/.test(S)||/^for\s*\(/.test(S))){let e=S.match(/^(while|if|for)\b/)?.[1],t=m.indexOf(e||``),r=t>=0?m.indexOf(`(`,t):-1;if(r>=0){let t=-1,i=0;for(let e=r;e<m.length;e+=1){let n=m[e];if(n===`(`&&(i+=1),n===`)`&&(--i,i===0)){t=e;break}for(let[e,t]of l){if(c.has(e)||u.has(e))continue;let n=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`);(RegExp(`(?:^|[^\\w])(?:\\+\\+|--)\\s*${n}\\b`).test(S)||RegExp(`\\b${n}\\s*(?:[+\\-*/%]?=|\\+\\+|--)`).test(S)||RegExp(`&\\s*${n}\\b`).test(S))&&D.push(`${h}${t.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(0, ${t.slot}, ${e});`)}}if(t>r){let i=m.slice(r+1,t);if(e===`for`){let e=[],o=``,s=0;for(let t of i){if(t===`;`&&s===0){e.push(o),o=``;continue}t===`(`&&(s+=1),t===`)`&&(s=Math.max(0,s-1)),o+=t}if(e.push(o),e.length===3&&e[1]?.trim()){let i=e[0].trim(),o=e[2].trim(),s=[],l=[],u=[],d=/^(?:const\s+)?(?:(?:unsigned|signed)\s+)?(?:(?:short|long long|long)\s+)?(?:int|float|double|bool|char)\b/.test(i);for(let[e,t]of c){let n=e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`),r=RegExp(`(?:^|[^\\w])(?:\\+\\+|--)\\s*${n}\\b|\\b${n}\\s*(?:[+\\-*/%]?=|\\+\\+|--)`);!d&&r.test(i)&&s.push(`${t.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${a}, ${t.slot}, ${e})`),d&&r.test(i)&&l.push(`${t.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${a}, ${t.slot}, ${e})`),r.test(o)&&u.push(`${t.kind===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${a}, ${t.slot}, ${e})`)}let f=s.length&&i?`(${i}, ${s.join(`, `)})`:e[0],p=u.length&&o?`(${o}, ${u.join(`, `)})`:e[2];g=m.slice(0,r+1)+`${f}; (${l.length?`${l.join(`, `)}, `:``}__wasm_idle_debug_line(${a}, ${n+1}), (${e[1].trim()})); ${p}`+m.slice(t)}}else g=m.slice(0,r+1)+`(__wasm_idle_debug_line(${a}, ${n+1}), (${i.trim()}))`+m.slice(t)}}}b.push(...E),b.push(g),b.push(...D);let j=r===0&&S.includes(`(`)&&S.includes(`)`)&&S.includes(`{`)&&!/^(if|for|while|switch|catch)\b/.test(S)&&!/^(class|struct|namespace|enum|union)\b/.test(S),ee=r===0&&!!f&&S===`{`;if(t+=(v.match(/{/g)||[]).length,t-=(v.match(/}/g)||[]).length,j||ee){r=t,a=o++;let e=`anonymous`,l=i===`OBJC`&&j?S.match(/^([-+])\s*\([^)]*\)\s*([A-Za-z_]\w*)/):null;if(j?(e=S.slice(0,S.indexOf(`(`)).trim().split(/\s+/).pop()||e,l&&(e=`${l[1]}${l[2]}`)):f&&(e=f.functionName||e),this.debugFunctionMetadata[a]=e,s=1,c=new Map,u=new Map,b.push(`${h}    __wasm_idle_debug_enter(${a}, ${n+1});`),e===`main`){i===`CPP`&&(b.push(`${h}    std::cout.setf(std::ios::unitbuf);`),b.push(`${h}    std::cerr.setf(std::ios::unitbuf);`));let e=i===`CPP`?`nullptr`:`NULL`;b.push(`${h}    setvbuf(stdout, ${e}, _IONBF, 0);`),b.push(`${h}    setvbuf(stderr, ${e}, _IONBF, 0);`)}let d=j?l?``:S.slice(S.indexOf(`(`)+1,S.lastIndexOf(`)`)):f?.parameters||``;for(let e of d.split(`,`).map(e=>e.trim()).filter(Boolean)){let t=e.split(`=`)[0]?.trim()||``,r=t.match(/^(?:const\s+)?(?:(?:std::)?(vector|set|map)\s*<.+>)\s*&?\s*([A-Za-z_]\w*)\s*$/);if(r){let e=s++,t=r[1],i=r[2];u.set(i,{slot:e,container:t,fromLine:n+1,toLine:2**53-1}),this.debugVariableMetadata[a]=[...this.debugVariableMetadata[a]||[],{slot:e,name:i,kind:`text`,fromLine:n+1,toLine:2**53-1}],b.push(`${h}    __wasm_idle_debug_emit_${t}(${a}, ${e}, ${i});`);continue}let i=[];for(let e of t.matchAll(/\[(\d+)\]/g))i.push(Number(e[1]));let o=t.match(/([A-Za-z_]\w*)\s*(?=\[\d+\])/);if(i.length&&o&&/\b(int|float|double|bool|char)\b/.test(t)){let e=s++;this.debugVariableMetadata[a]=[...this.debugVariableMetadata[a]||[],{slot:e,name:o[1],kind:`array`,elementKind:t.match(/\b(int|float|double|bool|char)\b/)?.[1]||`int`,length:i[0],dimensions:i,fromLine:n+1,toLine:2**53-1}],b.push(`${h}    __wasm_idle_debug_value_addr(${a}, ${e}, (int)((unsigned long long)(${o[1]})));`);continue}if(/[*&\[]/.test(t))continue;let l=t.match(/([A-Za-z_]\w*)\s*(?:\[[^\]]*\])?\s*$/);if(!l)continue;let d=l[1],f=/\bbool\b/.test(t)?`bool`:/\b(?:int|float|double|char|short|long)\b/.test(t)?`number`:``;if(!f)continue;let p=s++;c.set(d,{slot:p,kind:f,fromLine:n+1,toLine:2**53-1}),this.debugVariableMetadata[a]=[...this.debugVariableMetadata[a]||[],{slot:p,name:d,kind:f,fromLine:n+1,toLine:2**53-1}],b.push(`${h}    ${f===`bool`?`__wasm_idle_debug_value_bool`:`__wasm_idle_debug_value_num`}(${a}, ${p}, ${d});`)}f=void 0}else r===0&&S.includes(`(`)&&S.includes(`)`)&&!S.includes(`{`)&&!S.endsWith(`;`)&&!/^(if|for|while|switch|catch)\b/.test(S)&&!/^(class|struct|namespace|enum|union)\b/.test(S)?f={functionName:S.slice(0,S.indexOf(`(`)).trim().split(/\s+/).pop()||`anonymous`,parameters:S.slice(S.indexOf(`(`)+1,S.lastIndexOf(`)`))}:S&&S!==`{`&&(f=void 0);r>0&&t<r&&(r=0,a=0,c=new Map,u=new Map)}_.length&&(i===`CPP`?(b.push(`struct __wasm_idle_debug_globals_init {`),b.push(`    __wasm_idle_debug_globals_init() {`),b.push(..._.map(e=>`        ${e}`)),b.push(`    }`),b.push(`} __wasm_idle_debug_globals_init_instance;`)):(b.push(`__attribute__((constructor)) static void __wasm_idle_debug_globals_init(void) {`),b.push(..._.map(e=>`    ${e}`)),b.push(`}`))),n=b.join(`
`)}else this.debugVariableMetadata={},this.debugGlobalMetadata=[];typeof e.transformSource==`function`&&(n=e.transformSource(n));let u=lt(n);await this.ready,this.addWorkspaceFiles(e.workspaceFiles,t),this.addWorkspaceDirectories(t),this.memfs.addFile(t,u),this.memfs.addFile(r,new Uint8Array);let d=await this.getModule(this.assetUrls.clang),f=this.compilerConfig?.resourceDir||`/lib/clang/8.0.1`,p=`${f.replace(/\/+$/,``)}/include`,m=[`-cc1`,`-triple`,`wasm32-wasi`,`-emit-obj`,`-disable-free`,`-isysroot`,`/`,`-resource-dir`,f,...i===`CPP`?[`-internal-isystem`,`/include/c++/v1`,`-internal-isystem`,p,`-internal-isystem`,`/include/wasm32-wasi`,`-internal-isystem`,`/include`]:[`-internal-isystem`,p,`-internal-isystem`,`/include/wasm32-wasi`,`-internal-isystem`,`/include`],...i===`OBJC`?[`-I.`]:[],`-ferror-limit`,`19`,`-fcolor-diagnostics`,`-O`+l,`-o`,r,s,`-x`,o,...i===`OBJC`?[`-fobjc-runtime=gnustep-2.0`,`-fblocks`]:[],t,...a];this.trace(`compile ${t} -> ${r}`);try{return await this.run(d,!0,`clang`,...m)}catch(e){if(Uint8Array.from(this.memfs.getFileContents(r)).length>0)return this.trace(`recover ${r} after clang output stream exit`),null;throw e}}async link(e,t,n=!1){let r=`lib/wasm32-wasi`,i=this.compilerConfig?.compilerRuntimeLibDir||`lib/clang/8.0.1/lib/wasi`,a=`${r}/crt1.o`;await this.ready;let o=await this.getModule(this.assetUrls.lld);return this.trace(`link ${e} -> ${t}`),await this.run(o,this.log,`wasm-ld`,`--export-dynamic`,...n?[`--allow-undefined`]:[],`-z`,`stack-size=1048576`,`-L${r}/noeh`,`-L${r}`,a,e,`-lc`,`-lc++`,`-lc++abi`,`-lm`,`-L${i}`,`-lclang_rt.builtins-wasm32`,`-o`,t)}async run(e,t,...n){return this.runWithOptions(e,t,n)}async runWithOptions(e,t,n,r={},i,a){this.memfs.out=t,this.hostLog(`${n.join(` `)}\n`),this.trace(`run ${n.join(` `)}`);let o=+new Date,s=new Me(e,this.memfs,n[0],...n.slice(1),{extraImports:i,instanceRef:a});s.environ={...s.environ,...r},s.trace=e=>this.trace(e),s.debugSession={buffer:this.debugBuffer,interruptBuffer:this.debugInterruptBuffer,watchBuffer:this.debugWatchBuffer,watchResultBuffer:this.debugWatchResultBuffer,breakpoints:new Set(this.debugBreakpoints),breakpointVersion:0,pauseOnEntry:this.debugPauseOnEntry,stepArmed:this.debugPauseOnEntry,nextLineArmed:!1,stepOutArmed:!1,callDepth:0,stepOutDepth:0,currentFunctionId:0,currentLine:0,resumeSkipActive:!1,resumeSkipFunctionId:0,resumeSkipLine:0,nextLineFunctionId:0,nextLineLine:0,variableMetadata:this.debugVariableMetadata,globalVariableMetadata:this.debugGlobalMetadata,functionMetadata:this.debugFunctionMetadata,frames:[],globalValues:new Map,onPause:e=>this.onDebugEvent?.(e)};let c=+new Date,l=await s.run(),u=+new Date;return this.log&&this.stdout(`
`),this.showTiming&&this.stdout(`${qe}(${o-c}ms/${u-c}ms)${Je}\n`),l?s:null}async compileLink(e,t={}){let{language:n=`CPP`,fileName:r,activePath:i,workspaceFiles:a=[],args:o=[],compileArgs:s=o,debug:c=!1,breakpoints:l=[],pauseOnEntry:u=!1,cppVersion:d,cVersion:f,debugBuffer:p,interruptBuffer:m,watchBuffer:h,watchResultBuffer:g}=t,{input:_,obj:v,wasm:y}=ct(n,I(i||``)||I(r||``)||void 0);this.beginTrace(c),this.debugBreakpoints=new Set(c?l:[]),this.debugPauseOnEntry=c&&u,this.debugBuffer=p,this.debugInterruptBuffer=m,this.debugWatchBuffer=h,this.debugWatchResultBuffer=g,this.lastArtifactPath=y;let b=JSON.stringify({code:e,input:_,wasm:y,language:n,compileArgs:s,workspaceFiles:a,cppVersion:d,cVersion:f,debug:c});if(this.lastBuildKey===b)return this.trace(`reuse ${y}`),this.wasm;await this.compile({input:_,code:e,obj:v,language:n,compileArgs:s,workspaceFiles:a,cppVersion:d,cVersion:f,debug:c}),await this.link(v,y,c),this.lastBuildKey=b;let x=Uint8Array.from(this.memfs.getFileContents(y));return this.wasm=await this.hostLogAsync(`Compiling ${y}`,WebAssembly.compile(x))}async compileLinkRun(e,t={}){let{language:n=`CPP`,fileName:r,activePath:i,workspaceFiles:a=[],args:o=[],compileArgs:s=o,programArgs:c=[],debug:l=!1,breakpoints:u=[],pauseOnEntry:d=!1,cppVersion:f,cVersion:p,debugBuffer:m,interruptBuffer:h,watchBuffer:g,watchResultBuffer:_}=t;this.debug=l;let{wasm:v}=ct(n,I(i||``)||I(r||``)||void 0);return await this.run(await this.compileLink(e,{language:n,fileName:r,activePath:i,workspaceFiles:a,compileArgs:s,debug:l,breakpoints:u,pauseOnEntry:d,cppVersion:f,cVersion:p,debugBuffer:m,interruptBuffer:h,watchBuffer:g,watchResultBuffer:_}),!0,v,...c)}};function L(e,t){if(!e||typeof e!=`object`||Array.isArray(e))throw Error(`invalid ${t} in wasm-clang runtime manifest`);return e}function R(e,t){if(typeof e!=`string`||e.length===0)throw Error(`invalid ${t} in wasm-clang runtime manifest`);return e}function dt(e,t){if(e!==`wasm32-wasi`)throw Error(`invalid ${t} in wasm-clang runtime manifest`);return e}function ft(e){let t=L(e,`root.compiler`),n=L(t.sysroot,`root.compiler.sysroot`);return{memfs:{asset:R(L(t.memfs,`root.compiler.memfs`).asset,`root.compiler.memfs.asset`),argv0:R(L(t.memfs,`root.compiler.memfs`).argv0,`root.compiler.memfs.argv0`)},clang:{asset:R(L(t.clang,`root.compiler.clang`).asset,`root.compiler.clang.asset`),argv0:R(L(t.clang,`root.compiler.clang`).argv0,`root.compiler.clang.argv0`)},lld:{asset:R(L(t.lld,`root.compiler.lld`).asset,`root.compiler.lld.asset`),argv0:R(L(t.lld,`root.compiler.lld`).argv0,`root.compiler.lld.argv0`)},sysroot:{asset:R(n.asset,`root.compiler.sysroot.asset`),...typeof n.runtimeRoot==`string`?{runtimeRoot:n.runtimeRoot}:{}},...t.resourceDir===void 0?{}:{resourceDir:R(t.resourceDir,`root.compiler.resourceDir`)},...t.compilerRuntimeLibDir===void 0?{}:{compilerRuntimeLibDir:R(t.compilerRuntimeLibDir,`root.compiler.compilerRuntimeLibDir`)},...typeof t.defaultCppStandard==`string`?{defaultCppStandard:t.defaultCppStandard}:{},...typeof t.defaultCStandard==`string`?{defaultCStandard:t.defaultCStandard}:{}}}function pt(e){let t=L(e,`root.clangd`);return{js:R(t.js,`root.clangd.js`),wasm:R(t.wasm,`root.clangd.wasm`)}}function mt(e,t){let n=L(e,t);if(L(n.execution,`${t}.execution`).kind!==`wasi-preview1`)throw Error(`invalid ${t}.execution.kind in wasm-clang runtime manifest`);if(n.artifactFormat!==`wasi-core-wasm`)throw Error(`invalid ${t}.artifactFormat in wasm-clang runtime manifest`);return{artifactFormat:`wasi-core-wasm`,execution:{kind:`wasi-preview1`}}}function ht(e){return{"wasm32-wasi":mt(L(e,`root.targets`)[`wasm32-wasi`],`root.targets.wasm32-wasi`)}}function gt(e){let t=L(e,`root`);if(t.manifestVersion!==1)throw Error(`invalid root.manifestVersion in wasm-clang runtime manifest`);return{manifestVersion:1,version:R(t.version,`root.version`),defaultTarget:dt(t.defaultTarget,`root.defaultTarget`),compiler:ft(t.compiler),clangd:pt(t.clangd),targets:ht(t.targets)}}async function _t(e,t=fetch){let n=Ze(e,`wasm-clang runtime manifest URL`),r=await t(n.toString());if(!r.ok)throw Error(`failed to load wasm-clang runtime manifest from ${n}: ${r.status}`);return gt(await r.json())}function vt(e){return tt(e)}var yt=class e{static read_bytes(t,n){let r=new e;return r.buf=t.getUint32(n,!0),r.buf_len=t.getUint32(n+4,!0),r}static read_bytes_array(t,n,r){let i=[];for(let a=0;a<r;a++)i.push(e.read_bytes(t,n+8*a));return i}},bt=class e{static read_bytes(t,n){let r=new e;return r.buf=t.getUint32(n,!0),r.buf_len=t.getUint32(n+4,!0),r}static read_bytes_array(t,n,r){let i=[];for(let a=0;a<r;a++)i.push(e.read_bytes(t,n+8*a));return i}},xt=class{head_length(){return 24}name_length(){return this.dir_name.byteLength}write_head_bytes(e,t){e.setBigUint64(t,this.d_next,!0),e.setBigUint64(t+8,this.d_ino,!0),e.setUint32(t+16,this.dir_name.length,!0),e.setUint8(t+20,this.d_type)}write_name_bytes(e,t,n){e.set(this.dir_name.slice(0,Math.min(this.dir_name.byteLength,n)),t)}constructor(e,t,n,r){let i=new TextEncoder().encode(n);this.d_next=e,this.d_ino=t,this.d_namlen=i.byteLength,this.d_type=r,this.dir_name=i}},z=class{write_bytes(e,t){e.setUint8(t,this.fs_filetype),e.setUint16(t+2,this.fs_flags,!0),e.setBigUint64(t+8,this.fs_rights_base,!0),e.setBigUint64(t+16,this.fs_rights_inherited,!0)}constructor(e,t){this.fs_rights_base=0n,this.fs_rights_inherited=0n,this.fs_filetype=e,this.fs_flags=t}},B=class{write_bytes(e,t){e.setBigUint64(t,this.dev,!0),e.setBigUint64(t+8,this.ino,!0),e.setUint8(t+16,this.filetype),e.setBigUint64(t+24,this.nlink,!0),e.setBigUint64(t+32,this.size,!0),e.setBigUint64(t+38,this.atim,!0),e.setBigUint64(t+46,this.mtim,!0),e.setBigUint64(t+52,this.ctim,!0)}constructor(e,t,n){this.dev=0n,this.nlink=0n,this.atim=0n,this.mtim=0n,this.ctim=0n,this.ino=e,this.filetype=t,this.size=n}},St=class e{static read_bytes(t,n){return new e(t.getBigUint64(n,!0),t.getUint8(n+8),t.getUint32(n+16,!0),t.getBigUint64(n+24,!0),t.getUint16(n+36,!0))}constructor(e,t,n,r,i){this.userdata=e,this.eventtype=t,this.clockid=n,this.timeout=r,this.flags=i}},Ct=class{write_bytes(e,t){e.setBigUint64(t,this.userdata,!0),e.setUint16(t+8,this.error,!0),e.setUint8(t+10,this.eventtype)}constructor(e,t,n){this.userdata=e,this.error=t,this.eventtype=n}},wt=class{write_bytes(e,t){e.setUint32(t,this.pr_name.byteLength,!0)}constructor(e){this.pr_name=new TextEncoder().encode(e)}},Tt=class e{static dir(t){let n=new e;return n.tag=0,n.inner=new wt(t),n}write_bytes(e,t){e.setUint32(t,this.tag,!0),this.inner.write_bytes(e,t+4)}};let Et=class{enable(e){this.log=Dt(e===void 0?!0:e,this.prefix)}get enabled(){return this.isEnabled}constructor(e){this.isEnabled=e,this.prefix=`wasi:`,this.enable(e)}};function Dt(e,t){return e?console.log.bind(console,`%c%s`,`color: #265BA0`,t):()=>{}}const V=new Et(!1);var Ot=class extends Error{constructor(e){super(`exit with exit code `+e),this.code=e}};let kt=class{start(e){this.inst=e;try{return e.exports._start(),0}catch(e){if(e instanceof Ot)return e.code;throw e}}initialize(e){this.inst=e,e.exports._initialize&&e.exports._initialize()}constructor(e,t,n,r={}){this.args=[],this.env=[],this.fds=[],V.enable(r.debug),this.args=e,this.env=t,this.fds=n;let i=this;this.wasiImport={args_sizes_get(e,t){let n=new DataView(i.inst.exports.memory.buffer);n.setUint32(e,i.args.length,!0);let r=0;for(let e of i.args)r+=e.length+1;return n.setUint32(t,r,!0),V.log(n.getUint32(e,!0),n.getUint32(t,!0)),0},args_get(e,t){let n=new DataView(i.inst.exports.memory.buffer),r=new Uint8Array(i.inst.exports.memory.buffer),a=t;for(let a=0;a<i.args.length;a++){n.setUint32(e,t,!0),e+=4;let o=new TextEncoder().encode(i.args[a]);r.set(o,t),n.setUint8(t+o.length,0),t+=o.length+1}return V.enabled&&V.log(new TextDecoder(`utf-8`).decode(r.slice(a,t))),0},environ_sizes_get(e,t){let n=new DataView(i.inst.exports.memory.buffer);n.setUint32(e,i.env.length,!0);let r=0;for(let e of i.env)r+=new TextEncoder().encode(e).length+1;return n.setUint32(t,r,!0),V.log(n.getUint32(e,!0),n.getUint32(t,!0)),0},environ_get(e,t){let n=new DataView(i.inst.exports.memory.buffer),r=new Uint8Array(i.inst.exports.memory.buffer),a=t;for(let a=0;a<i.env.length;a++){n.setUint32(e,t,!0),e+=4;let o=new TextEncoder().encode(i.env[a]);r.set(o,t),n.setUint8(t+o.length,0),t+=o.length+1}return V.enabled&&V.log(new TextDecoder(`utf-8`).decode(r.slice(a,t))),0},clock_res_get(e,t){let n;switch(e){case 1:n=5000n;break;case 0:n=1000000n;break;default:return 52}return new DataView(i.inst.exports.memory.buffer).setBigUint64(t,n,!0),0},clock_time_get(e,t,n){let r=new DataView(i.inst.exports.memory.buffer);if(e===0)r.setBigUint64(n,BigInt(new Date().getTime())*1000000n,!0);else if(e==1){let e;try{e=BigInt(Math.round(performance.now()*1e6))}catch{e=0n}r.setBigUint64(n,e,!0)}else r.setBigUint64(n,0n,!0);return 0},fd_advise(e,t,n,r){return i.fds[e]==null?8:0},fd_allocate(e,t,n){return i.fds[e]==null?8:i.fds[e].fd_allocate(t,n)},fd_close(e){if(i.fds[e]!=null){let t=i.fds[e].fd_close();return i.fds[e]=void 0,t}else return 8},fd_datasync(e){return i.fds[e]==null?8:i.fds[e].fd_sync()},fd_fdstat_get(e,t){if(i.fds[e]!=null){let{ret:n,fdstat:r}=i.fds[e].fd_fdstat_get();return r?.write_bytes(new DataView(i.inst.exports.memory.buffer),t),n}else return 8},fd_fdstat_set_flags(e,t){return i.fds[e]==null?8:i.fds[e].fd_fdstat_set_flags(t)},fd_fdstat_set_rights(e,t,n){return i.fds[e]==null?8:i.fds[e].fd_fdstat_set_rights(t,n)},fd_filestat_get(e,t){if(i.fds[e]!=null){let{ret:n,filestat:r}=i.fds[e].fd_filestat_get();return r?.write_bytes(new DataView(i.inst.exports.memory.buffer),t),n}else return 8},fd_filestat_set_size(e,t){return i.fds[e]==null?8:i.fds[e].fd_filestat_set_size(t)},fd_filestat_set_times(e,t,n,r){return i.fds[e]==null?8:i.fds[e].fd_filestat_set_times(t,n,r)},fd_pread(e,t,n,r,a){let o=new DataView(i.inst.exports.memory.buffer),s=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let c=yt.read_bytes_array(o,t,n),l=0;for(let t of c){let{ret:n,data:c}=i.fds[e].fd_pread(t.buf_len,r);if(n!=0)return o.setUint32(a,l,!0),n;if(s.set(c,t.buf),l+=c.length,r+=BigInt(c.length),c.length!=t.buf_len)break}return o.setUint32(a,l,!0),0}else return 8},fd_prestat_get(e,t){let n=new DataView(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let{ret:r,prestat:a}=i.fds[e].fd_prestat_get();return a?.write_bytes(n,t),r}else return 8},fd_prestat_dir_name(e,t,n){if(i.fds[e]!=null){let{ret:r,prestat:a}=i.fds[e].fd_prestat_get();if(a==null)return r;let o=a.inner.pr_name;return new Uint8Array(i.inst.exports.memory.buffer).set(o.slice(0,n),t),o.byteLength>n?37:0}else return 8},fd_pwrite(e,t,n,r,a){let o=new DataView(i.inst.exports.memory.buffer),s=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let c=bt.read_bytes_array(o,t,n),l=0;for(let t of c){let n=s.slice(t.buf,t.buf+t.buf_len),{ret:c,nwritten:u}=i.fds[e].fd_pwrite(n,r);if(c!=0)return o.setUint32(a,l,!0),c;if(l+=u,r+=BigInt(u),u!=n.byteLength)break}return o.setUint32(a,l,!0),0}else return 8},fd_read(e,t,n,r){let a=new DataView(i.inst.exports.memory.buffer),o=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let s=yt.read_bytes_array(a,t,n),c=0;for(let t of s){let{ret:n,data:s}=i.fds[e].fd_read(t.buf_len);if(n!=0)return a.setUint32(r,c,!0),n;if(o.set(s,t.buf),c+=s.length,s.length!=t.buf_len)break}return a.setUint32(r,c,!0),0}else return 8},fd_readdir(e,t,n,r,a){let o=new DataView(i.inst.exports.memory.buffer),s=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let c=0;for(;;){let{ret:l,dirent:u}=i.fds[e].fd_readdir_single(r);if(l!=0)return o.setUint32(a,c,!0),l;if(u==null)break;if(n-c<u.head_length()){c=n;break}let d=new ArrayBuffer(u.head_length());if(u.write_head_bytes(new DataView(d),0),s.set(new Uint8Array(d).slice(0,Math.min(d.byteLength,n-c)),t),t+=u.head_length(),c+=u.head_length(),n-c<u.name_length()){c=n;break}u.write_name_bytes(s,t,n-c),t+=u.name_length(),c+=u.name_length(),r=u.d_next}return o.setUint32(a,c,!0),0}else return 8},fd_renumber(e,t){if(i.fds[e]!=null&&i.fds[t]!=null){let n=i.fds[t].fd_close();return n==0?(i.fds[t]=i.fds[e],i.fds[e]=void 0,0):n}else return 8},fd_seek(e,t,n,r){let a=new DataView(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let{ret:o,offset:s}=i.fds[e].fd_seek(t,n);return a.setBigInt64(r,s,!0),o}else return 8},fd_sync(e){return i.fds[e]==null?8:i.fds[e].fd_sync()},fd_tell(e,t){let n=new DataView(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let{ret:r,offset:a}=i.fds[e].fd_tell();return n.setBigUint64(t,a,!0),r}else return 8},fd_write(e,t,n,r){let a=new DataView(i.inst.exports.memory.buffer),o=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let s=bt.read_bytes_array(a,t,n),c=0;for(let t of s){let n=o.slice(t.buf,t.buf+t.buf_len),{ret:s,nwritten:l}=i.fds[e].fd_write(n);if(s!=0)return a.setUint32(r,c,!0),s;if(c+=l,l!=n.byteLength)break}return a.setUint32(r,c,!0),0}else return 8},path_create_directory(e,t,n){let r=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let a=new TextDecoder(`utf-8`).decode(r.slice(t,t+n));return i.fds[e].path_create_directory(a)}else return 8},path_filestat_get(e,t,n,r,a){let o=new DataView(i.inst.exports.memory.buffer),s=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let c=new TextDecoder(`utf-8`).decode(s.slice(n,n+r)),{ret:l,filestat:u}=i.fds[e].path_filestat_get(t,c);return u?.write_bytes(o,a),l}else return 8},path_filestat_set_times(e,t,n,r,a,o,s){let c=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let l=new TextDecoder(`utf-8`).decode(c.slice(n,n+r));return i.fds[e].path_filestat_set_times(t,l,a,o,s)}else return 8},path_link(e,t,n,r,a,o,s){let c=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null&&i.fds[a]!=null){let l=new TextDecoder(`utf-8`).decode(c.slice(n,n+r)),u=new TextDecoder(`utf-8`).decode(c.slice(o,o+s)),{ret:d,inode_obj:f}=i.fds[e].path_lookup(l,t);return f==null?d:i.fds[a].path_link(u,f,!1)}else return 8},path_open(e,t,n,r,a,o,s,c,l){let u=new DataView(i.inst.exports.memory.buffer),d=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let f=new TextDecoder(`utf-8`).decode(d.slice(n,n+r));V.log(f);let{ret:p,fd_obj:m}=i.fds[e].path_open(t,f,a,o,s,c);if(p!=0)return p;i.fds.push(m);let h=i.fds.length-1;return u.setUint32(l,h,!0),0}else return 8},path_readlink(e,t,n,r,a,o){let s=new DataView(i.inst.exports.memory.buffer),c=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let l=new TextDecoder(`utf-8`).decode(c.slice(t,t+n));V.log(l);let{ret:u,data:d}=i.fds[e].path_readlink(l);if(d!=null){let e=new TextEncoder().encode(d);if(e.length>a)return s.setUint32(o,0,!0),8;c.set(e,r),s.setUint32(o,e.length,!0)}return u}else return 8},path_remove_directory(e,t,n){let r=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let a=new TextDecoder(`utf-8`).decode(r.slice(t,t+n));return i.fds[e].path_remove_directory(a)}else return 8},path_rename(e,t,n,r,a,o){let s=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null&&i.fds[r]!=null){let c=new TextDecoder(`utf-8`).decode(s.slice(t,t+n)),l=new TextDecoder(`utf-8`).decode(s.slice(a,a+o)),{ret:u,inode_obj:d}=i.fds[e].path_unlink(c);if(d==null)return u;if(u=i.fds[r].path_link(l,d,!0),u!=0&&i.fds[e].path_link(c,d,!0)!=0)throw`path_link should always return success when relinking an inode back to the original place`;return u}else return 8},path_symlink(e,t,n,r,a){let o=new Uint8Array(i.inst.exports.memory.buffer);return i.fds[n]==null?8:(new TextDecoder(`utf-8`).decode(o.slice(e,e+t)),new TextDecoder(`utf-8`).decode(o.slice(r,r+a)),58)},path_unlink_file(e,t,n){let r=new Uint8Array(i.inst.exports.memory.buffer);if(i.fds[e]!=null){let a=new TextDecoder(`utf-8`).decode(r.slice(t,t+n));return i.fds[e].path_unlink_file(a)}else return 8},poll_oneoff(e,t,n){if(n===0)return 28;if(n>1)return V.log(`poll_oneoff: only a single subscription is supported`),58;let r=new DataView(i.inst.exports.memory.buffer),a=St.read_bytes(r,e),o=a.eventtype,s=a.clockid,c=a.timeout;if(o!==0)return V.log(`poll_oneoff: only clock subscriptions are supported`),58;let l;if(s===1)l=()=>BigInt(Math.round(performance.now()*1e6));else if(s===0)l=()=>BigInt(new Date().getTime())*1000000n;else return 28;let u=a.flags&1?c:l()+c;for(;u>l(););return new Ct(a.userdata,0,o).write_bytes(r,t),0},proc_exit(e){throw new Ot(e)},proc_raise(e){throw`raised signal `+e},sched_yield(){},random_get(e,t){let n=new Uint8Array(i.inst.exports.memory.buffer).subarray(e,e+t);if(`crypto`in globalThis&&(typeof SharedArrayBuffer>`u`||!(i.inst.exports.memory.buffer instanceof SharedArrayBuffer)))for(let e=0;e<t;e+=65536)crypto.getRandomValues(n.subarray(e,e+65536));else for(let e=0;e<t;e++)n[e]=Math.random()*256|0},sock_recv(e,t,n){throw`sockets not supported`},sock_send(e,t,n){throw`sockets not supported`},sock_shutdown(e,t){throw`sockets not supported`},sock_accept(e,t){throw`sockets not supported`}}}};var H=class{fd_allocate(e,t){return 58}fd_close(){return 0}fd_fdstat_get(){return{ret:58,fdstat:null}}fd_fdstat_set_flags(e){return 58}fd_fdstat_set_rights(e,t){return 58}fd_filestat_get(){return{ret:58,filestat:null}}fd_filestat_set_size(e){return 58}fd_filestat_set_times(e,t,n){return 58}fd_pread(e,t){return{ret:58,data:new Uint8Array}}fd_prestat_get(){return{ret:58,prestat:null}}fd_pwrite(e,t){return{ret:58,nwritten:0}}fd_read(e){return{ret:58,data:new Uint8Array}}fd_readdir_single(e){return{ret:58,dirent:null}}fd_seek(e,t){return{ret:58,offset:0n}}fd_sync(){return 0}fd_tell(){return{ret:58,offset:0n}}fd_write(e){return{ret:58,nwritten:0}}path_create_directory(e){return 58}path_filestat_get(e,t){return{ret:58,filestat:null}}path_filestat_set_times(e,t,n,r,i){return 58}path_link(e,t,n){return 58}path_unlink(e){return{ret:58,inode_obj:null}}path_lookup(e,t){return{ret:58,inode_obj:null}}path_open(e,t,n,r,i,a){return{ret:54,fd_obj:null}}path_readlink(e){return{ret:58,data:null}}path_remove_directory(e){return 58}path_rename(e,t,n){return 58}path_unlink_file(e){return 58}},U=class e{static issue_ino(){return e.next_ino++}static root_ino(){return 0n}constructor(){this.ino=e.issue_ino()}};U.next_ino=1n;var At=class extends H{fd_allocate(e,t){if(!(this.file.size>e+t)){let n=new Uint8Array(Number(e+t));n.set(this.file.data,0),this.file.data=n}return 0}fd_fdstat_get(){return{ret:0,fdstat:new z(4,0)}}fd_filestat_set_size(e){if(this.file.size>e)this.file.data=new Uint8Array(this.file.data.buffer.slice(0,Number(e)));else{let t=new Uint8Array(Number(e));t.set(this.file.data,0),this.file.data=t}return 0}fd_read(e){let t=this.file.data.slice(Number(this.file_pos),Number(this.file_pos+BigInt(e)));return this.file_pos+=BigInt(t.length),{ret:0,data:t}}fd_pread(e,t){return{ret:0,data:this.file.data.slice(Number(t),Number(t+BigInt(e)))}}fd_seek(e,t){let n;switch(t){case 0:n=e;break;case 1:n=this.file_pos+e;break;case 2:n=BigInt(this.file.data.byteLength)+e;break;default:return{ret:28,offset:0n}}return n<0?{ret:28,offset:0n}:(this.file_pos=n,{ret:0,offset:this.file_pos})}fd_tell(){return{ret:0,offset:this.file_pos}}fd_write(e){if(this.file.readonly)return{ret:8,nwritten:0};if(this.file_pos+BigInt(e.byteLength)>this.file.size){let t=this.file.data;this.file.data=new Uint8Array(Number(this.file_pos+BigInt(e.byteLength))),this.file.data.set(t)}return this.file.data.set(e,Number(this.file_pos)),this.file_pos+=BigInt(e.byteLength),{ret:0,nwritten:e.byteLength}}fd_pwrite(e,t){if(this.file.readonly)return{ret:8,nwritten:0};if(t+BigInt(e.byteLength)>this.file.size){let n=this.file.data;this.file.data=new Uint8Array(Number(t+BigInt(e.byteLength))),this.file.data.set(n)}return this.file.data.set(e,Number(t)),{ret:0,nwritten:e.byteLength}}fd_filestat_get(){return{ret:0,filestat:this.file.stat()}}constructor(e){super(),this.file_pos=0n,this.file=e}},jt=class extends H{fd_seek(e,t){return{ret:8,offset:0n}}fd_tell(){return{ret:8,offset:0n}}fd_allocate(e,t){return 8}fd_fdstat_get(){return{ret:0,fdstat:new z(3,0)}}fd_readdir_single(e){if(V.enabled&&(V.log(`readdir_single`,e),V.log(e,this.dir.contents.keys())),e==0n)return{ret:0,dirent:new xt(1n,this.dir.ino,`.`,3)};if(e==1n)return{ret:0,dirent:new xt(2n,this.dir.parent_ino(),`..`,3)};if(e>=BigInt(this.dir.contents.size)+2n)return{ret:0,dirent:null};let[t,n]=Array.from(this.dir.contents.entries())[Number(e-2n)];return{ret:0,dirent:new xt(e+1n,n.ino,t,n.stat().filetype)}}path_filestat_get(e,t){let{ret:n,path:r}=W.from(t);if(r==null)return{ret:n,filestat:null};let{ret:i,entry:a}=this.dir.get_entry_for_path(r);return a==null?{ret:i,filestat:null}:{ret:0,filestat:a.stat()}}path_lookup(e,t){let{ret:n,path:r}=W.from(e);if(r==null)return{ret:n,inode_obj:null};let{ret:i,entry:a}=this.dir.get_entry_for_path(r);return a==null?{ret:i,inode_obj:null}:{ret:0,inode_obj:a}}path_open(e,t,n,r,i,a){let{ret:o,path:s}=W.from(t);if(s==null)return{ret:o,fd_obj:null};let{ret:c,entry:l}=this.dir.get_entry_for_path(s);if(l==null){if(c!=44)return{ret:c,fd_obj:null};if((n&1)==1){let{ret:e,entry:r}=this.dir.create_entry_for_path(t,(n&2)==2);if(r==null)return{ret:e,fd_obj:null};l=r}else return{ret:44,fd_obj:null}}else if((n&4)==4)return{ret:20,fd_obj:null};return(n&2)==2&&l.stat().filetype!==3?{ret:54,fd_obj:null}:l.path_open(n,r,a)}path_create_directory(e){return this.path_open(0,e,3,0n,0n,0).ret}path_link(e,t,n){let{ret:r,path:i}=W.from(e);if(i==null)return r;if(i.is_dir)return 44;let{ret:a,parent_entry:o,filename:s,entry:c}=this.dir.get_parent_dir_and_entry_for_path(i,!0);if(o==null||s==null)return a;if(c!=null){let e=t.stat().filetype==3,r=c.stat().filetype==3;if(e&&r)if(n&&c instanceof G){if(c.contents.size!=0)return 55}else return 20;else if(e&&!r)return 54;else if(!e&&r)return 31;else if(!(t.stat().filetype==4&&c.stat().filetype==4))return 20}return!n&&t.stat().filetype==3?63:(o.contents.set(s,t),0)}path_unlink(e){let{ret:t,path:n}=W.from(e);if(n==null)return{ret:t,inode_obj:null};let{ret:r,parent_entry:i,filename:a,entry:o}=this.dir.get_parent_dir_and_entry_for_path(n,!0);return i==null||a==null?{ret:r,inode_obj:null}:o==null?{ret:44,inode_obj:null}:(i.contents.delete(a),{ret:0,inode_obj:o})}path_unlink_file(e){let{ret:t,path:n}=W.from(e);if(n==null)return t;let{ret:r,parent_entry:i,filename:a,entry:o}=this.dir.get_parent_dir_and_entry_for_path(n,!1);return i==null||a==null||o==null?r:o.stat().filetype===3?31:(i.contents.delete(a),0)}path_remove_directory(e){let{ret:t,path:n}=W.from(e);if(n==null)return t;let{ret:r,parent_entry:i,filename:a,entry:o}=this.dir.get_parent_dir_and_entry_for_path(n,!1);return i==null||a==null||o==null?r:!(o instanceof G)||o.stat().filetype!==3?54:o.contents.size===0?i.contents.delete(a)?0:44:55}fd_filestat_get(){return{ret:0,filestat:this.dir.stat()}}fd_filestat_set_size(e){return 8}fd_read(e){return{ret:8,data:new Uint8Array}}fd_pread(e,t){return{ret:8,data:new Uint8Array}}fd_write(e){return{ret:8,nwritten:0}}fd_pwrite(e,t){return{ret:8,nwritten:0}}constructor(e){super(),this.dir=e}},Mt=class extends jt{fd_prestat_get(){return{ret:0,prestat:Tt.dir(this.prestat_name)}}constructor(e,t){super(new G(t)),this.prestat_name=e}},Nt=class extends U{path_open(e,t,n){if(this.readonly&&(t&BigInt(64))==BigInt(64))return{ret:63,fd_obj:null};if((e&8)==8){if(this.readonly)return{ret:63,fd_obj:null};this.data=new Uint8Array([])}let r=new At(this);return n&1&&r.fd_seek(0n,2),{ret:0,fd_obj:r}}get size(){return BigInt(this.data.byteLength)}stat(){return new B(this.ino,4,this.size)}constructor(e,t){super(),this.data=new Uint8Array(e),this.readonly=!!t?.readonly}};let W=class e{static from(t){let n=new e;if(n.is_dir=t.endsWith(`/`),t.startsWith(`/`))return{ret:76,path:null};if(t.includes(`\0`))return{ret:28,path:null};for(let e of t.split(`/`))if(!(e===``||e===`.`)){if(e===`..`){if(n.parts.pop()==null)return{ret:76,path:null};continue}n.parts.push(e)}return{ret:0,path:n}}to_path_string(){let e=this.parts.join(`/`);return this.is_dir&&(e+=`/`),e}constructor(){this.parts=[],this.is_dir=!1}};var G=class e extends U{parent_ino(){return this.parent==null?U.root_ino():this.parent.ino}path_open(e,t,n){return{ret:0,fd_obj:new jt(this)}}stat(){return new B(this.ino,3,0n)}get_entry_for_path(t){let n=this;for(let r of t.parts){if(!(n instanceof e))return{ret:54,entry:null};let t=n.contents.get(r);if(t!==void 0)n=t;else return V.log(r),{ret:44,entry:null}}return t.is_dir&&n.stat().filetype!=3?{ret:54,entry:null}:{ret:0,entry:n}}get_parent_dir_and_entry_for_path(t,n){let r=t.parts.pop();if(r===void 0)return{ret:28,parent_entry:null,filename:null,entry:null};let{ret:i,entry:a}=this.get_entry_for_path(t);if(a==null)return{ret:i,parent_entry:null,filename:null,entry:null};if(!(a instanceof e))return{ret:54,parent_entry:null,filename:null,entry:null};let o=a.contents.get(r);return o===void 0?n?{ret:0,parent_entry:a,filename:r,entry:null}:{ret:44,parent_entry:null,filename:null,entry:null}:t.is_dir&&o.stat().filetype!=3?{ret:54,parent_entry:null,filename:null,entry:null}:{ret:0,parent_entry:a,filename:r,entry:o}}create_entry_for_path(t,n){let{ret:r,path:i}=W.from(t);if(i==null)return{ret:r,entry:null};let{ret:a,parent_entry:o,filename:s,entry:c}=this.get_parent_dir_and_entry_for_path(i,!0);if(o==null||s==null)return{ret:a,entry:null};if(c!=null)return{ret:20,entry:null};V.log(`create`,i);let l;return l=n?new e(new Map):new Nt(new ArrayBuffer(0)),o.contents.set(s,l),c=l,{ret:0,entry:c}}constructor(t){super(),this.parent=null,t instanceof Array?this.contents=new Map(t):this.contents=t;for(let t of this.contents.values())t instanceof e&&(t.parent=this)}};function Pt(e){let t=e.replace(/\\/g,`/`),n=t.startsWith(`/`)?t:`/${t}`,r=[];for(let t of n.split(`/`))if(!(!t||t===`.`)){if(t===`..`)throw Error(`wasm-clang does not allow guest path traversal: ${e}`);r.push(t)}return`/${r.join(`/`)}`}function Ft(e){return typeof e==`string`?new TextEncoder().encode(e):(e instanceof Uint8Array,new Uint8Array(e))}var It=class extends H{ino=U.issue_ino();decoder=new TextDecoder;chunks=[];output;constructor(e){super(),this.output=e}fd_filestat_get(){return{ret:0,filestat:new B(this.ino,2,0n)}}fd_fdstat_get(){let e=new z(2,0);return e.fs_rights_base=BigInt(64),{ret:0,fdstat:e}}fd_write(e){let t=this.decoder.decode(e,{stream:!0});return this.chunks.push(t),this.output?.(t),{ret:0,nwritten:e.byteLength}}getText(){let e=this.decoder.decode();return e&&(this.chunks.push(e),this.output?.(e)),this.chunks.join(``)}},Lt=class{currentChunk=new Uint8Array;currentOffset=0;readInput;constructor(e){this.readInput=e}read(e){for(;this.currentOffset>=this.currentChunk.length;){let e=this.readInput?.();if(e==null)return new Uint8Array;this.currentChunk=Ft(e),this.currentOffset=0,this.currentChunk.byteLength}let t=this.currentChunk.slice(this.currentOffset,this.currentOffset+e);return this.currentOffset+=t.byteLength,t}},Rt=class extends H{ino=U.issue_ino();source;constructor(e){super(),this.source=e}fd_filestat_get(){return{ret:0,filestat:new B(this.ino,2,0n)}}fd_fdstat_get(){let e=new z(2,0);return e.fs_rights_base=BigInt(2),{ret:0,fdstat:e}}fd_read(e){return{ret:0,data:this.source.read(e)}}};function zt(e={}){let t=new G(new Map);for(let n of e.files||[]){let e=Pt(n.path).slice(1).split(`/`),r=t;for(let t of e.slice(0,-1)){let e=r.contents.get(t);if(e instanceof G){r=e;continue}let n=new G(new Map);r.contents.set(t,n),r=n}r.contents.set(e.at(-1),new Nt(Ft(n.contents)))}let n=new Lt(e.stdin),r=new It(e.stdout),i=new It(e.stderr),a=new Map([[`PWD`,`/`]]);for(let[t,n]of Object.entries(e.env||{}))a.set(t,n);return{args:[e.programName||`main.wasm`,...e.args||[]],envEntries:Array.from(a.entries()).map(([e,t])=>`${e}=${t}`),rootDirectory:t,stdout:r,stderr:i,fds:[new Rt(n),r,i,new Mt(`/tmp`,new Map),new Mt(`/`,t.contents)]}}async function Bt(e,t={}){if(e.target!==`wasm32-wasi`||e.format!==`wasi-core-wasm`)throw Error(`wasm-clang currently executes only wasm32-wasi preview1 core wasm artifacts.`);let n=zt({...t,programName:t.programName||e.fileName}),r=new kt(n.args,n.envEntries,n.fds,{debug:!1}),i=(e.bytes instanceof Uint8Array,new Uint8Array(e.bytes)),a=e.wasm||await WebAssembly.compile(i),o={current:null},s=typeof t.extraImports==`function`?await t.extraImports({host:n,module:a,instance:o}):t.extraImports||{},c=await WebAssembly.instantiate(a,{...s,wasi_unstable:r.wasiImport,wasi_snapshot_preview1:r.wasiImport});return o.current=c,{exitCode:r.start(c),stdout:n.stdout.getText(),stderr:n.stderr.getText()}}let Vt=null,K=null;const q=e=>Vt?.postMessage(e),Ht=e=>K?.configureRuntimeAssets(e),Ut=e=>K?.handleAssetMessage(e)??!1,Wt=(e,t)=>{if(!K)throw Error(`Objective-C worker dependencies are not installed.`);return K.waitForStdin(e,t)},Gt=new TextDecoder,Kt=[],J=/^\s*#\s*(?:include|import)(?:_next)?\s+[<"]([^>"]+)[>"]/gm,qt=[`Foundation/`,`GNUstepBase/`,`CoreFoundation/`],Jt=[`._OBJC_CLASS_NSObject`,`._OBJC_CLASS_NSConstantString`,`GSPrivateNotifyASAP`];let Yt=null,Y=null,X=null,Xt=0,Z=null,Zt=``,Qt=!1,Q=null,$t=null,en=null,tn=!1;const nn=new Set;let rn=!1,an=null,on=!1;const sn=e=>e.replaceAll(`\\`,`/`).split(`/`).filter(e=>e&&e!==`.`&&e!==`..`).join(`/`),cn=e=>e.split(`/`).pop()||e,ln=e=>cn(e).replace(/\.[^.]+$/,``)||`main`,un=e=>e.endsWith(`
`)?e:`${e}\n`;function $(e,t){let n=e?.trim();if(!n)throw Error(`${t} is required.`);let r;try{r=new URL(n,typeof location<`u`?location.href:void 0)}catch{throw Error(`${t} must be an absolute HTTP(S) URL.`)}if(r.protocol!==`http:`&&r.protocol!==`https:`)throw Error(`${t} must use HTTP(S).`);return r.toString()}function dn(e){return{libobjcUrl:$(e.libobjcUrl,`Objective-C libobjc URL`),headersUrl:$(e.headersUrl,`Objective-C headers URL`),libgnustepBaseUrl:$(e.libgnustepBaseUrl,`Objective-C GNUstep Base URL`),libgnustepBaseObjectUrl:$(e.libgnustepBaseObjectUrl,`Objective-C GNUstep Base object URL`),foundationHeadersUrl:$(e.foundationHeadersUrl,`Objective-C Foundation headers URL`),libffiUrl:$(e.libffiUrl,`Objective-C libffi URL`)}}const fn=e=>{let t=sn(e||``);return t?/\.[A-Za-z0-9_-]+$/.test(t)?t:`${t}.m`:`main.m`};function pn(e){return(e.headers.get(`content-encoding`)||``).toLowerCase().split(`,`).map(e=>e.trim()).includes(`gzip`)}async function mn(e,t){if(pn(e))return new Uint8Array(await e.arrayBuffer());if(!e.body||typeof DecompressionStream!=`function`)throw Error(`${t} is gzip-compressed, but DecompressionStream is unavailable.`);let n=e.body.pipeThrough(new DecompressionStream(`gzip`));return new Uint8Array(await new Response(n).arrayBuffer())}async function hn(e,t){let n=await fetch(e);if(!n.ok){let r=await fetch(`${e}.gz`).catch(()=>null);if(!r?.ok)throw Error(`Failed to load ${t}: ${n.status}`);return mn(r,t)}return new Uint8Array(await n.arrayBuffer())}async function gn(e,t){return JSON.parse(Gt.decode(await hn(e,t)))}function _n(e){let t=()=>{let t=e.current?.exports.memory;if(!(t instanceof WebAssembly.Memory))throw Error(`Objective-C libffi bridge missing exported memory`);return new DataView(t.buffer)},n=()=>{let t=e.current?.exports.__indirect_function_table;if(!(t instanceof WebAssembly.Table))throw Error(`Objective-C libffi bridge missing exported function table`);return t},r=()=>{let t=e.current?.exports.malloc;if(typeof t!=`function`)throw Error(`Objective-C libffi bridge missing exported malloc`);return t},i=()=>{let t=e.current?.exports.free;if(typeof t!=`function`)throw Error(`Objective-C libffi bridge missing exported free`);return t},a=()=>{let e=n(),t=Kt.pop();if(t!=null)return t;let r=e.length;return e.grow(1),r},o=(e,t)=>e.getUint32(t,!0),s=(e,t)=>e.getUint16(t+6,!0),c=(e,t,n)=>{switch(n){case 1:case 9:return e.getUint32(t,!0);case 10:return e.getInt32(t,!0);case 2:return e.getFloat32(t,!0);case 3:return e.getFloat64(t,!0);case 5:return e.getUint8(t);case 6:return e.getInt8(t);case 7:return e.getUint16(t,!0);case 8:return e.getInt16(t,!0);case 11:return e.getBigUint64(t,!0);case 12:return e.getBigInt64(t,!0);case 14:return e.getUint32(t,!0);default:throw Error(`Objective-C libffi bridge cannot marshal argument type ${n}`)}},l=(e,t,n,r)=>{if(!(!t||n===0))switch(n){case 1:case 9:e.setUint32(t,Number(r),!0);break;case 10:e.setInt32(t,Number(r),!0);break;case 2:e.setFloat32(t,Number(r),!0);break;case 3:e.setFloat64(t,Number(r),!0);break;case 5:e.setUint8(t,Number(r));break;case 6:e.setInt8(t,Number(r));break;case 7:e.setUint16(t,Number(r),!0);break;case 8:e.setInt16(t,Number(r),!0);break;case 11:e.setBigUint64(t,BigInt(r),!0);break;case 12:e.setBigInt64(t,BigInt(r),!0);break;case 14:e.setUint32(t,Number(r),!0);break;default:throw Error(`Objective-C libffi bridge cannot marshal return type ${n}`)}};return{env:{ffi_call_js:(e,r,i,a)=>{let u=t(),d=o(u,e+4),f=o(u,e+8),p=s(u,o(u,e+12)),m=[];for(let e=0;e<d;e+=1){let t=o(u,a+e*4),n=o(u,f+e*4);m.push(c(u,t,s(u,n)))}let h=n().get(r);if(typeof h!=`function`)throw Error(`Objective-C libffi bridge missing function table entry ${r}`);l(u,i,p,h(...m))},ffi_closure_alloc_js:(e,n)=>{let i=t(),o=r()(e),s=a();return n&&i.setUint32(n,s,!0),i.setUint32(o,s,!0),o},ffi_closure_free_js:e=>{let n=o(t(),e);Kt.push(n),i()(e)},ffi_prep_closure_loc_js:()=>2,GSLeftInsertionPointForKeyInSortedRange:(e,t,n=0)=>n,GSRightInsertionPointForKeyInSortedRange:(e,t,n=0)=>n,GSSortStable:()=>void 0,GSSortStableConcurrent:()=>void 0,GSSortUnstable:()=>void 0,GSSortUnstableConcurrent:()=>void 0}}}async function vn(e,t,n){let r=sn(t).split(`/`).slice(0,-1),i=``;for(let t of r){i=i?`${i}/${t}`:t;try{e.memfs.addDirectory(i)}catch{}}e.memfs.addFile(t,n)}async function yn(e,t,n){let r=dn(t);Ht(e||null);let i=e?.baseUrl||``;Y=new ut({stdout:e=>q({output:e}),stdin:()=>``,progress:e=>q({progress:e}),onDebugEvent:e=>q({debugEvent:e}),log:n,runtimeBaseUrl:i,manifest:await _t(vt(i))}),X=r,Qt=!1,$t=null,en=null,tn=!1,nn.clear();let[a,o]=await Promise.all([hn(r.libobjcUrl,`libobjc.a`),gn(r.headersUrl,`Objective-C headers`)]);await Y.ready;for(let[e,t]of Object.entries(o))nn.add(e),await vn(Y,e,t);Y.memfs.addFile(`libobjc.a`,a)}async function bn(){if(!Y)throw Error(`Objective-C runtime is not loaded.`);if(!X)throw Error(`Objective-C runtime asset config is not loaded.`);if(Qt)return;let e=await gn(X.foundationHeadersUrl,`Objective-C Foundation headers`);Q=e,e[`blocks_runtime.h`]!=null&&!nn.has(`blocks_runtime.h`)&&(nn.add(`blocks_runtime.h`),await vn(Y,`blocks_runtime.h`,e[`blocks_runtime.h`])),Qt=!0}async function xn(){if(!Y)throw Error(`Objective-C runtime is not loaded.`);if(!X)throw Error(`Objective-C runtime asset config is not loaded.`);if(!tn){if(!$t||!en){let[e,t]=await Promise.all([hn(X.libgnustepBaseUrl,`libgnustep-base.a`),hn(X.libffiUrl,`libffi.a`)]);$t=e,en=t}Y.memfs.addFile(`libffi.a`,en),Y.memfs.addFile(`libgnustep-base.a`,$t),tn=!0}}function Sn(){return rn?on?null:(on=!0,an??``):Wt(Yt,()=>q({buffer:!0}))}function Cn(e){let t=e.toLowerCase();return t.endsWith(`.m`)?`objective-c`:t.endsWith(`.c`)?`c`:null}function wn(e){return/#\s*(?:include|import)\s+[<"]Foundation\/|@import\s+Foundation\b/u.test(e)}function Tn(e,t,n){if(t.startsWith(`ObjectiveC2/`)){let r=t.slice(12);return n[r]==null?n[`objc/${r}`]==null?Tn(e,r,n):`objc/${r}`:r}if(n[t]!=null)return t;let r=e.includes(`/`)?e.split(`/`).slice(0,-1).join(`/`):``;if(r&&!t.includes(`/`)){let e=`${r}/${t}`;if(n[e]!=null)return e}for(let e of[`Foundation`,`CoreFoundation`,`GNUstepBase`]){let r=`${e}/${t}`;if(n[r]!=null)return r}return null}function En(e,t){let n=t[e];return n==null?``:e===`Foundation/NSObjCRuntime.h`?`#include <stdint.h>
@class NSString;
#ifndef GSNativeChar
typedef char GSNativeChar;
#endif
${n.replace(/^\s*#\s*import\s*<GNUstepBase\/GSBlocks\.h>\s*$/m,`
#ifndef BLOCK_SCOPE
...
#endif
`).replace(/^\s*#\s*import\s*<GNUstepBase\/GSObjCRuntime\.h>\s*$/m,``)}`:n}function Dn(e,t,n=new Set){if(n.has(e))return``;n.add(e);let r=En(e,t);if(!r)return``;let i=``,a=0;J.lastIndex=0;for(let o of r.matchAll(J)){let s=o[1],c=Tn(e,s,t),l=c!=null&&qt.some(e=>c.startsWith(e));i+=r.slice(a,o.index),c&&l&&c!==`GNUstepBase/GSBlocks.h`&&c!==`GNUstepBase/GSObjCRuntime.h`?i+=`\n${Dn(c,t,n)}\n`:s===`ObjectiveC2/blocks_runtime.h`?i+=o[0].replace(s,`blocks_runtime.h`):s===`ObjectiveC2/objc/runtime.h`?i+=o[0].replace(s,`objc/runtime.h`):i+=o[0],a=o.index+o[0].length}return i+r.slice(a)}function On(e,t){if(!Q)return t;let n=new Set,r=``,i=0;J.lastIndex=0;for(let a of t.matchAll(J)){if(!qt.some(e=>a[1].startsWith(e))&&a[1]!==`Foundation.h`)continue;let o=Tn(e,a[1],Q);o&&(r+=t.slice(i,a.index),r+=`\n${Dn(o,Q,n)}\n`,i=a.index+a[0].length)}return r+t.slice(i)}async function kn(e,t,n,r,i=[],a=!1,o){if(!Y)throw Error(`Objective-C runtime is not loaded.`);if(a){if(t==null)throw Error(`Objective-C debug compilation requires the active source text.`);await Y.compile({input:e,code:t,obj:n,language:r===`objective-c`?`OBJC`:`C`,compileArgs:i,debug:!0,transformSource:o});return}t!=null&&await vn(Y,e,t),Y.memfs.addFile(n,new Uint8Array);let s=await Y.getModule(Y.assetUrls.clang),c=Y,l=c.stdout,u=[],d=Y.compilerConfig?.resourceDir||`/lib/clang/8.0.1`,f=[`-cc1`,`-triple`,`wasm32-wasi`,`-emit-obj`,`-disable-free`,`-isysroot`,`/`,`-resource-dir`,d,`-internal-isystem`,`${d.replace(/\/+$/,``)}/include`,`-internal-isystem`,`/include/wasm32-wasi`,`-internal-isystem`,`/include`,`-I.`,`-ferror-limit`,`20`,`-O2`,`-o`,n,`-x`,r,...r===`objective-c`?[`-fobjc-runtime=gnustep-2.0`,`-fblocks`]:[],e,...i];try{c.stdout=e=>u.push(e),await Y.run(s,!0,`clang`,...f)}catch(e){if(Uint8Array.from(Y.memfs.getFileContents(n)).length>0)return;for(let e of u)q({output:e});throw e}finally{c.stdout=l}}async function An(e,t,n,r=[],i=!1){if(!Y)throw Error(`Objective-C runtime is not loaded.`);let a=e=>console.log(`[wasm-idle:objectivec-worker] ${e}`),o=fn(t),s=`__wasm_idle_objc_${++Xt}`,c=[],l=new Set;for(let e of n){let t=sn(e.path);if(!t||t===o||l.has(t))continue;l.add(t);let n=`${s}/${t}`;await vn(Y,n,e.content);let r=Cn(t);r&&c.push({path:t,prefixedPath:n,language:r})}let u=ln(o),d=`${s}/${o}`,f=`${s}/${u}.o`,p=`${s}/objc_ctor.c`,m=`${s}/objc_ctor.o`,h=`${s}/${u}.wasm`,g=[],_=Cn(o)||`objective-c`,v=wn(e)||n.some(e=>wn(e.content)),y=!v&&_===`objective-c`&&(/@\s*(?:interface|implementation|protocol)\b/u.test(e)||n.some(e=>Cn(e.path)===`objective-c`&&/@\s*(?:interface|implementation|protocol)\b/u.test(e.content))),b=v?[`-Wno-macro-redefined`,`-Wno-nullability-completeness`]:[],x=e;v&&(await bn(),i||(x=On(o,e))),y&&(a(`compiling Objective-C load constructor`),await kn(p,`extern void __wasm_idle_objc_load(void) __asm__(".objcv2_load_function") __attribute__((weak));
...
`,m,`c`)),a(`compiling ${o}`),await kn(d,un(x),f,_,[`-I`,s,...b,...r],i,i&&v?e=>On(o,e):void 0);for(let e of c){let t=`${s}/${e.path.replace(/[^A-Za-z0-9_.-]/g,`_`).replace(/\.[^.]+$/,``)}.o`;a(`compiling ${e.path}`),await kn(e.prefixedPath,null,t,e.language,[`-I`,s,...b,...r]),g.push(t)}let S=`lib/wasm32-wasi`,C=Y.compilerConfig?.compilerRuntimeLibDir||`lib/clang/8.0.1/lib/wasi`,w=await Y.getModule(Y.assetUrls.lld);v&&await xn(),await Y.run(w,Y.log,`wasm-ld`,...v?[`--export=malloc`,`--export=free`]:[`--export-dynamic`],`--gc-sections`,...v||i?[`--allow-undefined`]:[],...v?[`--export-table`]:[],`-z`,`stack-size=1048576`,`-L${S}/noeh`,`-L${S}`,`${S}/crt1.o`,...y?[m]:[],f,...g,...v?Jt.flatMap(e=>[`-u`,e]):[],...v?[`libgnustep-base.a`]:[],`libobjc.a`,...v?[`libffi.a`]:[],`-lwasi-emulated-mman`,`-lc`,`-lc++`,`-lc++abi`,`-lm`,`-L${C}`,`-lclang_rt.builtins-wasm32`,`-o`,h);let T=Uint8Array.from(Y.memfs.getFileContents(h));return{bytes:T,wasm:await WebAssembly.compile(T),target:`wasm32-wasi`,format:`wasi-core-wasm`,fileName:h,language:`C`,debugMetadata:i?{variableMetadata:Y.debugVariableMetadata,globalVariableMetadata:Y.debugGlobalMetadata,functionMetadata:Y.debugFunctionMetadata}:void 0,needsLibffi:v}}function jn(e,t,n,r,i){return JSON.stringify({code:e,activePath:t||``,workspaceFiles:n,compileArgs:r,debug:i})}const Mn=async e=>{if(Ut(e.data))return;let{code:t,buffer:n,load:r,log:i,prepare:a,compileArgs:o,programArgs:s,activePath:c,workspaceFiles:l,stdin:u,debug:d,breakpoints:f,pauseOnEntry:p,debugBuffer:m,watchBuffer:h,watchResultBuffer:g,interrupt:_,clangAssets:v,objectivecAssets:y}=e.data;if(r)try{await yn(v,y,i),q({load:!0})}catch(e){q({error:e.message})}else if(typeof i==`boolean`&&!t)Y&&(Y.log=i);else if(t){if(!Y){q({error:`Objective-C runtime is not loaded.`});return}Y.log=i,Yt=new Int32Array(n),rn=typeof u==`string`,an=rn?u:null,on=!1;try{let e=l||[],n=o||[],r=!!d;Y.beginTrace(r),Y.debugBreakpoints=new Set(r&&f||[]),Y.debugPauseOnEntry=r&&!!p,Y.debugBuffer=m?new Int32Array(m):void 0,Y.debugWatchBuffer=h?new Int32Array(h):void 0,Y.debugWatchResultBuffer=g?new Int32Array(g):void 0,Y.debugInterruptBuffer=_?new Uint8Array(_):void 0;let i=jn(t,c,e,n,r),u;if(a){u=await An(t,c,e,n,r),Z=u,Zt=i,q({results:!0});return}if(Z&&Zt===i?u=Z:(u=await An(t,c,e,n,r),Z=u,Zt=i),!a&&r){Y.memfs.stdin=()=>Sn()??``;let e={current:null};await Y.runWithOptions(u.wasm,!0,[u.fileName||`main.wasm`,...s||[]],{},u.needsLibffi?_n(e):void 0,e)}else if(!a){let e=await Bt(u,{args:s||[],stdin:Sn,stdout:e=>q({output:e}),stderr:e=>q({output:e}),extraImports:u.needsLibffi?({instance:e})=>_n(e):void 0});if(e.exitCode)throw Error(`Objective-C program exited with ${e.exitCode}`)}q({results:!0})}catch(e){q({error:e.message||e.stack})}}};function Nn(e,t){Vt=e,K=t,e.document={querySelectorAll(){return[]}},e.onmessage=Mn}Nn(self,{configureRuntimeAssets:T,handleAssetMessage:E,waitForStdin:s});