...
`),this.showTiming&&this.stdout(`${z}(${o-c}ms/${u-c}ms)${B}\n`),l?s:null}async compileLink(e,t={}){let{language:n=`CPP`,fileName:r,activePath:i,workspaceFiles:a=[],args:o=[],compileArgs:s=o,debug:c=!1,breakpoints:l=[],pauseOnEntry:u=!1,cppVersion:d,cVersion:f,debugBuffer:p,interruptBuffer:m,watchBuffer:h,watchResultBuffer:g}=t,{input:_,obj:v,wasm:y}=Y(n,J(i||``)||J(r||``)||void 0);this.beginTrace(c),this.debugBreakpoints=new Set(c?l:[]),this.debugPauseOnEntry=c&&u,this.debugBuffer=p,this.debugInterruptBuffer=m,this.debugWatchBuffer=h,this.debugWatchResultBuffer=g,this.lastArtifactPath=y;let b=JSON.stringify({code:e,input:_,wasm:y,language:n,compileArgs:s,workspaceFiles:a,cppVersion:d,cVersion:f,debug:c});if(this.lastBuildKey===b)return this.trace(`reuse ${y}`),this.wasm;await this.compile({input:_,code:e,obj:v,language:n,compileArgs:s,workspaceFiles:a,cppVersion:d,cVersion:f,debug:c}),await this.link(v,y,c),this.lastBuildKey=b;let x=Uint8Array.from(this.memfs.getFileContents(y));return this.wasm=await this.hostLogAsync(`Compiling ${y}`,WebAssembly.compile(x))}async compileLinkRun(e,t={}){let{language:n=`CPP`,fileName:r,activePath:i,workspaceFiles:a=[],args:o=[],compileArgs:s=o,programArgs:c=[],debug:l=!1,breakpoints:u=[],pauseOnEntry:d=!1,cppVersion:f,cVersion:p,debugBuffer:m,interruptBuffer:h,watchBuffer:g,watchResultBuffer:_}=t;this.debug=l;let{wasm:v}=Y(n,J(i||``)||J(r||``)||void 0);return await this.run(await this.compileLink(e,{language:n,fileName:r,activePath:i,workspaceFiles:a,compileArgs:s,debug:l,breakpoints:u,pauseOnEntry:d,cppVersion:f,cVersion:p,debugBuffer:m,interruptBuffer:h,watchBuffer:g,watchResultBuffer:_}),!0,v,...c)}};function Q(e,t){if(!e||typeof e!=`object`||Array.isArray(e))throw Error(`invalid ${t} in wasm-clang runtime manifest`);return e}function $(e,t){if(typeof e!=`string`||e.length===0)throw Error(`invalid ${t} in wasm-clang runtime manifest`);return e}function we(e,t){if(e!==`wasm32-wasi`)throw Error(`invalid ${t} in wasm-clang runtime manifest`);return e}function Te(e){let t=Q(e,`root.compiler`),n=Q(t.sysroot,`root.compiler.sysroot`);return{memfs:{asset:$(Q(t.memfs,`root.compiler.memfs`).asset,`root.compiler.memfs.asset`),argv0:$(Q(t.memfs,`root.compiler.memfs`).argv0,`root.compiler.memfs.argv0`)},clang:{asset:$(Q(t.clang,`root.compiler.clang`).asset,`root.compiler.clang.asset`),argv0:$(Q(t.clang,`root.compiler.clang`).argv0,`root.compiler.clang.argv0`)},lld:{asset:$(Q(t.lld,`root.compiler.lld`).asset,`root.compiler.lld.asset`),argv0:$(Q(t.lld,`root.compiler.lld`).argv0,`root.compiler.lld.argv0`)},sysroot:{asset:$(n.asset,`root.compiler.sysroot.asset`),...typeof n.runtimeRoot==`string`?{runtimeRoot:n.runtimeRoot}:{}},...t.resourceDir===void 0?{}:{resourceDir:$(t.resourceDir,`root.compiler.resourceDir`)},...t.compilerRuntimeLibDir===void 0?{}:{compilerRuntimeLibDir:$(t.compilerRuntimeLibDir,`root.compiler.compilerRuntimeLibDir`)},...typeof t.defaultCppStandard==`string`?{defaultCppStandard:t.defaultCppStandard}:{},...typeof t.defaultCStandard==`string`?{defaultCStandard:t.defaultCStandard}:{}}}function Ee(e){let t=Q(e,`root.clangd`);return{js:$(t.js,`root.clangd.js`),wasm:$(t.wasm,`root.clangd.wasm`)}}function De(e,t){let n=Q(e,t);if(Q(n.execution,`${t}.execution`).kind!==`wasi-preview1`)throw Error(`invalid ${t}.execution.kind in wasm-clang runtime manifest`);if(n.artifactFormat!==`wasi-core-wasm`)throw Error(`invalid ${t}.artifactFormat in wasm-clang runtime manifest`);return{artifactFormat:`wasi-core-wasm`,execution:{kind:`wasi-preview1`}}}function Oe(e){return{"wasm32-wasi":De(Q(e,`root.targets`)[`wasm32-wasi`],`root.targets.wasm32-wasi`)}}function ke(e){let t=Q(e,`root`);if(t.manifestVersion!==1)throw Error(`invalid root.manifestVersion in wasm-clang runtime manifest`);return{manifestVersion:1,version:$(t.version,`root.version`),defaultTarget:we(t.defaultTarget,`root.defaultTarget`),compiler:Te(t.compiler),clangd:Ee(t.clangd),targets:Oe(t.targets)}}async function Ae(e,t=fetch){let n=V(e,`wasm-clang runtime manifest URL`),r=await t(n.toString());if(!r.ok)throw Error(`failed to load wasm-clang runtime manifest from ${n}: ${r.status}`);return ke(await r.json())}function je(e){return W(e)}export{Ce as BrowserClangRuntime,Ae as loadRuntimeManifest,je as resolveRuntimeManifestUrl};