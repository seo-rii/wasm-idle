...
#endif
`,oe=String.raw`#ifndef WASM_CLANG_EXT_PB_DS_ASSOC_CONTAINER_HPP
...
#endif
`,se=String.raw`#ifndef WASM_CLANG_EXT_PB_DS_HASH_POLICY_HPP
...
#endif
`,ce=String.raw`#ifndef WASM_CLANG_EXT_PB_DS_PRIORITY_QUEUE_HPP
...
#endif
`,ue=String.raw`#ifndef WASM_CLANG_SETJMP_H
...
#endif
`,de=String.raw`#ifndef WASM_CLANG_BITS_STDCPP_H
...
#endif
`,fe=String.raw`#ifndef WASM_CLANG_BITS_EXTCXX_H
...
#endif
`,pe=[{path:`include/setjmp.h`,contents:ue},{path:`include/bits/stdc++.h`,contents:de},{path:`include/bits/extc++.h`,contents:fe},{path:`include/c++/v1/ext/rope`,contents:le},{path:`include/c++/v1/ext/pb_ds/tree_policy.hpp`,contents:ae},{path:`include/c++/v1/ext/pb_ds/assoc_container.hpp`,contents:oe},{path:`include/c++/v1/ext/pb_ds/hash_policy.hpp`,contents:se},{path:`include/c++/v1/ext/pb_ds/priority_queue.hpp`,contents:ce}];function me(e){e.addDirectory(`include/c++/v1/ext/pb_ds`),e.addDirectory(`include/bits`);for(let t of pe)e.addFile(t.path,t.contents)}const I=e=>JSON.stringify(e.length>96?e.slice(0,93)+`...`:e);var he=class{ready;mem=null;hostMem_=null;stdinStr;stdin;stdout;trace;instance=null;exports;out=!0;filePaths=new Set;fileOverlays=new Map;constructor(t){this.stdin=t.stdin,this.stdout=t.stdout,this.stdinStr=t.stdinStr||``,this.trace=t.trace||(()=>{});let n=e(this,`abort`,`host_write`,`host_read`,`memfs_log`,`copy_in`,`copy_out`);this.ready=m(t.moduleUrl,t.progress).then(e=>WebAssembly.instantiate(e,{env:n})).then(e=>{this.instance=e,this.exports=e.exports,this.mem=new i(this.exports.memory),this.exports.init()})}set hostMem(e){this.hostMem_=e}setStdinStr(e){this.stdinStr=e}addDirectory(e){this.mem.check(),this.mem.write(this.exports.GetPathBuf(),e),this.exports.AddDirectoryNode(e.length)}addFile(e,t){let n=t instanceof ArrayBuffer?t.byteLength:t.length;this.mem.check(),this.mem.write(this.exports.GetPathBuf(),e);let r=this.exports.AddFileNode(e.length,n),i=this.exports.GetFileNodeAddress(r);this.mem.check(),this.mem.write(i,t),this.filePaths.add(this.normalizePath(e))}setFile(e,t){let n=this.normalizePath(e);this.filePaths.add(n),this.fileOverlays.set(n,Uint8Array.from(t))}hasFile(e){return this.filePaths.has(this.normalizePath(e))}normalizePath(e){return e.replaceAll(`\\`,`/`).replace(/^\.\//,``).replace(/^\/+/,``)}getFileContents(e){let t=this.fileOverlays.get(this.normalizePath(e));if(t)return t;this.mem.check(),this.mem.write(this.exports.GetPathBuf(),e);let n=this.exports.FindNode(e.length),r=this.exports.GetFileNodeAddress(n),i=this.exports.GetFileNodeSize(n);return new Uint8Array(this.mem.buffer,r,i)}abort(){throw this.trace(`abort()`),new v}host_write(e,t,n,r){this.hostMem_.check(),b(e<=2);let i=0,a=``;for(let e=0;e<n;++e){let e=this.hostMem_.read32(t);t+=4;let n=this.hostMem_.read32(t);t+=4,a+=this.hostMem_.readStrR(e,n),i+=n}return this.hostMem_.write32(r,i),this.trace(`host_write(fd=${e}, bytes=${i}, data=${I(a)})`),this.out&&this.stdout(a),0}host_read(e,t,n,r){this.hostMem_.check(),b(e===0);let i=0;for(let r=0;r<n;++r){let n=this.hostMem_.read32(t);t+=4;let r=this.hostMem_.read32(t);t+=4,this.stdinStr.length||(this.stdinStr=this.stdin());let a=Math.min(r,this.stdinStr.length);if(a===0)break;let o=this.stdinStr.substring(0,a);if(this.hostMem_.write(n,this.stdinStr.substring(0,a)),this.stdinStr=this.stdinStr.substring(a),i+=a,this.trace(`host_read(fd=${e}, bytes=${a}, data=${I(o)})`),a!==r)break}return this.hostMem_.write32(r,i),i===0&&this.trace(`host_read(fd=${e}, bytes=0)`),0}memfs_log(e,t){this.mem.check();let n=this.mem.readStr(e,t);this.trace(`memfs_log(${I(n)})`)}copy_out(e,t,n){this.hostMem_.check();let r=new Uint8Array(this.hostMem_.buffer,e,n);this.mem.check();let i=new Uint8Array(this.mem.buffer,t,n);r.set(i)}copy_in(e,t,n){this.mem.check();let r=new Uint8Array(this.mem.buffer,e,n);this.hostMem_.check();let i=new Uint8Array(this.hostMem_.buffer,t,n);r.set(i)}};function*L(e){let n=e instanceof Uint8Array?e:new Uint8Array(e),i=0,a=``,o=e=>(i+=e,t(n,i-e,e)),s=e=>(i+=e,r(n,i-e,e)),c=()=>i=i+511&-512;for(;i+512<=n.length;){let e={filename:o(100),mode:s(8),owner:s(8),group:s(8),size:s(12),mtime:s(12),checksum:s(8),type:o(1),linkname:o(100),ustar:o(8)};if(!e.ustar)return;let r={...e,ownerName:o(32),groupName:o(32),devMajor:o(8),devMinor:o(8),filenamePrefix:o(155)};if(c(),(r.size>0||r.type===`0`||r.type===``||r.type===`L`)&&(r.contents=n.subarray(i,i+r.size),i+=r.size,c()),r.type===`L`){r.contents&&(a=t(r.contents,0,r.size));continue}r.filename=a||(r.filenamePrefix?`${r.filenamePrefix}/${r.filename}`:r.filename),a=``,yield r}}function R(e,t){for(let n of L(e))switch(n.type){case``:case`0`:t.addFile(n.filename,n.contents);break;case`5`:t.addDirectory(n.filename);break;default:throw Error(`unsupported tar entry type: ${n.type}`)}}const z=`\x1B[92m`,B=`\x1B[0m`,ge=e=>Math.max(0,Math.min(1,Number.isFinite(e)?e:0));function _e(e){let t={clang:0,lld:0,memfs:0},n=()=>{e((t.clang+t.lld+t.memfs)/3)},r=e=>({set(r){t[e]=ge(r),n()}});return{clang:r(`clang`),lld:r(`lld`),memfs:r(`memfs`)}}const V=(e,t)=>{let n=e?.toString().trim();if(!n)throw Error(`${t} is required`);let r;try{r=new URL(n,typeof location<`u`?location.href:void 0)}catch{throw Error(`${t} must be an absolute HTTP(S) URL`)}if(r.protocol!==`http:`&&r.protocol!==`https:`)throw Error(`${t} must use HTTP(S)`);return r},H=e=>{let t=V(e,`wasm-clang runtime base URL`);return t.pathname.endsWith(`/`)||(t.pathname+=`/`),t.hash=``,t},U=(e,t)=>new URL(t,H(e)).toString(),ve=(e,t)=>U(e,t),ye=e=>H(e).toString(),W=e=>ve(e,`runtime-manifest.v1.json`);function be(e,t){let n=ye(e);return{manifest:W(n).toString(),memfs:U(n,t?.compiler.memfs.asset||`bin/memfs.wasm.gz`).toString(),clang:U(n,t?.compiler.clang.asset||`bin/clang.wasm.gz`).toString(),lld:U(n,t?.compiler.lld.asset||`bin/lld.wasm.gz`).toString(),sysroot:U(n,t?.compiler.sysroot.asset||`bin/sysroot.tar.gz`).toString(),clangdJs:U(n,t?.clangd.js||`clangd/clangd.js`).toString(),clangdWasm:U(n,t?.clangd.wasm||`clangd/clangd.wasm.gz`).toString()}}globalThis.document===void 0&&(globalThis.document={querySelectorAll:(()=>[])});const G=`-std=gnu++2a`;function K(e){return(e||``).trim().toUpperCase().replaceAll(/\s+/g,``)}function xe(e){switch(K(e)){case`03`:case`CPP03`:case`C++03`:case`GNU++03`:case`GNUC++03`:return`-std=gnu++03`;case`11`:case`CPP11`:case`C++11`:case`GNU++11`:case`GNUC++11`:return`-std=gnu++11`;case`14`:case`CPP14`:case`C++14`:case`GNU++14`:case`GNUC++14`:return`-std=gnu++14`;case`17`:case`CPP17`:case`C++17`:case`GNU++17`:case`GNUC++17`:return`-std=gnu++17`;case`20`:case`23`:case`26`:case`CPP20`:case`CPP23`:case`CPP26`:case`C++20`:case`C++23`:case`C++26`:case`GNU++20`:case`GNU++23`:case`GNU++26`:case`GNUC++20`:case`GNUC++23`:case`GNUC++26`:return G;default:return G}}function q(e){switch(K(e)){case`99`:case`C99`:case`GNU99`:case`GNUC99`:return`-std=gnu99`;case`11`:case`C11`:case`GNU11`:case`GNUC11`:return`-std=gnu11`;case`17`:case`18`:case`C17`:case`C18`:case`GNU17`:case`GNU18`:case`GNUC17`:case`GNUC18`:return`-std=gnu17`;default:return`-std=gnu11`}}function Se(e,t){return e===`C`?{languageArg:`c`,standardArg:q(t.cVersion)}:e===`OBJC`?{languageArg:`objective-c`,standardArg:q(t.cVersion)}:{languageArg:`c++`,standardArg:xe(t.cppVersion)}}const J=e=>e.replaceAll(`\\`,`/`).split(`/`).filter(e=>e&&e!==`.`&&e!==`..`).join(`/`);function Y(e,t){let n=J(t||``),r=`main`,i=n&&/\.[A-Za-z0-9_-]+$/.test(n)?n:`${n||r}.${e===`C`?`c`:e===`OBJC`?`m`:`cc`}`,a=(i.split(`/`).pop()||i).replace(/\.[^.]+$/,``)||r;return{input:i,obj:`${a}.o`,wasm:`${a}.wasm`}}const X=e=>{let t=encodeURIComponent(e),n=``;for(let e=0;e<t.length;){let r=t[e];if(e+=1,r==`%`){let r=t.substring(e,e+=2);r&&(n+=String.fromCharCode(parseInt(r,16)))}else n+=r}return n};var Z=class{ready;memfs;stdout;moduleCache;showTiming;log;debug=!1;debugBreakpoints=new Set;debugPauseOnEntry=!1;debugBuffer;debugInterruptBuffer;debugWatchBuffer;debugWatchResultBuffer;onDebugEvent;debugVariableMetadata={};debugGlobalMetadata=[];debugFunctionMetadata={};lastBuildKey=``;path;assetUrls;compilerConfig;wasm;lastArtifactPath=`main.wasm`;traceStartedAt=0;progress;constructor(e){this.moduleCache={},this.stdout=e.stdout||(()=>{}),this.showTiming=e.showTiming||!1,this.log=e.log||!1,this.path=e.runtimeBaseUrl.toString(),this.assetUrls=be(this.path,e.manifest),this.compilerConfig=e.manifest?.compiler,this.onDebugEvent=e.onDebugEvent,this.progress=_e(t=>e.progress?.(t)),this.memfs=new he({stdout:this.stdout,stdin:e.stdin||(()=>``),moduleUrl:this.assetUrls.memfs,progress:this.progress.memfs,trace:e=>this.trace(e)});let t=this.getModule(this.assetUrls.clang,this.progress.clang),n=this.getModule(this.assetUrls.lld,this.progress.lld),r=this.memfs.ready.then(async()=>{await this.hostLogAsync(`Untarring ${this.assetUrls.sysroot}`,p(this.assetUrls.sysroot).then(e=>R(e,this.memfs))),me(this.memfs)});this.ready=Promise.all([t,n,r]).then(()=>void 0)}hostLog(e){if(!this.log)return;let t=`[1;93m>${B} `;this.stdout(`${t}${e}`)}beginTrace(e){this.debug=e,this.traceStartedAt=Date.now()}trace(e){if(!this.debug||!this.log)return;let t=Date.now()-this.traceStartedAt;this.stdout(`\x1b[2m[debug +${t}ms] ${e}\x1b[0m\n`)}async hostLogAsync(e,t){let n=+new Date;this.hostLog(`${e}...`);let r=await t,i=+new Date;return this.log&&this.stdout(` done.`),this.showTiming&&this.stdout(` ${z}(${i-n}ms)${B}\n`),this.log&&this.stdout(`
`),r}async getModule(e,t){if(this.moduleCache[e])return this.moduleCache[e];let n=await this.hostLogAsync(`Fetching and compiling ${e}`,m(e,t));return this.moduleCache[e]=n,n}addWorkspaceDirectories(e,t=new Set){let n=J(e).split(`/`).slice(0,-1),r=``;for(let e of n)r=r?`${r}/${e}`:e,t.has(r)||(this.memfs.addDirectory(r),t.add(r))}addWorkspaceFiles(e=[],t=``){let n=new Set,r=J(t);for(let t of e){let e=J(t.path);!e||e===r||(this.addWorkspaceDirectories(e,n),this.memfs.addFile(e,X(t.content)))}}async compile(e){let t=J(e.input||`main.cc`)||`main.cc`,n=e.code,r=e.obj,i=e.language===`C`?`C`:e.language===`OBJC`?`OBJC`:`CPP`,a=e.compileArgs??e.args??[],{languageArg:o,standardArg:s}=Se(i,e),c=!!e.debug,l=c?`0`:e.opt||`2`;if(c){let e=n.split(`
...
`)}else this.debugVariableMetadata={},this.debugGlobalMetadata=[];typeof e.transformSource==`function`&&(n=e.transformSource(n));let u=X(n);await this.ready,this.addWorkspaceFiles(e.workspaceFiles,t),this.addWorkspaceDirectories(t),this.memfs.addFile(t,u),this.memfs.addFile(r,new Uint8Array);let d=await this.getModule(this.assetUrls.clang),f=this.compilerConfig?.resourceDir||`/lib/clang/8.0.1`,p=`${f.replace(/\/+$/,``)}/include`,m=[`-cc1`,`-triple`,`wasm32-wasi`,`-emit-obj`,`-disable-free`,`-isysroot`,`/`,`-resource-dir`,f,...i===`CPP`?[`-internal-isystem`,`/include/c++/v1`,`-internal-isystem`,p,`-internal-isystem`,`/include/wasm32-wasi`,`-internal-isystem`,`/include`]:[`-internal-isystem`,p,`-internal-isystem`,`/include/wasm32-wasi`,`-internal-isystem`,`/include`],...i===`OBJC`?[`-I.`]:[],`-ferror-limit`,`19`,`-fcolor-diagnostics`,`-O`+l,`-o`,r,s,`-x`,o,...i===`OBJC`?[`-fobjc-runtime=gnustep-2.0`,`-fblocks`]:[],t,...a];this.trace(`compile ${t} -> ${r}`);try{return await this.run(d,!0,`clang`,...m)}catch(e){if(Uint8Array.from(this.memfs.getFileContents(r)).length>0)return this.trace(`recover ${r} after clang output stream exit`),null;throw e}}async link(e,t,n=!1){let r=`lib/wasm32-wasi`,i=this.compilerConfig?.compilerRuntimeLibDir||`lib/clang/8.0.1/lib/wasi`,a=`${r}/crt1.o`;await this.ready;let o=await this.getModule(this.assetUrls.lld);return this.trace(`link ${e} -> ${t}`),await this.run(o,this.log,`wasm-ld`,`--export-dynamic`,...n?[`--allow-undefined`]:[],`-z`,`stack-size=1048576`,`-L${r}/noeh`,`-L${r}`,a,e,`-lc`,`-lc++`,`-lc++abi`,`-lm`,`-L${i}`,`-lclang_rt.builtins-wasm32`,`-o`,t)}async run(e,t,...n){return this.runWithOptions(e,t,n)}async runWithOptions(e,t,n,r={},i,a){this.memfs.out=t,this.hostLog(`${n.join(` `)}\n`),this.trace(`run ${n.join(` `)}`);let o=+new Date,s=new ie(e,this.memfs,n[0],...n.slice(1),{extraImports:i,instanceRef:a});s.environ={...s.environ,...r},s.trace=e=>this.trace(e),s.debugSession={buffer:this.debugBuffer,interruptBuffer:this.debugInterruptBuffer,watchBuffer:this.debugWatchBuffer,watchResultBuffer:this.debugWatchResultBuffer,breakpoints:new Set(this.debugBreakpoints),breakpointVersion:0,pauseOnEntry:this.debugPauseOnEntry,stepArmed:this.debugPauseOnEntry,nextLineArmed:!1,stepOutArmed:!1,callDepth:0,stepOutDepth:0,currentFunctionId:0,currentLine:0,resumeSkipActive:!1,resumeSkipFunctionId:0,resumeSkipLine:0,nextLineFunctionId:0,nextLineLine:0,variableMetadata:this.debugVariableMetadata,globalVariableMetadata:this.debugGlobalMetadata,functionMetadata:this.debugFunctionMetadata,frames:[],globalValues:new Map,onPause:e=>this.onDebugEvent?.(e)};let c=+new Date,l=await s.run(),u=+new Date;return this.log&&this.stdout(`
`),this.showTiming&&this.stdout(`${z}(${o-c}ms/${u-c}ms)${B}\n`),l?s:null}async compileLink(e,t={}){let{language:n=`CPP`,fileName:r,activePath:i,workspaceFiles:a=[],args:o=[],compileArgs:s=o,debug:c=!1,breakpoints:l=[],pauseOnEntry:u=!1,cppVersion:d,cVersion:f,debugBuffer:p,interruptBuffer:m,watchBuffer:h,watchResultBuffer:g}=t,{input:_,obj:v,wasm:y}=Y(n,J(i||``)||J(r||``)||void 0);this.beginTrace(c),this.debugBreakpoints=new Set(c?l:[]),this.debugPauseOnEntry=c&&u,this.debugBuffer=p,this.debugInterruptBuffer=m,this.debugWatchBuffer=h,this.debugWatchResultBuffer=g,this.lastArtifactPath=y;let b=JSON.stringify({code:e,input:_,wasm:y,language:n,compileArgs:s,workspaceFiles:a,cppVersion:d,cVersion:f,debug:c});if(this.lastBuildKey===b)return this.trace(`reuse ${y}`),this.wasm;await this.compile({input:_,code:e,obj:v,language:n,compileArgs:s,workspaceFiles:a,cppVersion:d,cVersion:f,debug:c}),await this.link(v,y,c),this.lastBuildKey=b;let x=Uint8Array.from(this.memfs.getFileContents(y));return this.wasm=await this.hostLogAsync(`Compiling ${y}`,WebAssembly.compile(x))}async compileLinkRun(e,t={}){let{language:n=`CPP`,fileName:r,activePath:i,workspaceFiles:a=[],args:o=[],compileArgs:s=o,programArgs:c=[],debug:l=!1,breakpoints:u=[],pauseOnEntry:d=!1,cppVersion:f,cVersion:p,debugBuffer:m,interruptBuffer:h,watchBuffer:g,watchResultBuffer:_}=t;this.debug=l;let{wasm:v}=Y(n,J(i||``)||J(r||``)||void 0);return await this.run(await this.compileLink(e,{language:n,fileName:r,activePath:i,workspaceFiles:a,compileArgs:s,debug:l,breakpoints:u,pauseOnEntry:d,cppVersion:f,cVersion:p,debugBuffer:m,interruptBuffer:h,watchBuffer:g,watchResultBuffer:_}),!0,v,...c)}};function Q(e,t){if(!e||typeof e!=`object`||Array.isArray(e))throw Error(`invalid ${t} in wasm-clang runtime manifest`);return e}function $(e,t){if(typeof e!=`string`||e.length===0)throw Error(`invalid ${t} in wasm-clang runtime manifest`);return e}function Ce(e,t){if(e!==`wasm32-wasi`)throw Error(`invalid ${t} in wasm-clang runtime manifest`);return e}function we(e){let t=Q(e,`root.compiler`),n=Q(t.sysroot,`root.compiler.sysroot`);return{memfs:{asset:$(Q(t.memfs,`root.compiler.memfs`).asset,`root.compiler.memfs.asset`),argv0:$(Q(t.memfs,`root.compiler.memfs`).argv0,`root.compiler.memfs.argv0`)},clang:{asset:$(Q(t.clang,`root.compiler.clang`).asset,`root.compiler.clang.asset`),argv0:$(Q(t.clang,`root.compiler.clang`).argv0,`root.compiler.clang.argv0`)},lld:{asset:$(Q(t.lld,`root.compiler.lld`).asset,`root.compiler.lld.asset`),argv0:$(Q(t.lld,`root.compiler.lld`).argv0,`root.compiler.lld.argv0`)},sysroot:{asset:$(n.asset,`root.compiler.sysroot.asset`),...typeof n.runtimeRoot==`string`?{runtimeRoot:n.runtimeRoot}:{}},...t.resourceDir===void 0?{}:{resourceDir:$(t.resourceDir,`root.compiler.resourceDir`)},...t.compilerRuntimeLibDir===void 0?{}:{compilerRuntimeLibDir:$(t.compilerRuntimeLibDir,`root.compiler.compilerRuntimeLibDir`)},...typeof t.defaultCppStandard==`string`?{defaultCppStandard:t.defaultCppStandard}:{},...typeof t.defaultCStandard==`string`?{defaultCStandard:t.defaultCStandard}:{}}}function Te(e){let t=Q(e,`root.clangd`);return{js:$(t.js,`root.clangd.js`),wasm:$(t.wasm,`root.clangd.wasm`)}}function Ee(e,t){let n=Q(e,t);if(Q(n.execution,`${t}.execution`).kind!==`wasi-preview1`)throw Error(`invalid ${t}.execution.kind in wasm-clang runtime manifest`);if(n.artifactFormat!==`wasi-core-wasm`)throw Error(`invalid ${t}.artifactFormat in wasm-clang runtime manifest`);return{artifactFormat:`wasi-core-wasm`,execution:{kind:`wasi-preview1`}}}function De(e){return{"wasm32-wasi":Ee(Q(e,`root.targets`)[`wasm32-wasi`],`root.targets.wasm32-wasi`)}}function Oe(e){let t=Q(e,`root`);if(t.manifestVersion!==1)throw Error(`invalid root.manifestVersion in wasm-clang runtime manifest`);return{manifestVersion:1,version:$(t.version,`root.version`),defaultTarget:Ce(t.defaultTarget,`root.defaultTarget`),compiler:we(t.compiler),clangd:Te(t.clangd),targets:De(t.targets)}}async function ke(e,t=fetch){let n=V(e,`wasm-clang runtime manifest URL`),r=await t(n.toString());if(!r.ok)throw Error(`failed to load wasm-clang runtime manifest from ${n}: ${r.status}`);return Oe(await r.json())}function Ae(e){return W(e)}export{Z as BrowserClangRuntime,ke as loadRuntimeManifest,Ae as resolveRuntimeManifestUrl};