...
procedure ReadLn(var I: Integer); overload;
procedure ReadLn(var D: Double); overload;

Type
  TConsoleHandler = Reference to Procedure (S : JSValue; NewLine : Boolean);
  TConsoleReadHandler = Reference to Function : String;
Function SetWriteCallBack(H : TConsoleHandler) : TConsoleHandler;
Function SetReadCallBack(H : TConsoleReadHandler) : TConsoleReadHandler;
...
var
  ...
  ReadCallBack : TConsoleReadHandler;
...
begin
  if Assigned(ReadCallBack) then
    ...
    asm
      if ((typeof globalThis !== "undefined") && (typeof globalThis.__wasm_idle_pascal_read === "function")) {
        S.set(String(globalThis.__wasm_idle_pascal_read()));
      } else {
        S.set("");
      }
    end;
