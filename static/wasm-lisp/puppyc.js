...
({ exports: exports1 } = yield instantiateCore(yield module1, {
  env: {
    'clock-now': trampoline4,
    'drop-descriptor': trampoline12,
    'drop-input-stream': trampoline13,
    'drop-output-stream': trampoline14,
    exit: trampoline0,
    'get-arguments': trampoline5,
    'get-directories': trampoline8,
    'get-stderr': trampoline2,
    'get-stdin': trampoline6,
    'get-stdout': trampoline1,
    'open-at': trampoline9,
    'read-via-stream': trampoline10,
    'stream-read': trampoline7,
    'stream-write': trampoline3,
    'write-via-stream': trampoline11,
  },
  mem: {
